...
last_updated: 11/15/2019 summary: "Learn how to load files in bulk with a script." sidebar: mydoc_sidebar permalink: /:collection/:path.html -- If you need to load data from multiple CSV files, create a script to automate the process.
