...
+
image::{{ site.baseurl }}/images/worksheet-choose-sources.png[Choose sources]
...
+
image::{{ site.baseurl }}/images/worksheet-apply-joins.png[Apply joins progressively or apply all joins]
