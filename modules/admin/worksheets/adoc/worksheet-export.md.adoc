...
In ThoughtSpot, you can download Worksheets to a flat file in `TSL`, link:{{ site.baseurl }}/admin/worksheets/yaml-worksheet.html[ThoughtSpot's Scripting Language], modify the file, and subsequently upload this file either to the same cluster, or to a different cluster.
...
See link:{{ site.baseurl }}/admin/worksheets/yaml-worksheet.html[TSL Worksheet specification] for the full syntax of the TSL file.
...
+
image::{{ site.baseurl }}/images/worksheet-update-browse.png[Find the Worksheet TSL file]
...
* link:{{ site.baseurl }}/admin/worksheets/yaml-worksheet.html[Worksheet TSL specification]
