...
last_updated: tbd summary: "You can manage all scheduled pinboards on the Jobs Management page." sidebar: mydoc_sidebar permalink: /:collection/:path.html -- Users who are not admins, but have the *can schedule pinboard* privilege, can only view pinboard schedules they've created.
...
image::{{ site.baseurl }}/images/pinboard-job-status.png[Job statuses]
