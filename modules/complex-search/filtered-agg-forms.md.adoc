...
image::{{ site.baseurl }}/images/filtered-agg-forms.png[]
...
image::{{ site.baseurl }}/images/vs-ex-1.png[]
...
image::{{ site.baseurl }}/images/vs-ex-2.png[]

You can also provide multiple `vs` instances:

image::{{ site.baseurl }}/images/vs-ex-3.png[]

Of course, you can compare across different columns as well:

image::{{ site.baseurl }}/images/vs-ex-4.png[]
