...
To ensure that users have *Read only* access, edit the user group permission and select the *link:{{ site.baseurl }}/end-user/introduction/about-privileges-end-user.html#read-only[Cannot create or update Pinboards]* privilege.
...
. Assign the *link:{{ site.baseurl }}/end-user/introduction/about-privileges-end-user.html#read-only[Cannot create or update Pinboards]* privilege to the User Group.
