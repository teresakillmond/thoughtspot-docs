...
+
Refer to the link:{{ site.baseurl }}/data-integrate/embrace/embrace-HANA-reference.html#[SAP HANA connection reference] for more information on each of the specific attributes you must enter for your connection.
...
+
{% include note.html content="Any key-value pairs that you enter must be defined in your SAP HANA data source.
...
* link:{{ site.baseurl }}/data-integrate/embrace/embrace-HANA-modify.html[Modify an SAP HANA connection]
* link:{{ site.baseurl }}/data-integrate/embrace/embrace-HANA-reference.html[SAP HANA connection reference]
