...
+
image::{{ site.baseurl }}/images/teradata-chooseconnection.png[Select a connection to edit]
...
For more information, see link:{{ site.baseurl }}/data-integrate/embrace/embrace-teradata-modify.html#deleting-a-table-from-a-Teradata-connection[Deleting a table].
...
image:{{ site.baseurl }}/images/teradata-remapping.png[Remap a connection]
. Click *Download* to download the source mapping file.
+
image::{{ site.baseurl }}/images/teradata-downloadyaml.png["Download the source mapping file"]
