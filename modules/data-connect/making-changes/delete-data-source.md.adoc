...
Before you begin, if there are any recurring data load jobs for the data source you are deleting, follow the steps in link:stop-scheduled-job.html[Stop a scheduled job from running].
...
+
image::{{ site.baseurl }}/images/data_connect_delete_source.png[]
...
+
image::{{ site.baseurl }}/images/retain_tables_when_deleting_data_sources.png[]
