...
Now, you're ready to either link:{{ site.baseurl }}/app-integrate/embedding-viz/embed-a-viz.html#[embed a visualization] or link:{{ site.baseurl }}/app-integrate/data-api/use-data-api-read.html#[use the REST API to get data] from ThoughtSpot and display it within your Web page or application.
