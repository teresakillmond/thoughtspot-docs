...
. If the first-level dependents are worksheets, select *Edit worksheet* for each worksheet, click *Fix worksheet* in the top-right corner, and then *Save* the worksheets. If the first-level dependents are answers or Liveboards, select *Save* for each object. Now all dependents are usable.
