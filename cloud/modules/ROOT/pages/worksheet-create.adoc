...
. At the top right corner of the interface, select *Close*.
...
. After you finish selecting the tables and columns, click the *More* menu image:icon-more-10px.png[more options menu] at the top right corner of the interface.
+
Select *Save*.
