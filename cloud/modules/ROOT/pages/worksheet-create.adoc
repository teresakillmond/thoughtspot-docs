...
. At the upper right corner of the interface, click *Close*.
...
. After you finish selecting the tables and columns, click the *More* menu at the upper right corner of the interface.
+
Click *Save*.
