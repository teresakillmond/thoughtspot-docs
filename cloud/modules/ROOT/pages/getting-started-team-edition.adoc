= Getting Started with ThoughtSpot Team Edition
...
NOTE: The following features are not supported in ThoughtSpot Team edition: SpotIQ, Visual Embed SDK, REST API, SAML SSO, OAuth, Style Customization, and row-level security.

We also provide these instructions in link:{attachmentsdir}/get-started-team-edition.pdf[PDF format].
