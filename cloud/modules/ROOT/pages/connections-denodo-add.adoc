...
If you plan to use OAuth with {connection}, you must configure it before you can create a connection. For details, see xref:connections-{connection}-oauth.adoc[Configure OAuth for a {connection} connection].
...
+
Refer to the xref:connections-{connection}-reference.adoc[{connection} connection reference] for more information on each of the specific attributes you must enter for your connection.
