 ...
 ** We adjusted the size and height of the *Name Your Worksheet* dropdown menu during Worksheet creation in Setup.
...
* To facilitate account creation and login, Free Trial login now asks for your email address rather than username.
