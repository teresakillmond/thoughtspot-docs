...
+
Refer to the xref:connections-aurora-reference.adoc[{connection} connection reference] for more information on each of the specific attributes you must enter for your connection.
...
You can also xref:connections-aurora-delete.adoc[Delete an {connection} connection].
