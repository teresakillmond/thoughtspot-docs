...
+
Before selecting Use OAuth authentication, you must configure either OAuth in Snowflake. For details, see xref:connections-starburst-okta-oauth.adoc[Configure Okta OAuth for a {connection} connection] or xref:connections-starburst-azure-ad-oauth.adoc[Configure Azure Ad OAuth for a {connection} connection].
+
