...
+
Before selecting Use OAuth authentication, you must configure OAuth in Snowflake. For details, see xref:connections-starburst-oauth.adoc[Configure OAuth for a {connection} connection].
+
