...
:description:  Deploy the Diversity, Equity, and Inclusion SpotApp, an out-of-the-box solution template built specifically for your HR data.
:spotapp: Diversity, Equity, and Inclusion SpotApp
:application: BambooHR or Workday

// have only changed the front matter

include::partial$spotapps-intro.adoc[]

This is a sample Liveboard, created after you deploy the {spotapp}:

// this is probably TS data -- confirming with edukondalu, in which case i need a new image

image::spotapp-dei-liveboard.png[Diversity, Equity, and Inclusion SpotApp Liveboard]

Use the {spotapp} to get invaluable insight into your Diversity, Equity, and Inclusion data from your HR application.
