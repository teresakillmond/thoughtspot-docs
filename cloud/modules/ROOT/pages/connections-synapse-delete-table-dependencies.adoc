= Delete a table with dependent objects from a Synapse connection
...
See xref:connections-synapse-delete-table.adoc[Delete a table from a Synapse connection]
