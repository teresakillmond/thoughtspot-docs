...
When you share an object, only the users and groups that have *SHARABLE* set for the *Sharing visibility* option appear as options in the dropdown menu for users and groups in the Sharing dialog.
