...
+++<col width="50%">++++++</col>++++++</colgroup>+++
  ...
  +++<tr>++++++<td>+++Worksheets+++</td>+++
    ...
    +++<td>+++Only the creator of the worksheet (and any user with administrator privileges) has access to it by default. They can share a worksheet with other users or groups. See xref:share-worksheets.adoc[Share worksheets]+++</td>++++++</tr>+++
  +++<tr>++++++<td>+++Liveboards+++</td>+++
