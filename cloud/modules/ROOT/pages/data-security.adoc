...
When you share an object, only the users and groups that have *SHAREABLE* set for the *Sharing visibility* option appear as options in the drop-down for users and groups in the Sharing dialog.
