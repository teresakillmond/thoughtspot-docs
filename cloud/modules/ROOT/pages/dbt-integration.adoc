...
+
To inspect the worksheet and Liveboard details, click on any of the worksheet or Liveboard names. You can view the joins created between the related tables in the worksheets from the *Joins* tab for the worksheet.
+
...
. If you click on any of the tables or worksheets you created, and then select *Joins*, you can see the joins ThoughtSpot created, based on the relationships in dbt.
