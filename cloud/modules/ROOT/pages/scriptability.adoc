...
If you export a table, you don't see this modal, since tables don't have any dependents.
...
. If you uploaded a `.zip` file with multiple objects, you can unselect any files in the `.zip` file you don't want to upload.
