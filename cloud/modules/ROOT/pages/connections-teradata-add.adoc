...
+
Refer to the xref:ts-cloud-embrace-teradata-connection-reference.adoc[Teradata connection reference] for more information on each of the specific attributes you must enter for your connection.
...
* xref:connections-teradata-edit.adoc[Edit a Teradata connection]
