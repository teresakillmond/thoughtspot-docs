...
WARNING: After you enable the Orgs feature on a cluster, you can’t turn off the ability to create Orgs. However, your environment remains a single-tenant environment until you create an Org, and you can return to single-tenancy by deleting all the Orgs you created. For more information, see <<enable-disable,Enabling and disabling Orgs>>.
...
After you enable the Orgs feature on a cluster, you can’t turn off the ability to create Orgs. However, your environment remains a single-tenant environment until you create an Org, and you can return to single-tenancy by deleting all the Orgs you created.
