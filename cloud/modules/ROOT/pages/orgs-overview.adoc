...
WARNING: After you enable the Orgs feature on a cluster, you cannot disable it and return that cluster to a single-tenant environment. For more information, contact your ThoughtSpot representative.
