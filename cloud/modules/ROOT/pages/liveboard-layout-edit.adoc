...
Resize a visualization by choosing a predetermined size under the ellipses icon image:icon-more-10px.png[more options menu icon] for the visualization.
+
image::resize_pinboard_visualization.png[]

. Save your Liveboard by clicking the ellipses icon image:icon-more-10px.png[more options menu icon] and selecting *Save*.
+
...
. Click the ellipses icon image:icon-more-10px.png[more options menu icon] for the chart or table.
+
...
. Click the ellipses icon image:icon-more-10px.png[more options menu icon] and select *Save*.
...
. In the upper-right corner of the visualization, click the ellipses icon image:icon-more-10px.png[more options menu icon] and select *Delete*.
+
image::delete_a_pinboard_visualization.png[]
...
To create a copy of a visualization and edit it:
...
. In the upper-right corner of the visualization, click the *more options* icon image:icon-more-10px.png[more options menu icon] and select *Copy and edit*, or *Make a copy*, depending on your xref:liveboard-experience-new.adoc[Liveboard experience].
+
...
Most of these actions are found under the ellipses icon image:icon-more-10px.png[more options menu icon].
