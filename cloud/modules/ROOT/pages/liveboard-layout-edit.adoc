...
Resize a visualization by choosing a predetermined size under the *more options* icon image:icon-more-10px.png[more options menu icon] for the visualization.
+
image::resize_pinboard_visualization.png[]

. Save your Liveboard by clicking the *more options* icon image:icon-more-10px.png[more options menu icon] and selecting *Save*.
+
...
. Click the *more options* icon image:icon-more-10px.png[more options menu icon] for the chart or table.
+
...
. In the upper-right corner of the visualization, click the *more options* icon image:icon-more-10px.png[more options menu icon] and select *Delete*.
+
...
Most of these actions are found under the *more options* menu image:icon-more-10px.png[more options menu icon].
