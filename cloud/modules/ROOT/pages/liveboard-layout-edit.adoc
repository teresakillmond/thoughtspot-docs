...
Starting in the 8.9.0.cl release, you can choose to enable <<custom,custom tile sizes>>. This feature is in beta and off by default. If you do not enable custom tile sizes, you can choose between 5 <<predetermined,predetermined sizes>> for each visualization.

[#predetermined]
=== Predetermined sizes
By default in 8.9.0.cl, ThoughtSpot provides predetermined size options for Liveboard visualizations.
...
. In the upper-right corner of the visualization you would like to edit, click the *More* icon image:icon-more-10px.png[more options menu icon].
. Select *Make a copy*.
+
