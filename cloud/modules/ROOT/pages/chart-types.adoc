...
a| image::chart-pie.png[link="chart-pie.adoc"]
...
a| image::chart-line-stacked-column.png[link="chart-line-stacked-column.adoc"]
...
a| xref:chart-line-stacked-column.adoc[]
...
a| image::chart-funnel.png[link="chart-funnel.adoc"]
...
a| image::chart-candlestick.png[link="chart-candlestick.adoc"]
