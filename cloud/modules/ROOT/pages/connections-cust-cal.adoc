...
* Maximum calendar length for specific cloud data warehouses:
** Google BigQuery: 20 days
** Amazon Redshift: 2000 days
** Snowflake: 18,250 days
+
To extend the calendar length for connections to these cloud data warehouses, contact {support-url}.
