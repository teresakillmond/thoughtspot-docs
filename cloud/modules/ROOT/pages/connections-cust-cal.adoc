...
xref:connections-cust-cal-create.adoc[Create a custom calendar] + xref:connections-cust-cal-update.adoc[Update a custom calendar] + xref:connections-cust-cal-delete.adoc[Delete a custom calendar]
