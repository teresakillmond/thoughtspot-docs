...
* Using date formulas with the `fiscal` option specified (See link:{{ site.baseurl }}/advanced-search/formulas/date-formulas.html#fiscal-and-gregorian-calendars[Fiscal and Gregorian calendars])
...
* Before you can create a custom calendar, you must contact link:{{ site.baseurl }}/admin/misc/contact.html[ThoughtSpot Support] to enable the custom calendar feature on your cluster.
...
link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-cust-cal-create.html#[Create a custom calendar] + link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-cust-cal-update.html#[Update a custom calendar] + link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-cust-cal-delete.html#[Delete a custom calendar]
