...
The xref:new-answer-experience.adoc[new Answer experience] [.badge.badge-update]#Beta# is off by default, but the option to turn it on or off individually is on by default.
