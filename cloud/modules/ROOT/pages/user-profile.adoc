...
You can change the display name by selecting the profile icon present on top right corner of the screen.
...
To sign out of your ThoughtSpot account, select the user icon at the far right of the top navigation bar, and select *Sign out*.
