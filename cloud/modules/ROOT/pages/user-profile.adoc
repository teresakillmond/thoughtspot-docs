...
The xref:liveboard-experience-new.adoc[new Liveboard experience] is off by default, but administrators can turn it on for their cluster. If your administrator enabled the new Liveboard experience, you see the option to turn it on or off individually in the *Experience* section of your profile.
If that option is not available, contact your administrator.
