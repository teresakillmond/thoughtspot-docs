...
Click *View my profile* to navigate to your profile, where you can change your <<display-name,display name>>, <<profile-picture,icon>>, <<password,password>>, <<email,email>>, <<language,locale>>, and other  preferences.
...
You can change the display name by clicking on the profile icon present on upper right corner of the screen.

. Navigate to the user icon next to the *help* button.
. Click *view my profile*.
. In your profile, next to name, click *edit*.
. Enter the display name and click the *save* button.
