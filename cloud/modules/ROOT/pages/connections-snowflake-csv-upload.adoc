...
. In the Upload Data window, select *Browse Files* and select your CSV file or drag your CSV file into the window.
...
.. Select *Yes*.
.. Select the *select source here* menu, and select the table or worksheet you plan to join your imported table to.
+
