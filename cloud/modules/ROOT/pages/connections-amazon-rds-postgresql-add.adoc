...
:description: Learn how to add an Amazon RDS PostgreSQL connection.
...
+
image::rds-connectiontype.png[Add a {connection} connection]

. Enter the connection details for your {connection} data source.
+
image::rds-connectiondetails.png[Enter connection details]
+
Refer to the xref:connections-amazon-rds-postgresql-reference.adoc[{connection} connection reference] for more information on each of the specific attributes you must enter for your connection.
...
You can also xref:connections-amazon-rds-postgresql-delete.adoc[Delete an {connection} connection].
