...
ThoughtSpot provides a set of standard actions in the primary menu bar, *More* menu, and the contextual menu that appears when a user selects any value on an Answer or visualization.
