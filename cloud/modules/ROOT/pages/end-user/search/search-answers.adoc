...
image::search-answers.png[]

. To search answers and Liveboards, toggle the *Search type* icon to *Search Answers* at the top right, next to the search bar: image:search-toggle-answers.png[].
