...
image::{{ site.baseurl }}/images/geo_heatmap_example.png[Geo heatmap chart example]
...
see the link:{{ site.baseurl }}/reference/geomap-reference.html[Geo map reference] for details.
