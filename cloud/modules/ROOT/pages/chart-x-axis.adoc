...
****
Introduced the Apply and Reset buttons on configure menu to reduce the reloading of chart, after every change. This feature is disabled by default. To enable it, contact your ThoughtSpot administrator.
...
+
. click *apply*, you can view the reorderd labels.
+
image::chartconfig-re-placed.png[]
+
. If you want to discard the changes your are making, click *reset*
+
NOTE: If you either closes the config menu,or opens the settings menu, or chart selection menu, the configuration of the chart would reset to default state.
