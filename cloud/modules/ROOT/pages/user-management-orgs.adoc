...
. Select the *+ Add User* button on the upper left-hand side of the list of users.
...
. Click the *Orgs* tab in the *Edit User* interface.
...
. Click the *Add to org* button above the list of users.
. In the *Add to org* interface, click on the drop-down.
