...
To remove or enable this option, xref:support-contact.adoc[contact ThoughtSpot Support].
...
You can manage the availability of the new Answer experience by xref:support-contact.adoc[contacting ThoughtSpot Support].
