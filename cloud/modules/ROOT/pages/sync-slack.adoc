...
. In the upper-right corner of the Answer, select the *more options* menu icon image:icon-more-10px.png[more options menu icon]. From the drop-down menu, click *Sync to other apps*, then select *Slack* and click *Next*.
+
