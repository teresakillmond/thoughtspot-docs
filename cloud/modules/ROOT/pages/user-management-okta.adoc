= Create, edit, or delete a user using Okta identity and access management
...
[NOTE]
====
This article contains instructions for managing users if your company uses ThoughtSpot's Okta identity and access management feature. The Okta feature is in *Beta* and off by default in 8.7.0.cl. If the *Users* section of the Admin Console contains an *Account Activation* column, your company is using the Okta feature.

If the *Users* section of the Admin Console does *_not_* contain an *Account Activation* column, your company is *_not_* using ThoughtSpot's Okta identity and access management feature. Refer to xref:user-management.adoc[].
====
