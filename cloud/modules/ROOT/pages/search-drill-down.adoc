...
To return to the original Answer, select the reset icon. In the new Liveboard experience, the reset icon is part of the back button, and appears when you select the back button dropdown menu. In the classic Liveboard experience, the reset icon is a blue icon at the lower-right corner of the Answer.
