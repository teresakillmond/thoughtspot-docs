...
When you drill down within a Liveboard but not within Answer Explorer, you cannot go back one step at a time to see an earlier version of your visualization.
