...
ThoughtSpot Cloud 8.10.0.cl is now available.
...
* xref:spotapps-procurement-vulnerability.adoc[SAP Procurement Vulnerability Analysis]: Use this SpotApp quickly identify where disruptions could occur in your global supply chain, reducing risk and building resilience.
