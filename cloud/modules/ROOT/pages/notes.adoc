...
Refer to xref:search-conditional-formatting.adoc#table[Apply conditional formatting] and link:{{ site.baseurl }}/complex-search/about-pivoting-a-table.html[Pivot tables].
