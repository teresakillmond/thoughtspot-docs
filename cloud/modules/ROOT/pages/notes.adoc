...
include::partial$cloud-coming-soon-release-notes.adoc[What's new in 8.8.0.cl]

ThoughtSpot Cloud 8.7.0.cl is now available.
...
+
This feature is only available if you have the xref:answer-experience-new.adoc[new answer experience] [.badge.badge-beta-relnotes]#Beta# (off by default in September cloud) on in your environment.
...
[#search-suggestions]
Search suggestions [.label.badge-beta-relnotes]#Beta#::
When you xref:search-answers.adoc[search across existing answers and Liveboards], ThoughtSpot now offers search suggestions in the search bar, based on your past searches and popular searches in your environment, in addition to object suggestions.
...
+
To perform conditional formatting on measures in pivot tables, you must have the xref:answer-experience-new.adoc[New Answer experience] [.badge.badge-beta-relnotes]#Beta# (off by default in June Cloud) enabled on your cluster.
...
[#admin-privileges]
New admin privileges [.label.badge-beta-relnotes]#Beta#::
...
It is in [.badge.badge-beta-relnotes]#Beta# and off by default, but the option to turn it on or off individually is on by default.
...
In this release, ThoughtSpot introduces the Visual Embed SDK package [.label.badge-beta-relnotes]#Beta# to help developers embed the ThoughtSpot search functionality, Liveboards, visualizations, or the full application in their web page, portal, or business solution.  For more information on embedding ThoughtSpot, see xref:intro-embed.adoc[ThoughtSpot embedding solution].
[#spotdev-portal]
SpotDev portal [.label.badge-beta-relnotes]#Beta#::
...
Embrace now supports Oracle Autonomous Database [.label.badge-beta-relnotes]#Beta#.
This feature is in beta and disabled by default.
To enable this feature, contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support].
