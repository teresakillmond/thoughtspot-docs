...
For these instructions, see xref:ts-cloud-getting-started.adoc[Getting Started with ThoughtSpot Cloud].+++</dlentry>+++
...
See xref:geomap-reference.adoc[Geo Map Reference].+++</dlentry>+++
...
See xref:geomap-reference.adoc[Geo Map Reference].+++</dlentry>++++++<dlentry id="learning-cards">+++Learning cards::::
...
For more information, see xref:connections.adoc[Connections].+++</dlentry>+++
...
* *TML for tables with row-level security:* ThoughtSpot now supports the migration and editing of tables with xref:security-rls-concept.adoc[row level security (RLS)] using xref:tml.adoc#syntax-tables[TML].+++</dlentry>+++
...
This does not affect the display of summaries for users on the classic answer experience.+++</dlentry>++++++<dlentry id="admin-console">+++UI improvement for help customization::::  This release improves the UI and user experience of the xref:customize-help.adoc[Help customization] section of the admin console.+++</dlentry>+++
...
Refer to xref:consumption-pricing.adoc#user-activity[Consumption-based pricing] for more information.+++</dlentry>++++++<dlentry id="admin-privileges">+++New admin privileges [.label.label-beta]#Beta#::::
...
For further details, see xref:audit-logs.adoc[Collect security logs].+++</dlentry>++++++<dlentry id="admin-console">+++UI improvement for scheduled maintenance::::  This release improves the UI and user experience of the xref:scheduled-maintenance.adoc[Scheduled maintenance] section of the admin console.+++</dlentry>+++
...
+ For more information, see xref:public-api-reference.adoc[REST API reference].+++</dlentry>+++
...
See xref:tml.adoc#syntax-worksheets[Syntax of the Worksheet TML file].+++</dlentry>+++
...
[#april-cloud-analyst]
=== For the Analyst
+++<dlentry id="scriptability">+++Scriptability::::  There are several enhancements to the xref:scriptability.adoc[Scriptability] feature:
...
See xref:public-api-reference.adoc[REST API reference].+++</dlentry>++++++<dlentry id="developer-portal">+++ThoughtSpot Developer portal::::
...
Refer to xref:public-api-reference.adoc[REST API reference].+++</dlentry>++++++<dlentry id="spotiq-analyze">+++Support for SpotIQ Analyze::::
