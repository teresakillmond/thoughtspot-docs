...
ThoughtSpot Cloud 9.0.0.cl is now available.
...
****
In this release, we introduce Early Access features. Administrators can selectively enable or disable Early Access features for all users. For more about Early Access features, see xref:release-lifecycle.adoc#early-access[ThoughtSpot Cloud release life cycle].
****
