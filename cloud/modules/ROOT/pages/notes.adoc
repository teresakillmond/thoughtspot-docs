...
ThoughtSpot 8.1.0.cl is now available.
...
* <<february-cloud-2022-first,For the First user>>
* <<february-cloud-2022-analyst,For the Analyst>>
* <<february-cloud-2022-business-user,For the Business User>>
* <<february-cloud-2022-data-engineer,For the Data Engineer>>
* <<february-cloud-2022-it-ops-engineer,For the IT Ops Engineer>>
* <<february-cloud-2022-developer,For the Developer>>

[#february-cloud-2022-first]
=== For the First User

[#february-cloud-2022-analyst]
=== For the Analyst

[#february-cloud-2022-business-user]
=== For the Business User

[#february-cloud-2022-data-engineer]
...
New region for AWS in Japan::
TBD.

[#february-cloud-2022-it-ops-engineer]
=== For the IT Ops Engineer

[#february-cloud-2022-developer]
=== For the Developer
...
Refer to xref:thoughtspot-one-homepage.adoc#quick-links[ThoughtSpot One home page] for more information about watchlist metrics.
...
Refer to xref:thoughtspot-one-homepage.adoc#trending[ThoughtSpot One home page] for more information.
...
It is on by default.
See xref:search-answers.adoc[Search Answers] and xref:thoughtspot-one-homepage.adoc[ThoughtSpot One home page] for more information.
[#bulk-share]
...
Refer to xref:thoughtspot-one-homepage.adoc#bulk-share[ThoughtSpot One home page].
[#details-panel]
...
To enable ThoughtSpot One, https://community.thoughtspot.com/customers/s/contactsupport[contact ThoughtSpot Support].
[#internet-explorer]
