...
It is in [.badge.badge-beta]#Beta# and off by default, but the option to turn it on or off individually is on by default.
...
In this release, ThoughtSpot introduces the Visual Embed SDK package [.label.badge-beta]#Beta# to help developers embed the ThoughtSpot search functionality, Liveboards, visualizations, or the full application in their web page, portal, or business solution.  For more information on embedding ThoughtSpot, see xref:intro-embed.adoc[ThoughtSpot embedding solution].
[#spotdev-portal]
...
Embrace now supports Oracle Autonomous Database [.label.badge-beta]#Beta#.
This feature is in beta and disabled by default.
To enable this feature, contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support].
