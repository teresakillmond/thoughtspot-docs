...
To set up a custom domain in your ThoughtSpot Cloud URL, xref:support-contact.adoc[contact ThoughtSpot Support].
...
<ul><li>Custom calendar offers <span class="badge badge-update">Beta</span> support for Redshift, Teradata, Starburst, Synapse, and SAP HANA connections. These are off by default. To enable them, xref:support-contact.adoc[contact ThoughtSpot support].</li><li>Streamlined custom calendar window with the ability to preview calendar data.</li>
...
To enable this feature, contact xref:support-contact.adoc[ThoughtSpot Support].
+
...
To know how to enable this setting by default on Safari for a ThoughtSpot embedded instance, xref:support-contact.adoc[contact ThoughtSpot Support].
...
To enable ThoughtSpot One, xref:support-contact.adoc[contact ThoughtSpot Support].
[#internet-explorer]
...
You do not need to xref:support-contact.adoc[Contact ThoughtSpot Support] to see your users' Search on Answers data in the Liveboard.
...
To enable this functionality, xref:support-contact.adoc[contact ThoughtSpot Support].
