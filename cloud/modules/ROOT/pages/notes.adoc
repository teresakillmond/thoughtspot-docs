...
.image:cal-outline-blue.svg[Inline,25] Release 8.3.0.cl coming soon!
****
ThoughtSpot plans to upgrade customer clusters starting on May 20.

See the xref:index.adoc#next-release[highlights] of the 8.3.0.cl release.
****
