...
* xref:spotapps-procurement-vulnerability.adoc[Procurement Vulnerability]: Use this SpotApp to investigate, understand, and prevent supply chain vulnerability across geographies.
