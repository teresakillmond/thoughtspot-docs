...
NOTE: The `STATE` column is visible through some ETL tools, such as Matillion, but not visible through other ETL tools, such as Fivetran. If the column does not appear on your ETL tool, you can ignore the column during mapping.
