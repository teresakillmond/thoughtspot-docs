...
If you want to customize the application domain URL that appears in the browser, please xref:support-contact.adoc[contact ThoughtSpot Support] to initiate a URL change request.
