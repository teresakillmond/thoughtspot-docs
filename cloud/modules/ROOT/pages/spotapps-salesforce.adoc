...
Use the {spotapp} to view and analyze data about your total deals closed and booked for each quarter, the deals in your pipelines, and the creators of your pipelines.
...
// may need to update the above sections if vishwa tells me this is snowflake-only
