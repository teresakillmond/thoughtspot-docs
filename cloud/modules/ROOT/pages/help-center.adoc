...
|*Expert Requests* |Your existing ThoughtSpot xref:expert-ask.adoc[Expert requests], so you can see when a ThoughtSpot expert in your organization responds to your question, or provide expert help to others.
