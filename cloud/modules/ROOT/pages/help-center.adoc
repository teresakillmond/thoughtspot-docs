...
Tutorials::
View several longer, more in-depth tutorials on how to use specific aspects of the product, and revisit walkthroughs for new areas of the product. This section contains buttons to restart the home page and Data workspace tours, a short keyword reference, and in-depth videos about joins, worksheets, and formulas.
