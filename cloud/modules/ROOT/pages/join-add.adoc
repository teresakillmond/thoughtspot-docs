...
NOTE: You cannot create range joins or primary key/foreign key relationships in the UI. You must xref:tml.adoc#table-join-functionality[use TML] to create range joins, and use TQL for primary key/foreign key relationships.
