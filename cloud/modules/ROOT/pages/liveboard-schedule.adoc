...
. Click the *Schedule* button to the left of the ellipses icon to create a new schedule. To modify an existing schedule, click the *more options* menu image:icon-more-10px.png[more options menu icon] and select *Manage schedules*.
