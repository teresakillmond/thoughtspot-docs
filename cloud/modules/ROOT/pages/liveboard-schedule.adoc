...
+
If you schedule a Liveboard hourly or every _n_ minutes, ThoughtSpot bases the schedule on when you first schedule the Liveboard. For example, if you schedule a Liveboard to repeat every 3 hours, and you first click on *Schedule* at 8:14 A.M., ThoughtSpot sends it you at 11:14 A.M., 2:14 P.M., and so on.
+
