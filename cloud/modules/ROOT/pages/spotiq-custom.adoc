...
image::spotiq-menu-items.png[SpotIQ icon in the top right corner of an answer]
...
The *SpotIQ* insights page has an option to customize a single analysis. Select *Customize analysis* in the top right corner.

image::spotiq-customize-locations.png[Select Customize analysis in the top right corner.]
