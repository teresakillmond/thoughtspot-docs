= ["Delete a table with dependent objects from a BigQuery connection"]
...
See link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-gbq-delete-table.html[Delete a table from a BigQuery connection]
