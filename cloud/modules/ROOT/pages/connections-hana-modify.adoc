...
:linkattrs:
:experimental:
:description: Learn how to modify an SAP HANA connection and its tables.
...
See xref:connections-hana-modify.adoc#deleting-a-table-with-dependent-objects[Deleting a table with dependent objects].
