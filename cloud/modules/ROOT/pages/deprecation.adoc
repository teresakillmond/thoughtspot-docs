...
== De-supported in January Cloud (8.0.0.cl)

The January Cloud (8.0.0.cl) release of ThoughtSpot Software, targeted for January 2022 (GA), will drop support for the following feature:
