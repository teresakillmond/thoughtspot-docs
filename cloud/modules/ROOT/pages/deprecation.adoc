...
The 8.3.0.cl release of ThoughtSpot Cloud, targeted for April 2022 (GA), will *deprecate* the following features. ThoughtSpot will drop support for these features in a later release.

If you have the new Liveboard experience turned on in 8.3.0, these features are *de-supported* in 8.3.0. To use these features, turn the new Liveboard experience off.
