...
Note that if you are analyzing a KPI chart, you must select two points from the sparkline visualization. You cannot run change analysis on a KPI chart with no sparkline visualization.
