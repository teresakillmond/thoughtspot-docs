...
Contextual change analysis displays an AI-generated summary of the changes in your data. Once this feature is enabled, your ThoughtSpot administrator can grant you access to the AI-generated summary by assigning the *Can preview ThoughtSpot Sage* user privilege to your user group.
