...
See xref:connections-amazon-aurora-postgresql-delete-table-dependencies.adoc[Delete a table with dependent objects].
...
> **Related information**
>
> * xref:connections-amazon-aurora-postgresql-add.adoc[Add a {connection} connection]
> * xref:connections-amazon-aurora-postgresql-edit.adoc[Edit a {connection} connection]
> * xref:connections-amazon-aurora-postgresql-remap.adoc[Remap a {connection} connection]
> * xref:connections-amazon-aurora-postgresql-delete-table-dependencies.adoc[Delete a table with dependent objects]
> * xref:connections-amazon-aurora-postgresql-delete.adoc[Delete a {connection} connection]
