...
NOTE: If the Data Literacy feature enabled, the process of choosing a data source is different. For more information, see xref:search-choose-data-source.adoc#search-choose-data-source-data-literacy[Choosing a data source with Data Literacy]
