...
[#properties]
properties::
The list of properties of a view column, a view itself, or the properties of the output for a formula within a view.
+
...
+
Views can have the following properties that affect query generation: `is_bypass_rls`, and `join_progressive`.
