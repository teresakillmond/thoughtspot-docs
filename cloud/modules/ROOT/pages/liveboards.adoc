...
Notice that you can explore any visualization, follow any KPI, or perform a number of other actions using the *more options menu* at the upper right corner of a visualization image:icon-more-10px.png[More menu icon].
...
To export a scriptable file, click the *More* icon image:icon-more-10px.png[More menu icon] at the upper right corner of the Liveboard, and select *Export TML*.
