...
xref:chart-change.adoc[*Configure the chart*] by clicking the gear element: image:gear-icon.png[gear].+++<script src="https://fast.wistia.com/embed/medias/y633w03qzm.jsonp" async="">++++++</script>++++++<script src="https://fast.wistia.com/assets/external/E-v1.js" async="">++++++</script>+++
