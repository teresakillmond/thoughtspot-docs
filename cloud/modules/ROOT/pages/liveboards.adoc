...
Liveboards are interactive, allowing you to perform actions like link:{{ site.baseurl }}/complex-search/drill-down.html[drilling down] on answers, link:{{ site.baseurl }}/complex-search/pinboard-filters.html[filtering], excluding values, and xref:answer-explorer.adoc[exploring] answers or headlines.
...
link:{{ site.baseurl }}/end-user/search/change-the-chart.html[*Configure the chart*] by clicking the gear element: image:gear-icon.png[gear].+++<script src="https://fast.wistia.com/embed/medias/y633w03qzm.jsonp" async="">++++++</script>++++++<script src="https://fast.wistia.com/assets/external/E-v1.js" async="">++++++</script>+++
...
* xref:download-liveboard-pdf.adoc[Download a Liveboard as PDF]
* xref:start-a-slideshow.adoc[Present a Liveboard]
