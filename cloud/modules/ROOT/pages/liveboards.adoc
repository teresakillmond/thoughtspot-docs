...
Notice that you can explore any visualization, follow any KPI, or perform a number of other actions using the *more options menu* at the top right corner of a visualization image:icon-more-10px.png[].
...
. Select the *Edit* button at the top right of the Liveboard. If you do not see this button, you do not have edit privileges for the Liveboard. To resolve this, contact your administrator or the creator of the Liveboard.
