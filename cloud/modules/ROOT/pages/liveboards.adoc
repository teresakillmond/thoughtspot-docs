...
To export a scriptable file, select the *More* icon image:icon-more-10px.png[More menu icon] at the upper-right corner of the Liveboard, and select *Export TML*.
