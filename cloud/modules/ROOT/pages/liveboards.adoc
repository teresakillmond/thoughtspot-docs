...
To present a Liveboard, select the *More* icon image:icon-more-10px.png[More menu icon] at the top right corner of the Liveboard, and select *Present*.
...
To download a Liveboard, select the *More* icon image:icon-more-10px.png[More menu icon] at the top right corner of the Liveboard, and select *Download as PDF*.
You can download the whole Liveboard, or just certain visualizations.

To export a scriptable file, select the *More* icon image:icon-more-10px.png[More menu icon] at the top right corner of the Liveboard, and select *Export TML*.
