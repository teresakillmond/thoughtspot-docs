...
. To copy an individual visualization link, click the ellipses icon image:icon-ellipses.png[more options menu icon] to the right of the visualization you would like to copy a link from and select *Copy embed link*.
+
