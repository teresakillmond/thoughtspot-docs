...
. Click the *more options* icon image:icon-more-10px.png[more options menu icon] and select *Copy embed link*.
+
...
. To copy an individual visualization link, click the *more options* icon image:icon-more-10px.png[more options menu icon] to the right of the visualization you would like to copy a link from and select *Copy embed link*.
+
