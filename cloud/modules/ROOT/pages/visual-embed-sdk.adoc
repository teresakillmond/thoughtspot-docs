...
:description: The Visual Embed SDK provides a JavaScript library to embed Search, visualizations, Liveboards, and the full application experience in an application, product, or web portal.
