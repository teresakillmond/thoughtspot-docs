...
* xref:thoughtspot-one-homepage.adoc[Home page] [.badge.badge-update]#New# +
This is where you get direct access to existing Answers, Liveboards, and visualizations.
* xref:pinboards.adoc[More about Liveboards and Answers] +
Quick tips on how you can use and customize Liveboards and Charts.
* <a href="{{ "/end-user/search/search-overview.html "| prepend: site.baseurl }}">ThoughtSpot Search</a> +
We expanded our flagship Search functionality.
In addition to the traditional xref:search-data.adoc[Search over Data], ThoughtSpot now supports a powerful set of features that helps users get their information from existing content through xref:search-answers.adoc[Search over Answers] [.badge.badge-update]#New#.
* xref:search-assist.adoc[Search Assist] +
See how ThoughtSpot Search Assist gives you insights into your own data.
* <a href="{{ "/admin/mobile/use-mobile.html "| prepend: site.baseurl }}">Mobile App</a> +
