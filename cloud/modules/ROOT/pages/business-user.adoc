...
* link:business-user-onboarding.html[Onboarding for Business users] +
Get a quick overview of how ThoughtSpot can support you.
* <a href="{{ "/end-user/thoughtspot-one/thoughtspot-one-homepage.html "| prepend: site.baseurl }}">Home page [.badge.badge-update]#New#</a> +
This is where you get direct access to exisiting Answers, Liveboards, and visualizations.
* link:pinboards.html[More about Liveboards and Answers] +
...
* link:search-assist.html[Search Assist] +
