...
[NOTE]
====
If your organization uses xref:orgs-overview.adoc[multi-tenancy with Orgs], ThoughtSpot does not support OIDC integration for authentication. You must use xref:authentication-local.adoc[local authentication].
====
