...
You can use any data source (table, worksheet, or view) that you have access to for the gating condition, since ThoughtSpot executes the query at user-level.
...
At the scheduled time, ThoughtSpot executes the gating condition query at user-level.
