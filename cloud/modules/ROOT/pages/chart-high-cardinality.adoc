...
The footer text may say `Showing 1,000 of many rows`, instead of specifying the number of rows, if ThoughtSpot receives an unknown number of rows.
...
The footer text may say `Showing 1,000 of many data points`, instead of specifying the number of data points, if ThoughtSpot receives an unknown number of data points.
