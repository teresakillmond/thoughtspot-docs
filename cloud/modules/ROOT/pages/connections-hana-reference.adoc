...
Team administrators can manage what functionality other users can access by hitting kbd:[command] / kbd:[control] + kbd:[k], and searching for "Roles". The following roles are available:
