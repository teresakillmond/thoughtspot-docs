...
+
image::{{ site.baseurl }}/images/growthofkeyword.png[Suggestions for the 'growth of' keyword]
+
...
+
image::{{ site.baseurl }}/images/growthof-waterfall.png[Growth of total sales by monthly date waterfall chart]
...
+
image::{{ site.baseurl }}/images/growthof-yearoveryear.png[Growth of sales by monthly year-over-year]
+
...
+
image::{{ site.baseurl }}/images/growthof-addattribute.png[Growth of sales broken up by department]
...
image::{{ site.baseurl }}/images/growthof-monthovermonth.png[Growth of sales by date daily month-over-month]
