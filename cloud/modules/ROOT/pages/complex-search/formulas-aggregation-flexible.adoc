...
* To learn about aggregation formulas in general, see xref:formulas-aggregation.adoc#[Overview of aggregate formulas] and link:about-pinned-measures.html#[Group aggregation functions]
