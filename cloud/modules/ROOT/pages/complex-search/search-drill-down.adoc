...
If you want to go back one step at a time while drilling down, xref:about-liveboards.adoc#add-an-answer-to-a-pinboard[add your answer to a Liveboard] so you can use Answer Explorer.
