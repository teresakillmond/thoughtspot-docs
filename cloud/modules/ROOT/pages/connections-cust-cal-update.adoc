...
. On the Custom calendar page, click the More menu image:{{ site.baseurl }}/images/icon-ellipses.png[more options menu icon] next to the custom calendar you want to update, and select *Update Calendar*.
...
. Click the More menu image:{{ site.baseurl }}/images/icon-ellipses.png[more options menu icon] next to the custom calendar you want to update, and select *Download as CSV*.
...
. Go to the next section to link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-cust-cal-update#upload-cal[upload your calendar file].
