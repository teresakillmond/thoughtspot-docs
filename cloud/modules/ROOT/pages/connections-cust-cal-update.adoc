...
xref:connections-cust-cal-create.adoc[Create a custom calendar] + xref:connections-cust-cal-delete.adoc[Delete a custom calendar] + xref:connections-cust-cal.adoc[Custom calendar overview] + xref:formulas-date.adoc#fiscal-and-gregorian-calendars[Fiscal and Gregorian calendars]
