...
| Learn how to use ThoughtSpot | Contains search replays created in the system. This Liveboard is not available with the xref:answer-experience-new.adoc[new Answer experience].
