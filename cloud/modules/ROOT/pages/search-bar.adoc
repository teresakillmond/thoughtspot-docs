...
xref:search-columns.adoc#measures[Measures] are green, xref:search-columns.adoc#attributes[attributes] are blue, and link:{{ site.baseurl }}/complex-search/about-filters.html#[filters] are gray.
