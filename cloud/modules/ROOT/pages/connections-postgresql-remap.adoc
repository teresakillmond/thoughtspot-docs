...
:description: Learn how to remap a PostgreSQL connection.
...
+
image::postgresql-remapping.png[Select "Remapping"]

. Select *Download* to download the source mapping file.
+
image::postgresql-downloadyaml.png["Download the source mapping file"]
