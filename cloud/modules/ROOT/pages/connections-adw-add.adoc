...
+
image::embrace-adw-connection-type-ts-cloud.png[Add an {connection} connection]

. Enter the connection details for your {connection} data source, and upload your {connection} Wallet zip file.
+
image::adw-connectiondetails.png[Enter connection details]
+
Refer to the xref:connections-adw-reference.adoc[{connection} connection reference] for more information on each of the specific attributes you must enter for your connection.
...
After you add the connection, you can search your {connection} database by clicking *Search now*.
...
You can also xref:connections-adw-delete.adoc[Delete an {connection} connection].
