...
.. Click *+ ADD DOMAIN* to reveal the *Authorized domain 1* field. In this field, enter the domain of the URL to your ThoughtSpot instance. For example, if ThoughtSpot hosts your instance at `https://<instance_name>.thoughtspot.cloud.com`, the domain is `thoughtspot.cloud.com`.
+
...
For example, +
`\https://thoughtspot.cloud.com/callosum/v1/connection/generateTokens`.
+
