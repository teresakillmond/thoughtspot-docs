...
== Create a threshold-based KPI alert ([.badge.badge-update]#Beta#)

NOTE: Threshold-based alerts are beta and off by default in 8.5.0.cl. To enable this feature, contact {support-url}.
...
ThoughtSpot emails you a notification of your KPI monitor schedule. Use the links in the email to view your KPI, modify the alert schedule, or unsubscribe from updates in your KPI at any time.
...
- When creatinng an alert for a KPI pinned to a Liveboard, you must first save any changes to the Liveboard containing your KPI.
