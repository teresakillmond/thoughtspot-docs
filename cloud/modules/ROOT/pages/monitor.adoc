...
NOTE: Monitor is in beta and off by default. To join the beta trial, click on the *Admin* tab, select *Search and SpotIQ* from the sidebar, and enable *Monitor* under *SpotIQ settings*.
