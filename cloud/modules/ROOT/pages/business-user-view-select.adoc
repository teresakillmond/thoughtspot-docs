...
You can xref:follow-liveboard.adoc[follow] this Liveboard, so you get notifications for major changes to the data it represents.

With Liveboards, you can link:{{ site.baseurl }}/complex-search/drill-down.html[drill down] to a chart or table's underlying data for a deeper understanding, or follow an AI-guided exploration of a visualization or headline metric using xref:answer-explorer.adoc[Answer Explorer].
