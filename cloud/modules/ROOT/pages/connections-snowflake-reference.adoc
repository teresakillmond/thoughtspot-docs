...
[#account-name]
Account name::
Enter the account name associated with your {connection} connection.
...
+
Scope maps to a role in your Snowflake database. It should be similar to `session:role:developer offline_access`.
[#oauth-url]
