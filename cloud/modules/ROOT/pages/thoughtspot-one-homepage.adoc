...
:description: Learn about the ThoughtSpot One home page, where you can search across existing answers and Liveboards and access trending objects, recently viewed objects, and your favorites.
