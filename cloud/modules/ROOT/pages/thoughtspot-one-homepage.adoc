...
Alternatively, you can select each object on the page, by selecting the empty box next to the word *Name* at the upper left of the screen, under the filter bar.
+
Note that you cannot select multiple objects across pages.
