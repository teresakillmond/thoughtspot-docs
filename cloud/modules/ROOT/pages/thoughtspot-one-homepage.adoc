...
. Select a metric or multiple metrics, and select *Add metrics*.
...
* *By author*: To see objects created by a specific user, select an author from the authors drop-down in the filter bar, or select the author of an object in the list of objects on the home page.
