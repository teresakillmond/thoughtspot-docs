= ThoughtSpot One home page
:last_updated: 11/05/2021
:linkattrs:
:experimental:
:page-aliases: /end-user/thoughtspot-one/thoughtspot-one-homepage.adoc
:description: Use the ThoughtSpot One home page to search across answers and Liveboards and access trending objects, recently viewed objects, and your favorites.

include::partial$liveboards-announcement.adoc[]

include::partial$includes/content/ts-one-homepage.adoc[]
...
To search across existing objects, toggle the *Search type* to *Search answers* by selecting the *Search answers* icon image:icon-eureka-8px.png[] at the top right, next to the search bar.
...
To search your data, toggle the *Search type* to *Search data to create an answer* by selecting the *Search data* icon image:icon-sage-8px.png[] at the top right, next to the search bar.
