...
You can enable shared y-axes for the two measures. To enable shared y-axes, select the drop-down menu icon image:icon-caret-right-20px.png[Dropdown menu icon image] next to one of the Y-axis labels, select *Group*, and click on the unchecked measure.
