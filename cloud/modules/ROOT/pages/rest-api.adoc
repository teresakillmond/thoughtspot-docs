...
* REST API V2
+
The REST API v2 [.badge.badge-beta]#Beta# framework is a new developer-focused solution that provides additional functionality and an interactive Playground experience. The REST v2 framework also supports language-specific SDK and client libraries.
...
* To access the https://developers.thoughtspot.com/docs/?pageid=rest-api-v2[REST v2 Playground,window=_blank], select **REST Playground v2**.
