...
The SA is your main contact for architecting the ThoughtSpot solution.
The SA is a member of the paid professional services team.
The SA:

* Oversees the engagement from Launch Kickoff to Wrap-Up
* Helps define the architecture and solution approach
* Assists the customer with solution implementation
* Helps the client Product Owner with story selection and use case prioritization

=== Customer Engagement Manager (EM)

The EM implements the solution, working in tandem with the SA.
