...
xref:connections-synapse.adoc[Configure Connections for {connection}] or xref:connections-snowflake.adoc[for Snowflake], using the private DNS name from ThoughtSpot Support.