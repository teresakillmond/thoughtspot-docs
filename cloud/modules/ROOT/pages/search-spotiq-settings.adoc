...
This includes enabling, disabling, and configuring the following features: SpotIQ, column indexing, summaries, and the xref:liveboard-experience-new.adoc[new Liveboard experience].
...
You can update the <<search,search>>, <<spotiq,SpotIQ>>, and <<liveboard-experience,Liveboard experience>> settings from this page.
...
Under *SpotIQ settings*, you can enable or disable xref:spotiq-custom.adoc[SpotIQ analyze], as well as enable or disable xref:monitor.adoc[Monitor].
...
To enable or disable Monitor, follow these steps:

. Select the *Edit* button in the *SpotIQ Settings* section.
. Click on the toggle to enable or disable the feature.
. Select *Save changes*.
Alternatively, you can *Reset to default*.
By default, Monitor is disabled.
