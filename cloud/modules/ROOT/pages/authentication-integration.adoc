...
NOTE: ThoughtSpot supports configuration of a maximum of 5 IDPs. If you are using xref:orgs-overview.adoc[] or xref:okta-iam.adoc[], we do not support SAML authentication with multiple IDPs.
