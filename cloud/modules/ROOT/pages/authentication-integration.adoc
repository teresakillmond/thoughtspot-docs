...
[NOTE]
====
If your organization uses xref:orgs-overview.adoc[], ThoughtSpot does not support SAML authentication. You must use xref:authentication-local.adoc[local authentication].
====
