...
for example, username and email address. In a xref:orgs-overview.adoc[] environment, you must include an *Orgs* attribute that contains all the Orgs the user belongs to.
