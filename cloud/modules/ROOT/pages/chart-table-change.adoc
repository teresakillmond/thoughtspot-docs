...
If you want to use another type, select the *change visualization* icon image:icon-chart-type-10px.png[Chart type change icon image] and select the type of chart you want.
...
* If you are in the chart view, select the axis label of your chart that you would like to sort and select *Sort*.
...
To bucket your data in a chart view, open the *drop-down* icon image:icon-dropdown-down-20px.png[Dropdown icon image] that appears when you hover near the axis labels on a chart.
