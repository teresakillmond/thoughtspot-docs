...
== image:aws-icon.png[Amazon Redshift] Amazon Redshift
...
== image:azure-sql-data-warehouse-icon.png[Azure Synapse] Azure Synapse
...
== image:databricks.png[Databricks]Databricks
...
== image:gcp-big-query-icon.png[Google BigQuery] Google BigQuery
...
== image:oracle-adw-icon.svg[Oracle ADW] Oracle ADW
