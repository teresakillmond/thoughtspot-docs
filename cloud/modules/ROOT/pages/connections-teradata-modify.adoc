...
:linkattrs:
:experimental:
:description: Learn how to modify a Teradata connection and its tables.
...
For more information, see xref:connections-teradata-modify.adoc#deleting-a-table-from-a-Teradata-connection[Deleting a table].
