...
+
<<<<<<< HEAD
NOTE: You can view data labels on a dark background. This feature is disabled by default. To enable it, contact your ThoughtSpot administrator.
+
...
>>>>>>> 23e52e9a70fec5de6c26293f0856ef7b593b7dce
