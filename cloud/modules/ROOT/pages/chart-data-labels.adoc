...
****
You can now view data labels on a dark background. This feature is an Early Access feature, and disabled by default. To enable it, contact your ThoughtSpot administrator. For more about Early Access features, see xref:release.adoc#early-access[ThoughtSpot Cloud release life cycle].
****
