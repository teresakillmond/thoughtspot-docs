...
+
NOTE: Data labels are visible even in dark background charts, by default it is disabled. Admins can enable it through the admin portal.
+
****
[.badge.badge-early-access]#Early Access# Data labels in a chart can now be visible even on a dark background. This feature is disabled by default. To enable it contact your ThoughtSpot administrator.
****
+
.[.badge.badge-early-access]#Early Access#
****
You can now view chart data labels on a dark background. This feature is disabled by default. To enable it, contact your ThoughtSpot administrator.
****
