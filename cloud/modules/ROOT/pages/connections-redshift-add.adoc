...
. Enter the connection details for your {connection} data source using Service Account, IAM or OAuth. The user must have at least *read* access to the *SVV_TABLE_INFO* table.
+
