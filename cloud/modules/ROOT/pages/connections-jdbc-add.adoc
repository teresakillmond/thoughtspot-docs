...
+
Refer to the xref:connections-jdbc-reference.adoc[{connection} connection reference] for more information on each of the specific attributes you must enter for your connection.
...
You can also xref:connections-jdbc-delete.adoc[Delete a {connection} connection].
