...
Or you can filter by clicking on a *\{blank}*, *\{empty}*, or *\{null}*  value in your search result table, then selecting *Show only "\{value}"*.

image::formula_null_empty_merge.png[Filter by clicking and selecting Show only <value>]
