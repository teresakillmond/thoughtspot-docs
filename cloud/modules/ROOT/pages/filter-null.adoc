...
If you need to differentiate between NULL and blank values, you can link:formula-add.adoc#[Add a formula] to make them appear differently in charts and tables.
...
If you want to keep the same display format for NULL and blank values, but be able to filter on both using "\{blank}", your link:formula-add.adoc#[formula] will be slightly different.
