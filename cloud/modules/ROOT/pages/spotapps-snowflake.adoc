...
[#option-2]
==== Option 2
The following SQL commands grant permission for the role you use in your {application} connection to use the {application} database. They prepare you to query on the system database directly. Replace the *YOUR_ROLE* with your specific information, either the SYSADMIN or a custom SpotApps role.
