...
You must include the resource URL in the scope you pass with the authorization request. In this case, it is URL of the {connection} server.
...
* xref:connections-synapse-delete-table.adoc[Delete a table from a v connection]
