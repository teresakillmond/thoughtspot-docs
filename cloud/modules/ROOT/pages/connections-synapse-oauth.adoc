...
If the following error appears (`InvalidClientError`) on initial login, you must update the API permissions.

image::synapse-oauth-error1.png[An InvalidCientError error message]
