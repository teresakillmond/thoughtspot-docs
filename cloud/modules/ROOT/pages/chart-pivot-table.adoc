...
If you would like to visualize your search as a pivot table, click on the *change visualization* icon image:icon-chart-type-10px.png[Chart type icon image] near the top right of your screen, and select *pivot table*.
...
To see your data as a percent, click the *edit chart configuration* image:icon-gear-10px.png[Chart configuration icon image] icon, and click *settings* at the bottom of the chart configuration panel.
Click on the drop-down menu to choose whether you want to see your data as a percent of a row or column total, or as a percent of the grand total.
...
To turn on the heatmap, click the *edit chart configuration* image:icon-gear-10px.png[Chart configuration icon image] icon, and click *settings* at the bottom of the chart configuration panel.
Select *heatmap mode*.
