...
If you would like to visualize your search as a pivot table, select the *change visualization* icon image:icon-chart-type-10px.png[Chart type icon image] near the top right of your screen, and select *pivot table*.
...
To turn on the heatmap, select the *edit chart configuration* icon image:icon-gear-10px.png[Chart configuration icon image], and select *Settings* at the bottom of the chart configuration panel.
Select *heatmap mode*.
...
Select *Edit chart configuration* image:icon-gear-10px.png[chart config icon], and select the measure you would like to add number or conditional formatting to.
