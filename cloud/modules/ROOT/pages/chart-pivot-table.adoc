...
* Pivot tables display your chosen measure(s) in the column row header, not in the row heading. ThoughtSpot does not support measures in the pivot row heading.
