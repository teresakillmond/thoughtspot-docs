...
****
The AI-generated synonyms feature is a private preview feature and is disabled by default. To enable it, contact your ThoughtSpot administrator. For more about Private Preview features, see xref:release-lifecycle.adoc#private-preview[ThoughtSpot Cloud release life cycle].
****
