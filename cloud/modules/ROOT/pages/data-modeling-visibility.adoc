...
****
The AI-generated synonyms feature is a private preview feature and is disabled by default. To enable it, contact {support-url}. Once enabled, your ThoughtSpot administrator can grant you access to this feature by assigning the *Can preview ThoughtSpot Sage* user privilege to your user group. For more about Private Preview features, see xref:release-lifecycle.adoc#private-preview[ThoughtSpot Cloud release life cycle].
****
