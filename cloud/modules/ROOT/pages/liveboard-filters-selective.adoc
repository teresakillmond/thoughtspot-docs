...
You can apply Liveboard filters to specific visualizations from the Filters modal.
...
. In the top menu bar, select *Add filter*. If you already created the filter you would like to link, click on the filter in the filters bar below the Liveboard name, and proceed to step 5.
