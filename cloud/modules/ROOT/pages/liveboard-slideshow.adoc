...
. Select a Liveboard from the list of Liveboards by selecting its title.
...
image::pinboard-present-controls-new-experience.png[Liveboard presentation controls in the top right corner]
