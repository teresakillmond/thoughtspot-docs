...
. Specify if you want to search across answers and Liveboards created by all users (default), or just certain users (including yourself). You can also filter by an author by clicking on the author of an object in the list of search results.
