...
Before you create a sync to {connection}, log in to find your *API key*. You need this information to set up your connection.
...
. If this is the first sync you have created for {connection}, a pop-up authorization window appears. Enter the API key, which you generate in Gainsight.
