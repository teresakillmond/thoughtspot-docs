...
:description: Learn about TQL, ThoughtSpot's SQL command line.
...
. Issue a `CREATE TABLE` command for each table you will create, using the information in xref:schema-plan.adoc#[Plan the schema].
+
