...
image::model_additive_model_false_options.png[Options for an Attribute column with Additive set to NO]
...
image::model_additive_model_true_options.png[Options for an Attribute column with Additive set to YES]
