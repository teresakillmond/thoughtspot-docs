...
<li><a href="https://docs.thoughtspot.com/cloud/latest/connections-presto">Presto <span class="badge badge-new">New!</span></a></li>
<li><a href="https://docs.thoughtspot.com/cloud/latest/connections-trino">Trino <span class="badge badge-new">New!</span></a></li>
<li><a href="https://docs.thoughtspot.com/cloud/latest/connections-starburst-oauth">Starburst Azure AD OAuth <span class="badge badge-new">New!</span></a></li>
    </ul>
    </ul>
    </div>
      <div class="box">
...
include::partial$whats-new-8-9-0-cl.adoc[What's new in 8.9.0.cl]