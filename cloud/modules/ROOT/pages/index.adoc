...
See the <<next-release,highlights>> of the 8.3.0.cl release.
****
...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        ...
        <li><a href="https://docs.thoughtspot.com/cloud/latest/notes#data-tab">Data tab redesign <span class="badge badge-update">Beta</span></a></li>
    </ul>
    </div>
      <div class="box">
        ...
        <ul>
        <li><a href="https://docs.thoughtspot.com/cloud/latest/notes#8-2-0-cl-it-ops-engineer">Okta Authentication <span class="badge badge-update">Beta</span></a></li>
...
include::partial$whats-new-8-3-0-cl.adoc[What's new in 8.3.0.cl]