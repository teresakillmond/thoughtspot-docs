...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        ...
        <ul><li><img src="_images/redshift_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-redshift-oauth">Redshift OAuth <span class="badge badge-new">New!</span></a></li></li>
...
<li><a href="https://docs.thoughtspot.com/cloud/latest/ts-cloud-requirements-support">Japan Cloud region <span class="badge badge-new">New!</span></a></li></ul></ul>
    </ul>
    </div>
      <div class="box">
