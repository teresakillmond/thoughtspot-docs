...
include::partial$cloud-coming-soon.adoc[What's new in 8.6.0.cl]
...
<li><img src="_images/denodo_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-denodo-oauth">Denodo OAuth <span class="badge badge-new">New!</span></a></li>
    </ul>
    </div>
      <div class="box">
...
//
// include::partial$whats-new-8-8-0-cl.adoc[What's new in 8.6.0.cl]
