...
.columns .box2:first-child, .columns .box-home:first-child, .columns .box:first-child, .main-home .columns .box:first-child {
  margin-top: -20px;
}
...
[cols="30,3,~",frame=none,grid=none]
|===
a| image::ts-cloud-new.png[] | .^   a| image:cal-outline-blue.svg[Inline,25] *Release 8.2.0.cl coming soon!*

ThoughtSpot plans to upgrade customer clusters from April 13 - 20, 2022.

See the <<next-release,highlights>> of the 8.2.0.cl release, or see a preview of the xref:notes.adoc#next-release[release notes].
| | |
|===
...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        ...
        <li><img src="_images/redshift_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-redshift-oauth">Redshift OAuth <span class="badge badge-new">New!</span></a></li>
        <li><img src="_images/synapse_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-synapse-oauth">Synapse OAuth <span class="badge badge-new">New!</span></a></li>
    </ul>
    </div>
      <div class="box">
