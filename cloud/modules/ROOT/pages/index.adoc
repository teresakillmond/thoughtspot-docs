...
.image:cal-outline-blue.svg[Inline,25] Release 8.2.0.cl coming soon!
****
ThoughtSpot plans to upgrade customer clusters starting on April 22, 2022.

See the <<next-release,highlights>> of the 8.2.0.cl release.
****
...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        <li><a href="https://docs.thoughtspot.com/cloud/latest/connections">Connections</a></li><ul>

        <li><img src="_images/logo-redshift.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-redshift">Amazon Redshift</a></li>
        <ul><li><img src="_images/redshift_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-redshift-oauth">Redshift OAuth <span class="badge badge-new">New!</span></a></li></ul></li>
        <li><img src="_images/logo-synapse.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-synapse">Azure Synapse</a></li><ul><li><img src="_images/synapse_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-synapse-oauth">Synapse OAuth <span class="badge badge-new">New!</span></a></li></ul>
        <li><img src="_images/logo-databricks.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-databricks">Databricks</a></li>
        <li><img src="_images/logo-gcp.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-gbq">Google BigQuery</a></li>
        <li><img src="_images/logo-awd.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-adw">Oracle ADW</a></li>
        <li><img src="_images/logo-sap.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-hana">SAP HANA</a></li>
        <li><img src="_images/logo-snowflake.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-snowflake">Snowflake</a></li><ul>
        <li><img src="_images/snowflake_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-snowflake-azure-ad-oauth">Azure AD OAuth</a></li></ul>
        <li><img src="_images/logo-starburst.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-starburst">Starburst</a></li>
        <li><img src="_images/logo-teradata.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-teradata">Teradata</a></li></ul>
...
include::partial$whats-new-8-2-0-cl.adoc[What's new in 8.2.0.cl]
