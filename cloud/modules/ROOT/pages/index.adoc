...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        ...
        <li><img src="_images/snowflake_sm.png" width="20px" alt="more options menu icon" class="inline"/>&nbsp;<a href="https://docs.thoughtspot.com/cloud/ts8.nov.cl/connections-redshift">Azure AD OAuth</a></li>&nbsp;<span class="badge badge-new">New!</span></a></li>
    </ul>
    </div>
      <div class="box">
