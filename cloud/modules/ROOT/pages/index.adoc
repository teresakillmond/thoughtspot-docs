...
<li><img src="_images/databricks_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://preview-thoughtspot.netlify.app/cloud/latest/connections-databricks-partner">Databricks Partner Connect <span class="badge badge-new">New!</span></a></li>
<li><img src="_images/snowflake_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://preview-thoughtspot.netlify.app/cloud/latest/connections-snowflake-okta-oauth">Snowflake Okta OAuth <span class="badge badge-new">New!</span></a></li>
<li><img src="_images/starburst_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://preview-thoughtspot.netlify.app/cloud/latest/connections-starburst-oauth">Starburst OAuth <span class="badge badge-new">New!</span></a></li>
<li><a href="https://preview-thoughtspot.netlify.app/cloud/latest/connections-private-link-intro">AWS PrivateLink support <span class="badge badge-new">Update</span></a></li>
    </ul>
    </div>
      <div class="box">
...
include::8.4.0.cl@cloud:ROOT:partial$whats-new-8-5-0-cl.adoc[]
