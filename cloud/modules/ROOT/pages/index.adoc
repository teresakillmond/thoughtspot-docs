...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        ...
        <li><img src="_images/snowflake_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/ts8.nov.cl/connections-redshift-oauth">Redshift OAuth <span class="badge badge-new">New!</span></a></li>
        <li><img src="_images/redshift_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/ts8.nov.cl/connections-snowflake-azure-ad-oauth">Azure AD OAuth</a></li>
    </ul>
    </div>
      <div class="box">
