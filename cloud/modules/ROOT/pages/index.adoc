...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        ...
        <li><img src="_images/databricks_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-snowflake-azure-ad-oauth">Databricks OAuth</a></li>
    </ul>
    </div>
      <div class="box">
