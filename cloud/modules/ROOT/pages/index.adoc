...
****
**Upcoming release: 8.2.0.cl**

The 8.2.0.cl cloud release is coming soon! Customer clusters are scheduled for upgrade starting April 13th.

For more information about the 8.2.0.cl release, refer to the xref:latest@cloud:notes.adoc[Release Notes].
****
