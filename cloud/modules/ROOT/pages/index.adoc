...
<li><img src="_images/denodo_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://preview-thoughtspot.netlify.app/cloud/latest/connections-denodo-oauth">Denodo OAuth <span class="badge badge-new">New!</span></a></li>
    </ul>
    </div>
      <div class="box">
