...
.image:cloud-outline.svg[Embedded,30,opts=inline] Next cloud release
****

The 8.2.0.cl release is coming soon!
Customer clusters are scheduled for upgrade starting April 13th.

For more information about the 8.2.0.cl release, refer to the xref:notes.adoc[Release Notes].
****
