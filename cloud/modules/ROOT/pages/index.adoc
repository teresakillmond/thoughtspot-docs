...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        ...
        <ul><li><img src="_images/redshift_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-redshift-oauth">Redshift OAuth</a></li></ul></li>
        <li><img src="_images/logo-synapse.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-synapse">Azure Synapse</a></li><ul><li><img src="_images/synapse_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://docs.thoughtspot.com/cloud/latest/connections-synapse-oauth">Synapse OAuth</a></li></ul>
