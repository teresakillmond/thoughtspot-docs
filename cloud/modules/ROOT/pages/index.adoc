...
.image:cloud-cal-outline-blue5.svg[Inline,40] Release 8.2.0.cl coming soon!
****

ThoughtSpot plans to upgrade customer clusters from April 13 - 20, 2022.

See the xref:next-release[highlights] of the 8.2.0.cl release, or see a preview of the xref:notes.adoc#upcoming[Release Notes].
****
...
See the <<next-release,highlights>> of the 8.2.0.cl release, or see a preview of the xref:notes.adoc#upcoming[Release Notes].
