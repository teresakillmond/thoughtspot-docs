...
<li><img src="_images/dremio_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://preview-thoughtspot.netlify.app/cloud/latest/connections-dremio.html">Dremio <span class="badge badge-new">New!</span></a></li>
<li><img src="_images/oracle_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://preview-thoughtspot.netlify.app/cloud/latest/connections-adw.html">Oracle <span class="badge badge-new">New!</span></a></li>
    </ul>
    </div>
      <div class="box">
...
include::8.2.0.cl@cloud:ROOT:partial$whats-new-8-3-0-cl.adoc[]
