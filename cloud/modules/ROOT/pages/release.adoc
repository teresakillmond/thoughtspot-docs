...
Early Access features have new or enhanced functionality that an administrator can selectively enable for all users. They are supported by ThoughtSpot and documentation is available."
