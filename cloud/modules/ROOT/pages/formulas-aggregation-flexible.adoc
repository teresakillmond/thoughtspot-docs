...
****
To reduce confusion when using aggregate formulas and avoid overcounting, the level of detail defined in group formulas is now respected at query level.
