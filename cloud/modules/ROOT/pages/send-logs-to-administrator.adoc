...
:page-aliases: /admin/system-admin/send-logs-to-administrator.adoc
...
Before you can send a log bundle to ThoughtSpot Support, you must https://community.thoughtspot.com/customers/s/contactsupport[Connect to the ThoughtSpot Support file server].
