...
:description: Learn about date formulas.
...
Your ThoughtSpot administrator and ThoughtSpot Support can create a xref:connections-cust-cal.adoc[custom calendar] to start on any month.
