...
Your ThoughtSpot administrator and ThoughtSpot Support can create a link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-cust-cal.html[custom calendar] to start on any month.
...
* link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-cust-cal-create.html#[Create a custom calendar]
