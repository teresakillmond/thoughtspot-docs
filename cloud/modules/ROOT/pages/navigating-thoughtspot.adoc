...
*Monitor* contains a list of all KPI alert schedules you subscribe to. From the Monitor tab, you can view and manage all KPI alerts you create or subscribe to.
