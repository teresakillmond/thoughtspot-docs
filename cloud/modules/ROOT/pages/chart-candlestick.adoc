...
+++<a href="https://docs.thoughtspot.com/cloud/latest/glossary.html" data-toggle="tooltip" data-placement="top" title="A Liveboard is a very cool way to do things">Liveboard</a>+++
