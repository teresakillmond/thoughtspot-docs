...
Once enabled, administrators can selectively enable Private Preview features for users by assigning them the *Can preview ThoughtSpot Sage* user privilege.
