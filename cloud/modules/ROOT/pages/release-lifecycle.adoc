...
Once enabled, your ThoughtSpot administrator can grant access to Private Preview features for users in a group by assigning the *Can preview ThoughtSpot Sage* user privilege to the group.
