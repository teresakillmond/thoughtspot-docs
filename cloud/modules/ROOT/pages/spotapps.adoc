...
xref:spotapps-dei.adoc[Diversity, Equity, and Inclusion]:: Use this SpotApp to get invaluable insight into your Diversity, Equity, and Inclusion data from your HR application.
...
xref:spotapps-procurement-vulnerability.adoc[SAP Procurement Vulnerability Analysis]:: Use this SpotApp to quickly identify where disruptions could occur in your global supply chain, reducing risk and building resilience.
...
* xref:spotapps-dei.adoc[Deploying the Diversity, Equity, and Inclusion SpotApp]
...
* xref:spotapps-procurement-vulnerability.adoc[Deploying the SAP Procurement Vulnerability Analysis SpotApp]
