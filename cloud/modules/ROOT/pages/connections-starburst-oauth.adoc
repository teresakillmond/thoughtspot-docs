...
In the JDBC connection, specify the JWT in the connection URL with the parameter “access_token”.

Example:
[source]
----
jdbc:trino://10.79.143.40:8443/tpch/sf100?user=admin&accessToken=<token_from_IdP>&SSL=true&SSLVerification=NONE
----
'''
> **Related information**
>
