...
[NOTE]
====
This article is an overview for the Admin Console if your company uses the xref:orgs-overview.adoc[Orgs] feature for multi-tenancy in ThoughtSpot. If you have an Org switcher to the left of the help icon in the top navigation bar, your company is using Orgs.
...
Cluster administrators can complete the following tasks in the Primary Org's Admin Console, under *All orgs*:

*Manage Orgs*

* Create, edit, and delete Orgs. See xref:orgs-administration-overview.adoc#create-manage[Create and manage Orgs].
...
Org administrators can complete the following tasks in the Admin Console:
...
* xref:scheduled-maintenance.adoc[View scheduled maintenance:] View upcoming maintenance and downtime for the ThoughtSpot application.