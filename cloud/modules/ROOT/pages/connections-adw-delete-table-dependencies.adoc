= ["Delete a table with dependent objects from an ADW connection"]
...
See link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-adw-delete-table.html[Delete a table from an ADW connection]
