...
image:{{ site.baseurl }}/images/HANA-connectiontype.png[Add a HANA connection]
...
image:{{ site.baseurl }}/images/HANA-connectiondetails.png[Enter connection details]
// [Enter connection details]({{ site.baseurl }}/images/HANA-connectiondetails.png "Enter connection details")
+
Refer to the link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-hana-connection-reference.html#[SAP HANA connection reference] for more information on each of the specific attributes you must enter for your connection.
...
+
{% include note.html content="Any key-value pairs that you enter must be defined in your Hana data source.
...
image:{{ site.baseurl }}/images/HANA-connectioncreated.png[The "Connection created" screen]
+
...
* link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-hana-edit-connection.html[Edit an SAP HANA connection]
* link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-hana-connection-reference.html[SAP HANA connection reference]
