...
. Select the *Color* drop-downs for each attribute value and change them.
. Select the *x* in the top right of the panel.
. Optionally, you can select *Reset* to use the default color.
. Save your changes.
