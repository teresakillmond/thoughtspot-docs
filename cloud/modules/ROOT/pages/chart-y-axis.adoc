...
. While viewing your answer as a chart, click the drop-down menu icon image:icon-caret-right-20px.png[Dropdown icon image] next to the y-axis label you want to change.
. Click *edit*.
+
...
+
To change the range for *gross profit margin*, click the drop-down menu icon next to the *gross profit margin* axis label.
...
. Click the *edit* button image:icon-edit-10px.png[Chart configuration icon image] that appears when you hover over *y-axis*.
