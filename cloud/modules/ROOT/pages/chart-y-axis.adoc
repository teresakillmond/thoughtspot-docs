...
You can manually set the y-axis range by selecting *edit* from the <<y-axis,y-axis label drop-down>>, or from the <<chart-config-edit,*chart configuration* menu>>.
...
. While viewing your answer as a chart, open the drop-down menu icon image:icon-caret-right-20px.png[Dropdown icon image] next to the y-axis label you want to change.
. Select *edit*.
+
...
+
To change the range for *gross profit margin*, open the drop-down menu icon next to the *gross profit margin* axis label.
...
. While viewing your answer as a chart, select the *chart configuration* icon image:icon-gear-10px.png[Chart configuration icon image] on the top right.
. Select the *edit* button image:icon-edit-10px.png[Chart configuration icon image] that appears when you hover over *y-axis*.
