...
You can manually set the y-axis range by selecting *edit* from the <<y-axis,y-axis label dropdown menu>>, or from the <<chart-config-edit,*chart configuration* menu>>.
...
. While viewing your Answer as a chart, open the dropdown menu icon image:icon-caret-right-20px.png[Dropdown icon image] next to the y-axis label you want to change.
. Select *edit*.
+
...
+
To change the range for *gross profit margin*, open the dropdown menu icon next to the *gross profit margin* axis label.
