...
. Enter Setup by logging in for the first time, or by choosing *Profile* from the user icon at the top right of the screen and selecting *Revisit onboarding experience* under *Experience*.
