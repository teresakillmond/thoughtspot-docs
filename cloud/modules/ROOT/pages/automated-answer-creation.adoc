...
. Enter Setup by logging in for the first time, or by selecting *Profile* from the user icon at the upper right of the screen and clicking *Revisit onboarding experience* under *Experience*.
