...
To paint a geo area chart, your search must include a geographical column with appropriate granularity. Note that you can create geo area charts using country, county, state, and other sub-nation region data, but not with latitude, longitude, or zipcode data.
