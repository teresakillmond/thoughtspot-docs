...
To work with Scriptable <<syntax-worksheets,worksheets>>, <<syntax-views,views>>, <<syntax-sql-views,SQL views>> <<syntax-tables,tables>>, <<syntax-answers,answers>>, and <<syntax-liveboards,Liveboards>> in ThoughtSpot, you can download these objects to a flat file in `.TML` format, modify it, and subsequently upload this file either to the same cluster, or to a different cluster.
