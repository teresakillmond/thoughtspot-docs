...
+
For wnswers, `column_id` refers to how the column appears in the query.
...
+
For worksheets and views, `column_id` is in the following format: `column_id: <table_path>::<column_id>`. For example: `column_id: Customer_Dimension::Customer_Name`.
