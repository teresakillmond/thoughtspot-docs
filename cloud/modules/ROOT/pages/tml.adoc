...
NOTE: To reduce ambiguity, you may need to add the optional `fqn` parameter to your table TML file. This is necessary if you have multiple connections or tables with the same name. If you do not add the `fqn` parameter, and the connection or table you reference does not have a unique name, the file import fails.
...
NOTE: To reduce ambiguity, you may need to add the optional `fqn` parameter to your table TML file. This is necessary if you have multiple tables with the same name. If you do not add the `fqn` parameter, and the table you reference in the join does not have a unique name, the file import fails.
