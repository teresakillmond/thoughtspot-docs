...
+ For details on how to add a connection to BigQuery in ThoughtSpot, see link:{{ site.baseurl }}/admin/ts-cloud/ts-cloud-embrace-gbq-add-connection.html[Add a BigQuery connection].
