...
[NOTE]
====
If you configure SAML group mapping, your groups in your IDP overrule your groups in ThoughtSpot, *_except_* in the case of group deletion. To delete a group, you must delete in ThoughtSpot, not in your IDP environment.
