...
+
IMPORTANT: The Application ID URI must be unique in your organization’s directory. Example: `\https://your.company.com/`. It should be come from your primary domain.
...
. Click *My APIs*.
. Click the name of the Snowflake OAuth Resource you created in <<part-1,Part 1>>.
+
