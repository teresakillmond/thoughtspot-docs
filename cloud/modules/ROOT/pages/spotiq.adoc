...
All users can use SpotIQ to run xref:spotiq-change.adoc[change analysis].

If you want to configure a xref:spotiq-custom.adoc[customized SpotIQ analysis], ask your ThoughtSpot Administrator to give you the *Has SpotIQ* privilege.
...
. Select *SpotIQ* from the top navigation bar.
