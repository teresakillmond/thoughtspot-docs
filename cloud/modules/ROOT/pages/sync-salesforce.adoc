...
* Map the *Source* and *Destination* columns from the drop-downs provided. Note that the Source column refers to the column in ThoughtSpot, while the Destination column refers to the column in Salesforce.
+
