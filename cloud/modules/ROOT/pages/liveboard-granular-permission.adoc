...
:description: ThoughtSpot now supports limiting some users to <strong>Read only</strong> access on curated Liveboards. These users can view and explore; however, they cannot copy, alter, download, or share the Liveboards.
...
To ensure that users have *Read only* access, edit the user group permission and select the *xref:privileges-end-user.adoc[Cannot create or update Liveboards]* privilege.
