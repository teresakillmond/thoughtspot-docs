...
+
This brings up the *Columns* screen, where you can update your modeling settings.
...
. Save your changes. Select *Save changes* in the upper right corner of your screen.
+
image::modeling_columns_screen.png[Select the Save changes button]
