...
NOTE: If you have an existing ThoughtSpot free trial account, you can use it with {connection} Partner Connect.

== Sign up for ThoughtSpot free trial or use an existing free trial account in {connection} Partner Connect

To sign up for the free trial or use an existing free trial account, do the following:
