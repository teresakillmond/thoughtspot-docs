...
When you xref:schedule-a-liveboard-job.adoc[schedule a Liveboard job], you can add a gating condition that triggers the Liveboard email.
...
After you create your view and Liveboard, follow the directions in xref:schedule-a-liveboard-job.adoc[Schedule a Liveboard job] to create the Liveboard schedule.
