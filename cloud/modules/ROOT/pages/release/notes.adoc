...
To see our feature deprecation plans, please see link:{{ site.baseurl }}/release/deprecation.html[Deprecation Announcements].
...
Refer to link:{{ site.baseurl }}/release/deprecation.html#de-support-august-cloud[Deprecation Announcements] for more information.+++</dlentry>+++
...
Refer to link:{{ site.baseurl }}/release/deprecation.html[Deprecation Announcements] for more information.+++</dlentry>+++
