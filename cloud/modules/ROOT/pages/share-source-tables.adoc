...
If you want to prevent shares from also revealing the columns regardless of where it appears (worksheets, answers, and Liveboards), you can ask xref:support-contact.adoc[ThoughtSpot Support] to enable a stricter behavior.
