...
Administrators and owners can share *Can View* or *Can Edit* privileges on tables with other users, who can further share them with others. If your organization is using xref:orgs-overview.adoc[], you can only share with other users in your specific Org.
...
If you want to prevent shares from also revealing the columns regardless of where it appears (Worksheets, Answers, and Liveboards), you can ask https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support] to enable a stricter behavior.
