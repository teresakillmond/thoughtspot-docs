...
image::{{ site.baseurl }}/images/index-type.png[]
...
image::{{ site.baseurl }}/images/index-row.png[]
...
image::{{ site.baseurl }}/images/table-search-indexing.png[Table and View search indexing]
...
image::{{ site.baseurl }}/images/worksheet-search-indexing.png[Worksheet search indexing]
...
image::{{ site.baseurl }}/images/priority-effect.png[]
...
image::{{ site.baseurl }}/images/set-priority.png[]
