...
last_updated: 3/10/2020 description: "Learn about backup and snapshot schedules." sidebar: mydoc_sidebar permalink: /:collection/:path.html -- You can schedule periodic snapshots and backups.
...
Refer to link:{{ site.baseurl }}/admin/backup-restore/overview-snapshot.html[work with snapshots] and link:{{ site.baseurl }}/admin/backup-restore/configure-backup.html[configure periodic backups].
