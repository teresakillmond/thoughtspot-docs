...
video::_HqB__xe3bo[youtube]
https://youtu.be/_HqB__xe3bo[ThoughtSpot Success Series: Defining a ThoughtSpot Use Case^]

video::W5dwAmLSwT0[youtube]

https://youtu.be/W5dwAmLSwT0[ThoughtSpot Success Series: Use Case Prioritization^]
