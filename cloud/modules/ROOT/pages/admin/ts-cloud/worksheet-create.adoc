...
>
> * As you develop your expertise with joins and schema, we recommend the following ThoughtSpot U courses: https://training.thoughtspot.com/2-worksheet-design[Worksheet Design] and https://training.thoughtspot.com/series/business-analyst/2-using-formulas[Using Formulas].
