...
link:{{ site.baseurl }}/admin/misc/contact.html[Contact ThoughtSpot Support] to do this configuration.
...
For details on defining joins in ThoughtSpot, see link:{{ site.baseurl }}/admin/data-modeling/create-new-relationship.html[Join a table or view to another data source].
