...
image::{{ site.baseurl }}/images/admin_sign-up.png[]
...
If you want to display the sign-up button on the ThoughtSpot sign-in page without using the special sign-up URL, link:{{ site.baseurl }}/admin/misc/contact.html[contact ThoughtSpot Support].
