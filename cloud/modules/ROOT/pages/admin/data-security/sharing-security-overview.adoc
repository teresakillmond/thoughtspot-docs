...
Users can be managed link:{{ site.baseurl }}/admin/users-groups/about-users-groups.html#[manually].
...
+++<col width="50%">++++++</col>++++++</colgroup>+++
  ...
  +++<tr>++++++<td>+++Liveboards+++</td>+++
    ...
    +++<td>+++Anyone who can view a Liveboard can share it. See [Share a Liveboard](share-pinboards.html)+++</td>++++++</tr>++++++</table>+++
