...
ThoughtSpot supports applying runtime filters to objects embedded using the link:{{ site.baseurl }}/admin/ts-cloud/visual-embed-sdk.html[Visual Embed SDK] or the xref:rest-api.adoc[REST APIs].
