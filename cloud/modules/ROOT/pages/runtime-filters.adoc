...
ThoughtSpot supports applying runtime filters to objects embedded using the xref:visual-embed-sdk.adoc[Visual Embed SDK] or the xref:rest-api.adoc[REST APIs].
