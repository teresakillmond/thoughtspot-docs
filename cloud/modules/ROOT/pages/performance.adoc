...
:page-aliases: /admin/architecture/performance.adoc
:description: Make sure you understand the performance considerations in your installation.
...
https://community.thoughtspot.com/customers/s/contactsupport[Contact ThoughtSpot Support] for guidance on boundaries for the following:
