...
When you download a chart, it will be a PNG file. If you do not all the search download options, your company may have removed them.
...
| Number formatting based on xref:/data-modeling-patterns#_number_formats[custom format patterns] | Supported | Not supported
