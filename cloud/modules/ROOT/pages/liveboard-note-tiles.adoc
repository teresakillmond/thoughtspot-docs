...
[#image]
=== Inserting images
Images must be either .jpg, .jpeg, or .png. The image size can't be greater than 5 MB. To add an image to your note tile, follow these steps:

//Note that you must have the xref:privileges-end-user.adoc#upload-user-data[Can upload data] privilege to upload images.
