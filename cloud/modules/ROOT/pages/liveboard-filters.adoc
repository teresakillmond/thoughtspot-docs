...
. In the *Add filters* side panel, you see a list of columns. Click the filter icon image:icon-filter-10px.png[Filter icon image] next to the column you would like to selectively filter on.
...
If you open the filter from *Edit mode*, by selecting the *Edit* button at the top right of the Liveboard and clicking on the filter, you can edit the values to include or exclude, specify the visualizations the filter should apply to, and configure linked filters.
...
+
image::filter_appears.png[Click the x that appears in the top right of the filter when you hover over it]
