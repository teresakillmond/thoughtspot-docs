...
. Click the search icon, and select the *Choose sources* icon in the Data panel.
...
+
If your search shows no data found or doesn't look right to you, it's possible that one of the links between your sources was made on the incorrect column.
