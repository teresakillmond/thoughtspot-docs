...
If the Answer is within a Liveboard, select the *more options* menu image:icon-more-10px.png[More options menu icon] for that Answer and click *Edit*.
...
. Click the edit icon image:icon-edit-10px.png[More options menu icon] next to the formula name.
