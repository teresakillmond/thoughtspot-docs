...
Use ThoughtSpot's _time series analysis_ feature to search for answers about series data.
...
image::time-example1.png[Time series line chart example sliced with color]
...
image::time-example2.png[Time series line chart example]
...
image::time-example3.png[Stacked line chart]
...
* Simple date filters allow you to use edit the filter through the  to refine your search, adding a hierarchical date filter in the search bar disables this ability.
