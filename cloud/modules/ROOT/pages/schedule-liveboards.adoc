...
On the *Jobs Management* page, found in *Data > Usage > Jobs Management*, you can create and manage jobs, including scheduled Liveboards.
...
== Format of scheduled Liveboards
