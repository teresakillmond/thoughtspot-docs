...
Downloading a Liveboard works just as it would when downloading an answer: simply click the *more options* icon image:icon-more-10px.png[more options menu icon] and select *Download as PDF*.
