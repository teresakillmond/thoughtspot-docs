...
. While viewing your answer of interest, click the *Pin* icon image:icon-pin.png[] at the top right of the answer.
...
Most of these actions are found under the *Actions* button image:icon-more-10px.png[].
