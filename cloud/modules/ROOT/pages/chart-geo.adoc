...
ThoughtSpot supports maps for many countries. See the complete list in xref:geomap-reference.adoc[Geo Map Reference]. If you would like to use a custom map to visualize your data, select xref:geomaps-custom.adoc[].
