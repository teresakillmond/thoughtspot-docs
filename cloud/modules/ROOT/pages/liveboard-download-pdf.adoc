...
By default, Liveboard PDFs download at a width of 1920 px, which supports most Liveboard visualizations and layouts. To change this default width to a different width in pixels for your company, contact {support-url}.
