...
. Select *Download CSV* in the bottom left corner to download a CSV file of the data.
+
image::showing_underlying_data.png[Select Download CSV in the bottom left corner]
