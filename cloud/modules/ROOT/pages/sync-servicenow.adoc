...
Before you create a sync to {connection} from ThoughtSpot, log in to {connection} to find your instance URL, Client Secret, and Client ID. You need this information to create the connection to send your data to {connection}.
