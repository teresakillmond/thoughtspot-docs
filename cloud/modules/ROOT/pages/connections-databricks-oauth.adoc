...
. Log in to the Azure portal and navigate to the AAD resource, select *Add*, and select *App registration*.
+
...
. In your application, select *API Permissions* and under the *AzureDatabricks* API/Permissions name, select the *user_impersonation* permission.
+
