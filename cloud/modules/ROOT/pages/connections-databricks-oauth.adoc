...
+
NOTE: In the authorization code flow for OAuth, the scope must be set with this resource id: *`2ff814a6-3304-4ab8-85cb-cd0e6f879c1d/.default`*. Refer the screenshot from microsoft documentation provided below.
