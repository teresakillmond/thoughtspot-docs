...
Host:: Enter the {connection} server host name without the protocol. You can find this in the connection details of your SQL warehouse. Example: *example.cloud.databricks.com*
