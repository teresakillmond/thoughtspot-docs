...
For details, see xref:ts-cloud-embrace-cust-cal-create.adoc#view-cust-cal[View a custom calendar].
...
xref:connections-cust-cal-update.adoc#[Update a custom calendar] + xref:connections-cust-cal-delete.adoc#[Delete a custom calendar] + xref:connections-cust-cal.adoc[Custom calendar overview] + xref:date-formulas.adoc#fiscal-and-gregorian-calendars[Fiscal and Gregorian calendars]
