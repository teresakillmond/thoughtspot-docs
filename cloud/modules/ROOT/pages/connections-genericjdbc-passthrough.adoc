...
:description: Passthrough functions allow you to send SQL expressions directly to Generic JDBC without being interpreted by ThoughtSpot.
...
> **Related information**
>
> * xref:connections-genericjdbc-add.adoc[Add a connection]
> * xref:connections-genericjdbc-edit.adoc[Edit a connection]
...
> * xref:connections-genericjdbc-reference.adoc[{connection} connection reference]
