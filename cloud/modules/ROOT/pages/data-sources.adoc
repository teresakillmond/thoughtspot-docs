...
Worksheets are the most commonly used data sources for searching.
...
Your connections appear under the xref:connections.adoc[Connections] tab, in the side navigation bar of the Data workspace. You can add, edit, remap, delete, or apply tags to connections to external data warehouses from the *Connections* page.
...
* xref:sharing.adoc[About sharing]. Whenever you are working in ThoughtSpot, you are in your own private environment until you share your work with others. This applies to searches, Liveboards, and any data you upload.
