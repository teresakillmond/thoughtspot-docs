...
[#logout-successful]
Account logout::  A user logs out from ThoughtSpot. [#create-answer]
...
[#user-groups-created]
Group creation:: A user creates a new group, either manually through the Admin Console, or through the internal API.
[#user-groups-deleted]
Group deletion:: A user deletes a group, either manually through the Admin Console, or through the internal API.
[#group-modification]
Group modification::
A user modifies the properties of a group, either in the Admin Console or over internal API.
...
[#users-modified]
Profile change:: A user profile changes, either manually in the Admin Console or over SAML sync.
[#update-rls-rule]
...
[#users-created]
User account creation:: A new user creates an account, either manually in the Admin Console or through the internal API.
[#users-deleted]
User account deletion:: A user account is deleted, either manually in the Admin Console or through the internal API.
+
////
