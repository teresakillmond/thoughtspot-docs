...
Open the drop-down menus to select new values.
...
You can modify how you would like a column summary value to be displayed by opening the drop-down on a summary and selecting a different type of aggregation.
