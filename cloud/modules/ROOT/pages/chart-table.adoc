...
Click the *edit table configuration* icon image:icon-gear-10px.png[Chart configuration icon image].
...
[#clip-entire-table]
To clip or wrap text for the entire table, click the *edit table configuration* icon image:icon-gear-10px.png[Chart configuration icon image].
Select *Settings*.
...
[#clip-one-column]
To clip or wrap text for each column individually, hover over the column name and click the *more options menu* icon image:icon-more-10px.png[More icon image].
...
. Click the *edit table configuration* icon image:icon-gear-10px.png[Chart configuration icon image] to the upper right of your table.
...
Click the drop-down menus to select new values.
...
You can modify how you would like a column summary value to be displayed by clicking the drop-down on a summary and selecting a different type of aggregation.
