...
+
Alternatively, you can select *Exit to homepage* at the top-right corner of the screen, and end the onboarding process.
...
Simply select *Profile* from the user icon in the top-right corner of the upper navigation bar, and under *Experience*, select *Revisit onboarding experience*.
