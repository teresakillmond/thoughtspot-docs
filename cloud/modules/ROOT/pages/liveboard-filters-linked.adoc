...
The head of customer experience in the North America region may only want to see the data on customers in North America, in a Liveboard that represents global data.
...
If you do not add primary filters, the *Configure filters* option does not appear in the *more options menu* image:icon-ellipses.png[].
. To add a primary Liveboard filter, select the *more options menu* image:icon-ellipses.png[] at the top right, and select *Add filters*.
