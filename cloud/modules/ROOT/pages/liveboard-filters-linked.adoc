...
If you do not add primary filters, the *Configure filters* option does not appear in the *more options menu* image:icon-more-10px.png[].
. To add a primary Liveboard filter, select the *more options menu* image:icon-more-10px.png[] at the top right, and select *Add filters*.
...
Select the *more options menu* image:icon-more-10px.png[] at the top right, and select *Configure filters*.
+
