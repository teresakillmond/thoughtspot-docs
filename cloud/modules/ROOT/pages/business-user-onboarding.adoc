...
To repeat user onboarding or change your persona, simply select *Profile* from the user icon at the top right of the page, and under *Experience*, select *Revisit onboarding experience*.
