...
. <a href="{{ "/admin/ts-cloud/business-user-get-started.html "| prepend: site.baseurl }}">Get started</a>: learn about one of the many methods for analyzing data in ThoughtSpot, through a Liveboard
...
. xref:business-user-liveboard-view.adoc[Explore your Liveboard]: explore valuable insights through Liveboards+++</div>++++++</div>+++
