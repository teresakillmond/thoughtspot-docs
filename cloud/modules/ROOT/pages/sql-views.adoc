...
. Choose a connection to the data you would like to query. Select *Choose connection* in the side panel, and click on or search for a connection in the drop-down.
+
