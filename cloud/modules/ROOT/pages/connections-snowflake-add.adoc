...
+
Before selecting *Use External OAuth* authentication, you must configure Azure AD or Okta OAuth.
For details, see xref:connections-snowflake-azure-ad-oauth.adoc[Configure Azure AD external OAuth for a {connection} connection] or xref:connections-snowflake-okta-oauth.adoc[Configure Okta OAuth for a {connection} connection].
+
