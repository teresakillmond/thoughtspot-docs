 ...
 ** Click the *Advanced Config* menu to reveal the *Key* and *Value* fields. Refer to {connection}'s JDBC driver reference documentation for information on {connection}'s supported keys and values.
