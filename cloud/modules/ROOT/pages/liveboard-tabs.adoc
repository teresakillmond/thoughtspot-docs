...
. Double-click on the name of the tab you would like to rename. Alternatively, select the drop-down arrow next to the name of the tab, and select *Rename*.
...
. Select the drop-down arrow next to the name of the tab you would like to delete.
