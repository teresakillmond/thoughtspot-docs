...
. Name the tab. If the name is more than 30 characters, the entire name does not appear. ThoughtSpot cuts it off with an ellipsis.
+
You can add html to the tab name. For example, you can italicize part of the tab name: `Sales this quarter <em>internal-only</em>`. For more information, see xref:chart-html.adoc[].
