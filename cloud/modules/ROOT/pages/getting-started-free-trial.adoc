...
+++<div>++++++<iframe width="375" height="210" src="https://www.youtube.com/embed/_HqB__xe3bo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="">++++++</iframe>+++
...
* xref:ts-cloud-getting-started-free-trial.adoc#upload-csv[Upload flat data file (CSV)]
...
* xref:ts-cloud-support-handbook.adoc[ThoughtSpot Support Handbook] (link:{{ site.baseurl }}/downloads/support-handbook.pdf[PDF])
