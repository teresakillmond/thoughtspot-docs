...
.Defining a ThoughtSpot Use Case
video::_HqB__xe3bo[youtube,width="375",height="210",frameborder="0",allow="accelerometer"]
.Use Case Prioritization
video::W5dwAmLSwT0[youtube,width="375",height="210",frameborder="0",allow="accelerometer"]
