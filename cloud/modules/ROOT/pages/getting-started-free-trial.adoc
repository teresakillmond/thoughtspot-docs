...
We will send you an email that contains an activation link to sign in for the first time and the public IP address to whitelist.
Check your inbox, then select the link to access the free trial cluster. Note that if you use Google sign-in, you do not need to receive an email to activate your account.
Stay logged in to complete the rest of the setup.


If you do not see the IP address to whitelist in your activation email, consult the following list:
