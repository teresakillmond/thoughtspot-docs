...
. Save the Answer(s) by clicking the ellipsis icon image:icon-ellipses.png[more options menu icon], and selecting *Save*.
+
image::sharing-save-answer.png[Save an answer]
+
NOTE: When you save an answer, ThoughtSpot makes your answer discoverable by default. Teammates who have access to the answer's underlying worksheet can find your answer when they search using *Search Answers*. To restrict access to your answer, de-select the *Make this answer discoverable* checkbox.
...
. Share the answer by clicking the sharing icon image:icon-share copy-20px.png[sharing icon].
+
