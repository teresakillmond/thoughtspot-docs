...
+
NOTE: When you save an answer, ThoughtSpot makes your answer discoverable by default. Members of the same user group who have access to the answer's underlying data source can find your answer when they search using *Search Answers*. To restrict access to your answer, de-select the *Make this answer discoverable* checkbox.
