...
Export, edit, and import KPI Monitor alerts programmatically using ThoughtSpot Modeling Language. For more information, see xref:tml.adoc#syntax-alerts[Syntax of the Monitor alert TML file].
