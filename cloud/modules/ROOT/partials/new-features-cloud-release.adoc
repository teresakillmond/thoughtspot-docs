...
+
The new SpotIQ experience deprecates the following feature:
+
* *SpotIQ Feedback tab:* The SpotIQ Feedback tab was previously available in the SpotIQ top menu after you click on *SpotIQ* from the top navigation bar. Now, when you respond to the *Is this insight useful?* question below each SpotIQ result, SpotIQ learns from that response, but does not allow you to view or change your feedback later.
