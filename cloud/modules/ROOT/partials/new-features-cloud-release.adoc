...
You can now edit your display name by clicking the profile icon in the top-right corner of the screen. For more information, see xref:user-profile.adoc[Edit display name,window=_blank].
