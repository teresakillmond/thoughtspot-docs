...
// move to business user. add image
...
[#9-2-0-cl-headlines]
[discrete]
===  Migrate existing Headlines to KPI charts

// Naomi

Existing customer Headlines have been changed to KPI chart type. KPI charts retain all properties of Headlines, but allow users to set alerts to track when your Key Performance Indicators reach certain thresholds.
