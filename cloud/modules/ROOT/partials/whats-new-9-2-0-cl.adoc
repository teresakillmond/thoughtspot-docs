...
Once enabled, your ThoughtSpot administrator can grant access to the ThoughtSpot Sage features for users in a group by assigning the *_Can preview ThoughtSpot Sage_* user privilege to the group.
