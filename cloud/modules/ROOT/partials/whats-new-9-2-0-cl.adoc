...
In this release we introduce our new AI-powered search experience called ThoughtSpot Sage, which makes it easier for you to get answers and insights from your complex data. ThoughtSpot Sage uses GPT-3.5T, and the large language models (LLM) of Microsoft Azure OpenAI Service.
