...
Access the contextual menu for visualization data points with a left-click. Instead of right-clicking on a data point to include or exclude it, drill down on it, or show underlying data, now you can access the menu more easily, with a single left-click. This feature must be enabled by your administrator.
...
[#9-2-0-cl-sample]
[discrete]
=== Column and data source overview in Search Data [.badge.badge-beta]#Beta# [.badge.badge-beta]#Beta#
endif::[]
ifdef::pendo-links[]
[#9-2-0-cl-sample]
[discrete]
=== Column and data source overview in Search Data [.badge.badge-beta]#Beta# [.badge.badge-beta-whats-new]#Beta#
endif::[]
