...
tags or classifications (if available), data source metadata, and data source experts (top users). Column information includes the name, description, synonyms (if avialable), column type, sample values, parameters, and more.
