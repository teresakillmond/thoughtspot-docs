...
NOTE: Our in-app support team cannot access your data. Questions that require access to or understanding of your data or data model should be directed to your internal data teams.
****
...
Your ThoughtSpot administrator can grant access to the *Natural language search* and *AI-suggested searches* features for users in a group by assigning the *_Can preview ThoughtSpot Sage_* user privilege to the group. For more information about ThoughtSpot Sage,
endif::free-trial-feature[]
ifndef::pendo-links[]
...
You can now see anomalies in time-series KPI charts. Our new anomaly detection algorithm detects data which does not fall within the expected confidence intervals, while allowing for seasonal changes and growth over time. To try it out, open your KPI chart as an Answer, open the chart configuration menu, and select *Show anomalies*. This feature must be enabled by your administrator. For more information, see
ifndef::pendo-links[]
...
[#9-2-0-cl-llm]
[discrete]
=== ThoughtSpot Google Sheets(TM) add-on
...
For details,
ifndef::pendo-links[]
see xref:thoughtspot-sheets.adoc[ThoughtSpot Google Sheets add-on].
endif::[]
ifdef::pendo-links[]
see xref:thoughtspot-sheets.adoc[ThoughtSpot Google Sheets add-on,window=_blank].
endif::[]
// Mark
...
ifndef::pendo-links[]
xref:tml-alerts.adoc[TML for Monitor alerts] and xref:monitor.adoc[Monitor KPIs in your data].
endif::[]
ifdef::pendo-links[]
xref:tml-alerts.adoc#syntax-alerts[TML for Monitor alerts,window=_blank] and xref:monitor.adoc[Monitor KPIs in your data,window=_blank].
endif::[]
...
ifndef::pendo-links[]
xref:tml-joins.adoc[TML join syntax].
endif::[]
ifdef::pendo-links[]
xref:tml-joins.adoc[TML join syntax,window=_blank].
endif::[]
...
ifdef::pendo-links[]
xref:parameters-use.adoc#runtime-filters[Runtime filters for Parameters,window=_blank] and https://developers.thoughtspot.com/docs/?pageid=runtime-params[Runtime Parameters,window=_blank].
endif::[]
