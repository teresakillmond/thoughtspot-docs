...
Sage features are disabled by default and available for select customers to try before they reach GA, when they are enabled by default. You must contact ThoughtSpot Support to enable them.
