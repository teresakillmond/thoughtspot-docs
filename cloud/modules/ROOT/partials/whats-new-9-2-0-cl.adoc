...
.[.badge.badge-dep]#Help and support features#
****
This release introduces important enhancements to provide help and support to all ThoughtSpot users.
[#9-2-0-cl-help]
[discrete]
=== In-product help
...
image::icon-chat-support.png[Chat support icon]
...
ifndef::pendo-links[]
You can now search using natural language to access AI-generated answers to your business questions. To try it out, navigate to the Home page, select the search bar labeled *Ask any business question you have* and type your question. When you enter your question, you will see the AI-generated answer appear, along with a list of related Answers created by users in your team. For more information, see xref:ai-answers.adoc[AI-generated Answers].
endif::[]
ifdef::pendo-links[]
You can now search using natural language to access AI-generated answers to your business questions. To try it out, navigate to the Home page, select the search bar labeled *Ask any business question you have* and type your question. When you enter your question, you will see the AI-generated answer appear, along with a list of related Answers created by users in your team. For more information, see xref:ai-answers.adoc[AI-generated Answers,window=_blank].
endif::[]
...
[#9-2-0-cl-cortex]
[discrete]
=== Anomaly detection for time-series KPI charts [.badge.badge-beta]#Beta#
endif::[]
ifdef::pendo-links[]
[#9-2-0-cl-cortex]
[discrete]
=== Anomaly detection for time-series KPI charts [.badge.badge-beta-whats-new]#Beta#
endif::[]
...
In the Search Data page, you now see a short description of your selected data source which helps you understand the kinds of answers you can get from that data source. Data source information includes the name of the data source,
description, Liveboards created using the datasource (if available),
tags or classifications (if available), data source metadata, and data source experts (top users). Column information includes the name, description, synonyms (if available), column type, sample values, parameters, and more.
...
Private Preview features are complete, and available for select customers to try before they reach GA, when they are enabled by default. To try it out, contact {support-url} to enable these features. Then, administrators can selectively enable or disable this feature set for users and groups, using the *Can preview ThoughtSpot Sage* user privilege. For more information, see
ifndef::pendo-links[]
