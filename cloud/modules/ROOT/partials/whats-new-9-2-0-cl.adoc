...
// For the preview features, how do we plan to handle doc and what’s new? Full doc with a note similar to the what’s new note? “This feature must be enabled by ThoughtSpot support” for the what’s new?
...
[#9-2-0-cl-ai-answers]
[discrete]
=== AI-generated answers [.badge.badge-early-access]#Early Access#
endif::[]
ifdef::pendo-links[]
[#9-2-0-cl-ai-answers]
[discrete]
=== AI-generated answers [.badge.badge-early-access-whats-new]#Early Access#
endif::[]
...
// Naomi. Should this have a what's new/ release note?  not customer-facing

[#9-2-0-cl-support]
[discrete]
=== AI-assisted chat support

Now you can get live, chat-based support from anywhere in the product, in a small self-contained window that floats on top of the ThoughtSpot UI. You can send a message, book a call with a product specialist, or search for answers in our documentation, training and community sites. Messages can be a product question, sales inquiry, feedback, or even a product idea.

To use the chat-based support, click the support icon in the bottom-right corner of ThoughtSpot.
...
AI-suggested searches helps you think of relevant questions to ask of your own data source, by providing examples of searches. This feature is designed to help you get started if you are a new user of Search Data, or you are working with a new worksheet.
ifndef::pendo-links[]
...
[#9-2-0-cl-synonyms]
[discrete]
=== Automatic synonyms for Worksheet columns
...
ifdef::pendo-links[]
xref:data-modeling-synonyms.adoc#automatic-synonyms[Create synonyms for a column,window=_blank].
endif::[]
