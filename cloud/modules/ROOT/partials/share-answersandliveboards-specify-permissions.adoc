...
+
NOTE: When you share an answer or Liveboard, ThoughtSpot makes your content discoverable by default. Members of the same user group who have access to the data object's underlying worksheet can find your answer or Liveboard when they search using *Search Answers*. To restrict access to your content, de-select the *Make this [answer | Liveboard] discoverable* checkbox.
