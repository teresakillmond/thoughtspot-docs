. After you select the *Share* icon, the sharing dialog box appears.
+
...
Simply select the *Copy link* button at the bottom of the sharing dialog box.
+
Note that sending users this link does not share the object with them.
You must also share the object by selecting the *Share* button at the bottom of the dialog box.
+
