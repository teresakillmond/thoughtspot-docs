...
. To bring back the default logos, select the *Reset* button on the upper right-hand side of the sections.
...
. Select the custom font drop-down to choose your custom font.
+
image::choose_chart_custom_font.png[Custom font dropdown]

. Select the chart label drop-down to choose where you would like to apply your custom font.
+
...
. To bring back the default fonts, select the *Reset* button on the upper right-hand side of the sections.
...
. To bring back the default color, select the *Reset* button on the upper right-hand side of the section.
...
. To bring back the default color palettes, select the *Reset* button on the upper right-hand side of the section.
...
ThoughtSpot uses a specific logic to determine the colors in your charts. To learn more, expand the *Chart color logic* section below.
...
. To bring back the default footer text, select the *Reset* button on the upper right-hand side of the section.
