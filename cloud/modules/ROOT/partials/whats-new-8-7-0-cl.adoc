...
ifndef::pendo-links[]
see xref:connections-denodo-oauth[Configure OAuth for a Denodo connection].
endif::[]
ifdef::pendo-links[]
see xref:connections-denodo-oauth[Configure OAuth for a Denodo connection,window=_blank].
endif::[]
// Mark
