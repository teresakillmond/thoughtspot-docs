...
* You cannot delete table joins from the table TML file.
You must delete them in the UI. You can, however, delete Worksheet or View-level joins from the Worksheet or View TML file.
