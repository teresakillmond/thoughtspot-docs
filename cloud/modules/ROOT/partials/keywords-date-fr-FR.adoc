...
Français;; tous les jours une année sur l'autre
...
Français;; croissance de … par … tous les jours

include::partial$keywords/growth_of_by_monthly.adoc[]
Français;; croissance de … par … tous les mois

include::partial$keywords/growth_of_by_quarterly.adoc[]
Français;; croissance de … par … tous les trimestres

include::partial$keywords/growth_of_by_weekly.adoc[]
Français;; croissance de … par … toutes les semaines

include::partial$keywords/growth_of_by_yearly.adoc[]
Français;; croissance de … par … tous les ans

include::partial$keywords/hourly.adoc[]
Français;; toutes les heures
...
Français;; tous les mois une année sur l'autre
...
Français;; tous les trimestres

include::partial$keywords/quarterly_year_over_year.adoc[]
Français;; tous les trimestres une année sur l'autre
...
Français;; toutes les semaines

include::partial$keywords/weekly_year_over_year.adoc[]
Français;; toutes les semaines une année sur l'autre
