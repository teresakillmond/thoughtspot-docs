...
Arrange Answer filters in the filter bar so that they are in a logical, coherent order, by dragging and dropping them to different spots in the list. This makes it easier for viewers of the Answer to understand and use the filters on the Answer. To try it out, edit any Answer, and drag and drop the filters in the filter bar.
For more information, see
ifndef::pendo-links[]
