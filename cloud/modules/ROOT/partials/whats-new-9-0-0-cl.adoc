...
Labels that appear on a dark background can be displayed in a lighter text color, making them easier to read. This feature is disabled by default. To enable it, contact your ThoughtSpot administrator.
...
// Yochana  it is only bug fixes, No new features. documentation not required.
