...
Create Worksheet parameters to optimize your data inquiries. Use parameters to run different scenarios with adjustable values, without changing your Answers or Liveboards. This feature must be enabled by your administrator. For more information about parameters, see
ifndef::pendo-links[]
xref:parameters.adoc[Parameters].
endif::[]
ifdef::pendo-links[]
see xref:parameters.adoc[Parameters,window=_blank].
endif::[]
