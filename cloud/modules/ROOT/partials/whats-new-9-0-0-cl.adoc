...
====
--
include::partial$whats-new-feature-list-9-0.adoc[]
--
====
endif::[]
////
...
image:sync-hubspot.png[HubSpot and ServiceNow sync]
...
image::chartconfig-data-labels-on-dark-background.png[Chart labels on dark background]
...
ifndef::pendo-links[]
xref:connection-share.adoc[About connections in ThoughtSpot].
endif::[]
ifdef::pendo-links[]
xref:connection-share.adoc[About connections in ThoughtSpot,window=_blank].
endif::[]
...
image::share-connection.png[Share connections]
