...
Manage your ThoughtSpot Worksheet column properties in dbt. Use metadata tags to define column properties within your dbt model schema. dbt stays the source of truth, and you don't have to manually update the columns in ThoughtSpot when you make changes to your dbt model.
