...
[discrete]
=== ThoughtSpot Sync Salesforce connection [.badge.badge--whats-new]#Beta#
endif::[]
ifndef::pendo-links[]
[#8-9-0-cl-salesforce-sync]
[discrete]
...
* *SAP Procurement Vulnerability Analysis:* Use this SpotApp to quickly identify where disruptions could occur in your global supply chain, reducing risk and building resilience. For more information,
ifndef::pendo-links[]
see xref:spotapps-procurement-vulnerability.adoc[SAP Procurement Vulnerability Analysis SpotApp].
endif::[]
ifdef::pendo-links[]
see xref:spotapps-procurement-vulnerability.adoc[SAP Procurement Vulnerability Analysis SpotApp,window=_blank].
endif::[]
