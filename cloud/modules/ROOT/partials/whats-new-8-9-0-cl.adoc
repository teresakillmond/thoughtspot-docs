...
Custom tile sizes for visualizations within Liveboards are now GA. You can now customize your Liveboard visualizations to be any size.
...
[discrete]
=== ThoughtSpot Sync Salesforce connection [.badge.badge-early-access-whats-new]#Early Access#
endif::[]
ifndef::pendo-links[]
[#8-9-0-cl-salesforce-sync]
[discrete]
=== ThoughtSpot Sync Salesforce connection [.badge.badge-early-access]#Early Access#
endif::[]
...
// take out second paragraph. explain a little more, specifically in search answers context
...
// cut image off after "count of queries by month" so it fits in the pendo screen
