...
In this release, ThoughtSpot officially certifies and provides support for Microsoft SQL Server used with Synapse connections. For more information,
ifndef::pendo-links[]
see xref:connections-synapse-add.adoc[Add a Synapse connection].
endif::[]
ifdef::pendo-links[]
see xref:connections-synapse-add.adoc[Add a Synapse connection,window=_blank].
endif::[]
