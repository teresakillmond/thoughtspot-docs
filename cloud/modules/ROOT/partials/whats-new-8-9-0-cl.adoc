...
[#8-9-0-cl-fqn]
[discrete]
=== Table and connection FQN export in TML files
ThoughtSpot now automatically exports the FQNs for table and connections in any TML file when exporting from the UI. When you import a TML file, if the provided FQN does not match any existing FQNs, ThoughtSpot now uses name matching to find the table or connection it should use.
