...
. Hover over the dataset you want to share and select it by selecting the empty checkbox that appears.
. Select *Share*.
+
...
+
NOTE: You cannot select multiple columns at once.
You must input the users or groups with whom you want to share for each column.

. Select *+ Add users or groups* and select the users and groups with whom you want to share.
+
...
. Select the *more options* icon image:icon-more-10px.png[more options menu icon], and then select *Share*.
+
