The language that ThoughtSpot displays depends on the system locale.
...
See the link:{{ site.baseurl }}/reference/keywords.html[keyword reference] for all supported languages.
...
image::{{ site.baseurl }}/images/locale-spanish.png[Locale change -- Español]
