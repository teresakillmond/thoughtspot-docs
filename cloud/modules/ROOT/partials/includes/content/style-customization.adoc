...
For help with chart and table visualization fonts, link:{{ site.baseurl }}/admin/misc/contact.html[contact ThoughtSpot Support].
...
+
image::{{ site.baseurl }}/images/style-customization-menu-cloud.png[Admin Console - Style Customization]
+
 ...
 ** link:{#background-color[Choose a background color]
