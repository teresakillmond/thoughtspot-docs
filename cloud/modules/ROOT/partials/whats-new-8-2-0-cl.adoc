...
+
Have you ever wanted to display just the name of your product with the highest sales as a KPI and pin it to a Liveboard? Now, with KPI attributes you can.  You can now get KPIs on attributes, like product and dates.
+
...
You can also format text as *bold*, _italic_, or #highlight#.
...
You can now more easily create connections on the new Data Workspace page. To get started, select *Data* > *Connections*  in the top navigation bar, and then select a cloud data warehouse. You don't even have to specify tables or columns when you create your connection.
...
All these features are part of the data tab redesign, which is in beta. To enable SpotApps and the Data tab redesign, contact {support-url}.
