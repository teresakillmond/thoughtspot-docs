...
When you download a table in `XLSX` format, the downloaded table now shows the same column width and date bucketing formatting as the table in ThoughtSpot.
// For more information,
// ifndef::pendo-links[]
