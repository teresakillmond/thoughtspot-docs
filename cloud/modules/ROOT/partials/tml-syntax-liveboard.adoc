...
[NOTE]
====
In 8.9.0.cl, ThoughtSpot changed the `pinboard` parameter to `liveboard`, consistent with our rebrand of pinboards as Liveboards.
...
<<liveboard,liveboard>>:
  ...
  - <<id,id>>: <viz_id_1>
    <<answer,answer>>:
    This section includes all the Answer specification for a visualization, from name to display_mode, in the <<syntax-answers,Answer syntax>> section above.
