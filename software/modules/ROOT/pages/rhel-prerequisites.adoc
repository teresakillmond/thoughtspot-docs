...
:linkattrs:
:redirect_from: /appliance/rhel/rhel-prerequisites.html
:experimenal:
...
If you have trouble upgrading your Linux kernel to version 3.10.0-1127.19.1, contact xref:support-contact.adoc[ThoughtSpot Support].
