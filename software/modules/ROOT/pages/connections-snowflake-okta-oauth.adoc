...
+
image::sf-oauth2.png[Select Authorization Code and Refresh Token]
...
+
image::sf-oauth5.png[Make a note of the client credentials in the application home page]
...
+
image::sf-okta-add-scopes.png[Add scopes]
+
