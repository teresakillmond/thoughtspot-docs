...
* Contact xref:support-contact.adoc[ThoughtSpot Support] to get the ThoughtSpot `.ipa/.apk` file.
...
HomePinboardHelpText:: Customize the home Liveboard setup help text using this key.
  Format::: Send an email to admin@example.com if you are having difficulties when setting up your home Liveboard.
...
Have questions?
Feel free to contact xref:support-contact.adoc[ThoughtSpot Support].
