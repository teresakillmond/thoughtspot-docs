...
. Change the file extension to `.tsv`. This ensures that your editor (vi/vim, and so on) knows the file contains tab-separated values. *If you are using Excel*, change the file extension to `.txt`.
+
