...
Example:;; 1234
[#dataflow-azure-synapse-conn-authentication-type]
...
Valid Values:;; Database credentials, Active directory password, Active directory service principal, Active directory MSI
...
Example:;; user1
Other notes:;; Field does not appear when you select "Active Directory service principal" or "Active Directory MSI" authentication types.
[#dataflow-azure-synapse-conn-password]
include::partial$dataflow/password.adoc[]
Other notes:;; Field does not appear when you select "Active Directory service principal" or "Active Directory MSI" authentication types.
[#dataflow-azure-synapse-conn-aad-secure-principal-id]
AAD secure principal id:: Specify the Azure Active Directory secure principal id. Field appears when you select the "Active directory service principal" authentication type.
[#dataflow-azure-synapse-conn-aad-secure-principal-secret]
AAD secure principal secret:: Specify the Azure Active Directory secure principal secret. Field appears when you select the "Active directory service principal" authentication type.
