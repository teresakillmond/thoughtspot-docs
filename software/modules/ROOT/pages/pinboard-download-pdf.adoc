...
The highlights and instant insights [.label.label-dep]#De-supported 7.1# appear at the top, and the rest of the Pinboard is on a rectangular grid, with natural page breaks.
