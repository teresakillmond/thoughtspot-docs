...
This page explains how to install a ThoughtSpot cluster in a VMware VSphere Hypervisor (ESXi) 6.5, 6.7, or 7.0 environment.

ThoughtSpot certifies *VMware 6.5* for ThoughtSpot versions 6.0 and later. ThoughtSpot certifies *VMware 6.7* for ThoughtSpot versions 7.1.0.CU1 and later. ThoughtSpot certifies *VMware 7.0* _only_ for ThoughtSpot version 8.4.1.sw.
