...
:experimental:
:linkattrs:
:redirect_from: /end-user/search/about-geo-charts.html

Geo charts show data on a map by location. There are three geo charts that let you visualize geographical data in ThoughtSpot: xref:docs:chart-geo-area.adoc[geo area], xref:docs:chart-geo-bubble.adoc[geo bubble], and xref:docs:chart-geo-heatmap.adoc[geo heatmap] charts.
