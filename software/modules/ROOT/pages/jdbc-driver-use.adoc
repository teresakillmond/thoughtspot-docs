...
:linkattrs:
:page-aliases: /data-integrate/clients/use-jdbc-driver.adoc
:experimental:
:description: How to configure the JDBC driver.
...
* xref:odbc-jdbc-configuration.adoc#properties-reference[JDBC properties reference] in this ThoughtSpot documentation
...
> * xref:odbc-jdbc-configuration.adoc[Connection configuration]
> * xref:odbc-jdbc-sql.adoc[Supported SQL commands]
