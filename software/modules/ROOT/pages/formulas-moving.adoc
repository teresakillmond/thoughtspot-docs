...
. Open the *Data* panel from the upper-right corner if it is not open, and select the + icon next to Formulas. If the xref:answer-experience-new.adoc[new answer experience] is off in your environment, click the more options icon image:icon-more-10px.png[more icon] in the upper-right side of the table, and select *Add formula*.
+
...
+
image::moving_average_formula-new.png[Moving average formula in the formula builder]
...
+
image::moving_average_table-new.png[Moving average formula as its own column in the table]
+
