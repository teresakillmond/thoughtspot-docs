...
:description: When you see too many blank search results when searching on a worksheet, change the worksheet inclusion rule.
...
Now when searching for "store name" and "product name" on the worksheet, users won't be overwhelmed by null values.
