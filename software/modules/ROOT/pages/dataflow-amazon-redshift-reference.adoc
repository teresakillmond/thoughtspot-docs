...
[#dataflow-amazon-redshift-conn-fetch-password-from-vault]
include::partial$dataflow/fetch-password-from-vault.adoc[]

[#dataflow-amazon-redshift-conn-vault-provider]
include::partial$dataflow/vault-provider.adoc[]

[#dataflow-amazon-redshift-conn-secrets-manager-region]
include::partial$dataflow/secrets-manager-region.adoc[]

[#dataflow-amazon-redshift-conn-secret-name-or-arn]
include::partial$dataflow/secret-name-or-arn.adoc[]

[#dataflow-amazon-redshift-conn-remote-role-arn]
include::partial$dataflow/remote-role-arn.adoc[]

[#dataflow-amazon-redshift-conn-key-name-in-secret]
...
Default:;; 1000
[#dataflow-amazon-redshift-sync-max-ignored-rows]
