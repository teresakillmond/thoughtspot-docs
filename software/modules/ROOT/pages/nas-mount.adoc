...
:last_updated: 08/23/2021
:experimental:
:linkattrs:
:page-aliases: /admin/setup/NAS-mount.adoc, /disaster-recovery/nas-mount.adoc, NAS-mount.adoc
:description: You can mount a network attached storage (NAS) file system to support operations like backup, restore, and data loading.
...
>
> * For best results when mounting NAS, we recommend that you take the following ThoughtSpot U course: https://training.thoughtspot.com/nas-mount[NAS Mount^].
...
You can mount NAS through the xref:admin-portal.adoc[Admin Console], or xref:mount-nas-tscli[Mount NAS using tscli].
