...
You can link:connections-cust-cal-update.adoc#updating-the-calendar-file[update] an existing calendar by downloading it, making changes to it, and then uploading it.
...
For details, see link:connections-cust-cal-create.adoc#view-cust-cal[View a custom calendar].

== (Optional) Set a custom calendar as the default calendar for your cluster

To set your custom calendar as the default calendar for your cluster, contact link:support-contact.adoc[ThoughtSpot Support].
...
> **Related information**
>
> * xref:connections-custom-cal-update.adoc[Update a custom calendar]
> * xref:connections-custom-cal-delete.adoc[Delete a custom calendar]
> * xref:connections-custom-cal.adoc[Custom calendar overview]