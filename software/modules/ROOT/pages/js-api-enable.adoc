...
ThoughtSpot clusters running 7.0.1 or lower Software release versions may add additional headers and restrict iFrame embedding with SSO. You can resolve this issue by applying the `saml_iframe_options.patch`.
To install this patch on your ThoughtSpot instance, contact xref:support-contact.adoc[ThoughtSpot Support].
