...
NOTE: ThoughtSpot supports number, currency, percent, and custom (also called source) formatting for numerical values. If you use more than one of these formatting types for a worksheet or for the system data model, one of the formatting types overrides the others. Custom formatting overrides number, currency, and percent formatting. Number formatting overrides currency.
