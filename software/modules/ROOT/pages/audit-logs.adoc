...
- <<user-groups-created,user-groups-created>>
- <<user-groups-deleted,user-groups-deleted>>
- <<user-group-modified,user-group-modified>>
- <<principals-in-group-update,principals-in-group-update>>
