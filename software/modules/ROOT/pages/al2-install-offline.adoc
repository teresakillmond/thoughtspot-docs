...
rpm_gpg:: This directory contains the link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2rl_verify.html[GPG keys, window="_blank"] that authenticate the public repository.
