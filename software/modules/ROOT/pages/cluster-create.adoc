...
s3 example: +++<button type="button" id="s3-cloud" title="Copy" onclick="sayCopied(this.id)" class="btn btn-copy" data-clipboard-text="tscli cluster create 6.0.tar.gz --enable_cloud_storage s3a">+++Copy &#128203;+++</button>+++
+
----
