...
You can use HTML 5 in titles and descriptions for answers and visualizations within Liveboards. For example, you can add a clickable link to a word or phrase in a description, or italicize part of an answer title. In 8.4.1.sw, if you enable the xref:liveboard-experience-new.adoc[new Liveboard experience], you can also use HTML 5 in answers and descriptions for Liveboards.
...
This feature is only available if you are using the xref:answer-experience-new.adoc[new answer experience], which is off by default. You can turn it on or off xref:user-profile.adoc#new-answer-experience[from your profile]. In 8.4.0.sw, or if you do not enable the xref:liveboard-experience-new.adoc[new Liveboard experience], you can use HTML in titles and descriptions only for answers and visualizations within Liveboards. In 8.4.1.sw, if you enable the xref:liveboard-experience-new.adoc[new Liveboard experience], you can also use HTML 5 in answers and descriptions for Liveboards.
...
* In 8.4.0.sw, this feature is not available for Liveboard titles and descriptions. In 8.4.1.sw, this feature is available for Liveboard titles and descriptions, if you enable the xref:liveboard-experience-new.adoc[new Liveboard experience].
