...
You can use HTML 5 in titles and descriptions for answers and visualizations within Liveboards. For example, you can add a clickable link to a word or phrase in a description, or italicize part of an answer title. If you enable the xref:liveboard-experience-new.adoc[new Liveboard experience], you can also use HTML 5 in answers and descriptions for Liveboards.
...
* This feature is only available for Liveboard titles and descriptions, if you enable the xref:liveboard-experience-new.adoc[new Liveboard experience], which is off by default.
