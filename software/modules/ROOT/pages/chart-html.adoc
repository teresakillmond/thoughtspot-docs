...
This feature is only available if you are using the xref:answer-experience-new.adoc[new answer experience], which is on by default. You can turn it on or off xref:user-profile.adoc#new-answer-experience[from your profile]. If you enable the xref:liveboard-experience-new.adoc[new Liveboard experience], you can also use HTML 5 in answers and descriptions for Liveboards.
