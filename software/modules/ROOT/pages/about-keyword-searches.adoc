...
You can access a list of keywords and other reference materials in the xref:keywords.adoc[reference] section or in the help center.
Open the help center by selecting *Help* from the top navigation bar.
...
+
You can only use location keywords if you bring your data into ThoughtSpot's in-memory database. You cannot use them if you xref:embrace-intro.adoc[connect to your data] in an external database.
