...
CAUTION: Following AWS best practices, we strongly recommend that you **do not** use the AWS root user for deploying ThoughtSpot. For details, see AWS account root user in Amazon’s AWS documentation.
