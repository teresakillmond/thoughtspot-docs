...
a| xref:chart-column.adoc[] a| xref:chart-column-stacked.adoc[] a| xref:chart-bar.adoc[] a| xref:chart-bar-stacked.adoc[] a| xref:chart-line.adoc[] a| xref:docs:chart-pie.adoc[]
a| a| a| a| a| a|
