...
:linkattrs:
:redirect_from: /data-integrate/embrace/embrace-intro.html
:experimental:
...
|===
a| image::snowflake-icon.svg[] a|xref:connections-snowflake.adoc[Snowflake]
a| image::aws-icon.svg[] a|xref:connections-redshift.adoc[Amazon Redshift (AWS)]
a| image::gcp-big-query-icon.svg[] a|xref:connections-gbq.adoc[Google Big Query]
a| image::azure-sql-data-warehouse-icon.svg[]  a|xref:connections-synapse.adoc[Azure Synapse]
a| image::teradata-icon.svg[] a|xref:connections-teradata.adoc[Teradata]
a| image::sap-hana-icon.svg[] a|xref:connections-hana.adoc[SAP HANA]
a| image::oracle-adw-icon.svg[] a|xref:connections-adw.adoc[Oracle Autonomous Data Warehouse (ADW)]
a|  image::databricks-icon.svg[] a|xref:connections-databricks.adoc[Databricks] [.badge.badge-new]#New!#
a|  image::starburst-icon.svg[] a|xref:connections-starburst.adoc[Starburst] [.badge.badge-new]#New!#
|===
...
* xref:connections-databrickss-add.adoc[]: Create the connection between ThoughtSpot and tables in a Databricks database.
