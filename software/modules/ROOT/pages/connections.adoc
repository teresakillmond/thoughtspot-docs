...
a| image::logo-awd.svg[] a|xref:connections-adw.adoc[Oracle Autonomous Data Warehouse (ADW)]
a|  image::logo-databricks.png[] a|xref:connections-databricks.adoc[Databricks] [.badge.badge-new]#New!#
a|  image::logo-starburst.jpg[] a|xref:connections-starburst.adoc[Starburst] [.badge.badge-new]#New!#
|===
