...
a|  image::logo-databricks.png[] .^a|xref:connections-databricks.adoc[Databricks]
a|  image::logo-denodo.png[] .^a|xref:connections-denodo.adoc[Denodo]
a|  image::logo-dremio.png[] .^a|xref:connections-dremio.adoc[Dremio]
a| image::logo-gcp.png[] .^a|xref:connections-gbq.adoc[Google Big Query]
a| image::logo-oracle.png[] .^a|xref:connections-adw.adoc[Oracle]
a| image::logo-presto.png[] .^a|xref:connections-presto.adoc[Presto]
...
a|  image::logo-starburst.png[] .^a|xref:connections-starburst.adoc[Starburst]
a| image::logo-teradata.png[] .^a|xref:connections-teradata.adoc[Teradata]
a| image::logo-trino.png[] .^a|xref:connections-trino.adoc[Teradata]
