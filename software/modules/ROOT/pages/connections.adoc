...
|===
a| image::snowflake-icon-sm.svg[] a|xref:connections-snowflake.adoc[Snowflake]
a| image::aws-icon.png[] a|xref:connections-redshift.adoc[Amazon Redshift (AWS)]
a| image::gcp-big-query-icon.png[] a|xref:connections-gbq.adoc[Google Big Query]
a| image::azure-sql-data-warehouse-icon.png[]  a|xref:connections-synapse.adoc[Azure Synapse]
a| image::teradata.png[] a|xref:connections-teradata.adoc[Teradata]
a| image::hana.png[] a|xref:connections-hana.adoc[SAP HANA]
a| image::oracle-adw-icon.svg[] a|xref:connections-adw.adoc[Oracle Autonomous Data Warehouse (ADW)]
a|  image::databricks.png[] a|xref:connections-databricks.adoc[Databricks] [.badge.badge-new]#New!#
a|  image::starburst.jpg[] a|xref:connections-starburst.adoc[Starburst] [.badge.badge-new]#New!#
|===
