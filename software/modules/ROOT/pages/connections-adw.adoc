...
Connections to Oracle Autonomous Data Warehouse (ADW) or Exadata databases enable you to use your data directly in ThoughtSpot, and perform live queries to create answers and pinboards.
