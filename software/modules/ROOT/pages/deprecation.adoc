...
[#deprecated-8-4-1-sw]
== Deprecated in 8.4.1.sw
The 8.4.1.sw release of ThoughtSpot Software, targeted for August 2022, will *deprecate* the following features. ThoughtSpot will drop support for these features in a later release.
