...
If you have the new Pinboard experience turned on in 8.4.0.sw, *Share a Pinboard visualization* is *de-supported* in 8.4.0.sw. To use this feature, turn the new Pinboard experience off.
