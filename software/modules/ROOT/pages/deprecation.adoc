...
The 9.0.0.sw release of ThoughtSpot Cloud, targeted for January 2023 (GA), will drop support for the following feature:
...
The 9.0.0.sw release of ThoughtSpot Software, targeted for January 2023, will *de-support* the Instant Search functionality. Instead, searching in ThoughtSpot will use the xref:search-bar.adoc#search-on-enter[Search on Enter] functionality.
