...
Please xref:support-contact.adoc[contact] your Customer Success or SRE team for clarification.
...
Prior to the 7.1 release, the Instant Insights feature works only in on-prem deployments that use our internal database, Falcon. Embrace and cloud deployments never supported Instant Insights.
