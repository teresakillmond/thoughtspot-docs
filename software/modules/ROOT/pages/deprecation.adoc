...
The 9.0.0.sw release of ThoughtSpot Cloud, targeted for February 2023 (LA) and April 2023 (GA), will drop support for the following feature:
...
[#desupported-9-0-0-sw]
== De-supported in 9.0.0.sw

The 9.0.0.sw release of ThoughtSpot Software, targeted for February 2023 (LA) and April 2023 (GA), will *de-support* the Instant Search functionality. Instead, searching in ThoughtSpot will use the xref:search-bar.adoc#search-on-enter[Search on Enter] functionality.
...
The 8.8.0.sw release of ThoughtSpot Software, targeted for October 2022 (LA) and January 2023 (GA), will *deprecate* the following features. ThoughtSpot will drop support for these features in a later release.
