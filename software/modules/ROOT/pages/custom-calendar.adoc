...
IMPORTANT: This documentation describes custom calendar for ThoughtSpot's Falcon database only. For details on custom calendar for Connections, see xref:connections-cust-cal.adoc[Custom calendar overview]
...
To enable the custom calendar feature for your cluster, contact xref:support-contact.adoc[ThoughtSpot Support].
...
+
Example calendar with the fiscal year beginning on April 1:  image:custom_cal.png[Custom calendar CSV with the fiscal year beginning April 1]
...
. Sign in to your ThoughtSpot cluster and select *DATA*.
. On the DATA page, select the name of a worksheet, table or view in which you want to use your custom calendar.
