...
* Optionally define ThoughtSpot xref:data-modeling-settings.adoc[column properties] within your dbt model schema. See xref:dbt-integration-metadata-tags.adoc[].
