...
:description: Learn how to load files using the tsload connector.
...
If that isn't possible, they are saved to `/tmp`.
...
This requires python3. The details of the methods are documented within the client.
 ...
 ** This simply uploads and starts processing the file, but the load isn't complete just by calling this method.
