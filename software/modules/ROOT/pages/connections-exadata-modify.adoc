= Modify an Oracle Exadata connection
:last_updated: 08/09/2021
:experimental:
:linkattrs:

Learn how to modify an Oracle Exadata connection and its tables.

You can modify an Oracle Exadata connection in the following ways:

- <<editing-an-oracle-exadata-connection,Edit a connection>>: to add or remove tables and columns
- <<remapping-an-oracle-exadata-connection,Remap a connection>>: to map a table or column to a different table or column
- <<removing-a-column-from-an-oracle-exadata-connection,Remove a column>>
- <<deleting-a-table-from-an-oracle-exadata-connection,Delete a table>>
- <<deleting-an-oracle-exadata-connection,Delete a connection>>

[#editing-an-oracle-exadata-connection]
== Editing an Oracle Exadata connection

You can edit an Exadata connection to add tables and columns.
...
To remove a table from a connection, delete it from the connection details page. For more information, see: <<deleting-a-table-from-an-oracle-exadata-connection,Delete a table from an Exadata connection>>.

[#remapping-an-oracle-exadata-connection]
== Remapping an Oracle Exadata connection
...
[#removing-a-column-from-an-oracle-exadata-connection]
== Removing a column from an Oracle Exadata connection

You can edit an Oracle Exadata connection to remove a column.

To remove a column from an Oracle Exadata connection:
...
[#deleting-a-table-from-an-oracle-exadata-connection]
== Deleting a table from an Oracle Exadata connection
...
[#deleting-an-oracle-exadata-connection]
== Deleting an Oracle Exadata connection

To delete an Oracle Exadata connection:
