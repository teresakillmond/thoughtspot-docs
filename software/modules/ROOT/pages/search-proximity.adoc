...
NOTE: You can only use this feature if you bring your data into ThoughtSpot's in-memory database. You cannot perform proximity searches if you xref:embrace.adoc[connect to your data] in an external database.
