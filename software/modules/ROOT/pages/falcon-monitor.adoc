...
You can use these Pinboards for proactive monitoring, or, with help from https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^], for debugging.
