...
:description: How to configure Azure Ad OAuth for a Starburst connection in ThoughtSpot Software
...
. Click *Register*.
+
image::azure-portal-reg-ten-starburst.png[]

. After the application is created, click *Expose an API*.
+
image::star-expose-api.png[]
...
+
image::star-app-uri-oauth-client2.png[]
+
...
+
image:star_oauth_user_res_1.png[]
+
...
+
image:token_det_starburst_1.png[]
+
