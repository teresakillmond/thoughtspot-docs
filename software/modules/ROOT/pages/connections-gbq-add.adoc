...
. Create a name for your connection, a description (optional), then click *Continue*. Alternatively, select *+ Create new* in the left navigation bar, select *Connection*, and select the {connection} tile.
