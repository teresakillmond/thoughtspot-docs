...
[#dataflow-sql-server-conn-authentication-type]
...
Other notes:;; Field appears when you select "Azure SQL database" as server type.
...
[#dataflow-sql-server-conn-aad-secure-principal-id]
...
[#dataflow-sql-server-conn-aad-secure-principal-secret]
