...
----
+
Now, instead of summing the hours, we sum hours only when the sum of the hours is greater than 5.
...
A common mistake is to create an aggregate calculation and then attempt to aggregate on top of that. For example, the following nested formulas will not work:
