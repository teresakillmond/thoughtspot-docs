...
:linkattrs:
:experimental:
:redirect_from: /advanced-search/formulas/percent-calculations.html#calculate_percentages

You can use xref:docs:formulas-simple-operations.adoc[] to perform useful percent calculations on your data.
