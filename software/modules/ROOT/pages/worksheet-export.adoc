...
. Click the *More* icon image:icon-ellipses.png[more options menu] (more options) in the upper-right side of the screen.
...
. Click *Data* on the top navigation bar.
. Click the name of the worksheet you want to edit.
. Click the *More* icon image:icon-ellipses.png[more options menu] in the upper-right side of the screen.
