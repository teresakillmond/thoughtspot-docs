...
* Capacity details are not shown in the Admin/Cluster Liveboard
...
* Filtering on a Liveboard cannot be turned off.
...
* Liveboards do not display properly.
...
* Large Liveboard does not fully display all visualizations.
