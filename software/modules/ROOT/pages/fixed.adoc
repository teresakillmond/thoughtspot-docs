...
|SCAL-127616
|With a Pareto chart, the Y axis disappears when **All labels** is selecting from **Settings**.
...
|SCAL-121291
|When using the New Experience for Answers and Liveboards with worksheets that have a large number of rows causes a big increase in the time to fetch data from the cloud data warehouse, leading to potential crashes.

|SCAL-121185
|Reordering tables in an answer using the New answer experience is very slow.
