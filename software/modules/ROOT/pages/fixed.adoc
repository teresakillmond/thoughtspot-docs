...
* Colors for pie charts cannot be changed.
...
* Certain visualizations never display when a pinboard filter is applied.
* Certain pinboards cannot be shared.
...
* Unable to download charts or PDFs when URL encoding is enabled after upgrade from 6.3.1.CU1 to 6.3.1-188.
...
* Copying pinboards does not work.
...
* Captions cannot be used in charts since upgrade to 6.3.1 CU1.
* Password cannot be updated for a Snowflake connection.
* Active Directory script stops working after upgrade to 6.3.1 CU1.
