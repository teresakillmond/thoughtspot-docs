...
:linkattrs:
:experimental:
:page-aliases: /appliance/hardware/configure-nodes-dell.adoc
:description: Configure ThoughtSpot nodes on your Dell appliance.
...
Make sure you have logged in to your cluster.
If you have not, use admin credentials to sign in to your cluster.
