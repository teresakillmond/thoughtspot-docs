...
:linkattrs:
:experimental:
:description: Learn how to install ThoughtSpot clusters in VMware.
...
>
> * For best results in setting up ThoughtSpot clusters in VMware, we recommend that you take the following ThoughtSpot U course:  https://training.thoughtspot.com/create-upgrade-patch-a-thoughtspot-cluster/430642[Create a Cluster^].
...
| &#10063; | <<cluster-step-3,3: [RHEL, OEL, or AL2] Step 3: Prepare services>>
| &#10063; | <<cluster-step-4,4: Finalize installation>>
|===
