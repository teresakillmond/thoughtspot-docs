...
If your expert(s) don't have an email in ThoughtSpot, they must xref:answer-expert-question.html[check in ThoughtSpot for requested answers].
. Click the name of the worksheet or table from the *Data* page.
. Click the *More* icon image:icon-ellipses.png[more options menu icon] in the upper right side of the page and select *Manage experts*.
+
