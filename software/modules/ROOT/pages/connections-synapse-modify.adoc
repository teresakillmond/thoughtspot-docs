...
You can modify a Synapse connection in the following ways:
...
For more information, see xref:connections-synapse-modify.adoc#deleting-a-table-from-a-synapse-connection[Deleting a table].
...
See xref:connections-synapse-modify.adoc#deleting-a-table-with-dependent-objects[Deleting a table with dependent objects].
