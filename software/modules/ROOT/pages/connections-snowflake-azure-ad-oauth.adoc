...
* https://docs.snowflake.com/en/user-guide/oauth-azure.html#configure-microsoft-azure-ad-for-external-oauth[Microsoft docs: Configure Microsoft Azure AD for External OAuth^]
