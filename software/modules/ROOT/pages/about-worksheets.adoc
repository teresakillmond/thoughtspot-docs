...
. Click the *More* icon image:icon-ellipses.png[more options menu icon], and select *Create worksheet*.
+
...
If you are working with two tables that should be related, but are not, you can xref:about-relationships.html#[add a relationship between them].
