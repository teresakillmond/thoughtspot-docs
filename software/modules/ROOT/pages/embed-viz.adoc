...
Vizualization embedding:: click the *More* menu on the visual you plan to embed, image:icon-more-10px.png[more options menu icon], and select *[-] Copy embed link*. The format for the link is:
+
[source,html]
----
