...
+
Liveboard embedding::
Click the *More* menu at the level of the Liveboard, image:icon-ellipses.png[more options menu icon], and select *[-] Copy embed link*. The format for the link is:
+
[source,html]
----
