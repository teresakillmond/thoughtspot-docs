...
ThoughtSpot provides several REST APIs to manage users, sessions, and ThoughtSpot data objects.

ThoughtSpot REST APIs let you programmatically manage users, user sessions, group privileges, and metadata objects.

For an up-to-date list of API categories and associated resource endpoints, see https://docs.thoughtspot.com/visual-embed-sdk/release/en/?pageid=rest-api-reference[REST API reference].
