...
:description: Use the user icon to adjust language options, specify notification preferences, manage your Answer experience, or sign out of ThoughtSpot.
...
The xref:answer-experience-new.adoc[new answer experience] is in Beta and off by default, but you can turn it on or off from the *Experience* section of your profile. If that option is not available, contact your administrator.
...
The xref:spotiq.adoc[new SpotIQ experience] is in Beta and off by default, but you can turn it on or off from the *Experience* section of your profile. If that option is not available, contact your administrator.
