...
The xref:answer-experience-new.adoc[new Answer experience] is in Beta and off by default, but the option to turn it on or off individually is on by default.
