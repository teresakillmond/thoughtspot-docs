...
:description: The user icon lets you view your profile, adjust language options, specify notification preferences, revisit onboarding, manage your answer experience, or sign out of ThoughtSpot.
...
To add additional words to the blocklist, https://community.thoughtspot.com/customers/s/contactsupport[contact ThoughtSpot Support].

[#new-answer-experience]
== Manage your answer experience

The xref:answer-experience-new.adoc[new answer experience] is on by default. You can turn it on or off from the *Experience* section of your profile. If that option is not available, contact your administrator.
...
The xref:liveboard-experience-new.adoc[new Liveboard experience] is in beta and off by default. You can turn it on or off from the *Experience* section of your profile. If that option is not available, contact your administrator.
