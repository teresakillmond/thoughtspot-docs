...
The new answer experience is in [.label.label-beta]#Beta# and on by default. You can turn it on or off from the Experience manager. If that option is not available, contact your administrator.
