...
With SpotIQ analysis and insight feedback, you can rate a SpotIQ analysis result, or insight, by clicking the like image:thumb_up.png[more options menu icon] or dislike image:thumb_down.png[more options menu icon] icon of the insight.
