...
////
When a user searches with a formula containing both a conditional clause and a group_aggregate expression, then ThoughtSpot detects the first aggregation type within the conditional clause and uses it in the table aggregate summary.
