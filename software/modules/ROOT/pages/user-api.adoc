...
Set `visibility` to `NON_SHARABLE` if you do not want users to be able to xref:user-management.adoc#sharing-visibility[share objects] with users in this group.
