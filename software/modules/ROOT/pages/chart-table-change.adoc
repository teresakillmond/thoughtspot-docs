...
To bucket your data in a table view, select the *More* menu icon image:icon-more-10px.png[More options menu icon] that appears when you hover over a column name on a table.
...
To bucket your data in a chart view, select the dropdown icon image:icon-dropdown-down-20px.png[Dropdown icon image] that appears when you hover near the axis labels on a chart.
