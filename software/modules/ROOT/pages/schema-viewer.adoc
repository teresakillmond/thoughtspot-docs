...
+
image::select-worksheet-schema.png[Select the joins tab]

. The join information and the schema for the worksheet appear.
+
image::worksheet-join-schema.png[View the Joins information and the worksheet schema]
...
image::worksheet_viewer.png[Worksheet schema viewer]
