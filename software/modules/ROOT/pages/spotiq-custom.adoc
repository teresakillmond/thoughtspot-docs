...
NOTE: The new SpotIQ experience is now GA and on by default. The functionality remains the same, but we reorganized the UI to make it more intuitive. You can manage your individual SpotIQ experience xref:user-profile.adoc#spotiq[from your profile]. Note that the new SpotIQ experience is dependent on the xref:answer-experience-new.adoc[new answer experience]; to use the new SpotIQ experience, you must first enable the new answer experience. If you are using the classic SpotIQ experience, your experience may be different from the one this article describes.
...
Depending on whether you are using the new answer and Liveboard experiences or the classic experiences, the SpotIQ analysis window has a different layout.
...
In the classic answer and Liveboard experiences, the SpotIQ analysis window has two tabs:
