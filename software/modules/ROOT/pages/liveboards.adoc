...
For more details, see xref:liveboard-download-pdf.adoc[Download a Pinboard as PDF].
...
> **Related information**
>
> * xref:liveboard-download-pdf.adoc[Download a Pinboard as PDF]
> * xref:liveboard-slideshow.adoc[Present a Pinboard]
