...
:experimental:
:linkattrs:
:page-aliases: /6.3.0/admin/setup/NAS-mount.adoc, /6.3.0.CU1/admin/setup/NAS-mount.adoc, /6.3.1.CU1/admin/setup/NAS-mount.adoc, /admin/setup/NAS-mount.adoc, /disaster-recovery/nas-mount.adoc, NAS-mount.adoc
