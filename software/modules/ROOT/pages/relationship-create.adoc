...
ThoughtSpot allows you to edit the name, join type, and cardinality through the Web interface. This allows you to change a many-to-one join to one-to-one. To reverse the join cardinality, you must delete the join and create it again with the opposite cardinality. To change the columns that define a join, you must delete the join and create a new one.
...
. Make the desired changes to the name, type, or cardinality of the join. This allows you to change a many-to-one join to one-to-one. To reverse the join cardinality, you must delete the join and create it again with the opposite cardinality.
. Click *Save*.
...
. Make the desired changes to the join type or cardinality. This allows you to change a many-to-one join to one-to-one. To reverse the join cardinality, you must delete the join and create it again with the opposite cardinality.
. Click *Save*.
