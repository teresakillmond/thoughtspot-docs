...
ThoughtSpot allows you to edit the name, join type, and cardinality through the Web interface. This allows you to change a many-to-one join to one-to-one. To reverse the join cardinality, you must delete the join and create it again with the opposite cardinality. Deleting the join does *not* delete the dependent objects, but it does make them unusable until you create another join. To change the columns that define a join, you must delete the join and create a new one.
...
. Make the desired changes to the name, type, or cardinality of the join. This allows you to change a many-to-one join to one-to-one. To reverse the join cardinality, you must delete the join and create it again with the opposite cardinality. Deleting the join does *not* delete the dependent objects, but it does make them unusable until you create another join.
. Click *Save*.
...
. Make the desired changes to the join type or cardinality. This allows you to change a many-to-one join to one-to-one. To reverse the join cardinality, you must delete the join and create it again with the opposite cardinality. Deleting the join does *not* delete the dependent objects, but it does make them unusable until you create another join.
. Click *Save*.
...
If a join does not have dependents, you can change the join cardinality by xref:relationship-create.adoc#modify-join[editing the join]. This allows you to change a many-to-one join to one-to-one. To reverse the join cardinality, you must delete the join and create it again with the opposite cardinality.
