...
If you are running one of the following versions, you can upgrade to the 7.1.0.CU1 release directly:
...
First, upgrade to version 6.3.x, or 7.0.x, and then to the 7.1.0.CU1 release.
