...
* Allowed users to configure the installation so it skips specific OS changes. Refer to xref:rhel-install-online.adoc[] or xref:al2-install-online.adoc[] for information about the OS changes you can skip. You can also skip these changes when you install offline.
