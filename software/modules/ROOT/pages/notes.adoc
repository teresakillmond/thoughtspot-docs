...
RHEL and Amazon Linux 2 installation flexibility::
We made installing ThoughtSpot on RHEL and Amazon Linux 2 easier and more secure, in the following ways:
