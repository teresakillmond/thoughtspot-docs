...
****
8.4.0.sw is a Limited Availability release provided directly to select customers to test and provide feedback directly to ThoughtSpot to ensure the 8.4.1.sw maintenance release is customer-tested, stable, and reliable.
