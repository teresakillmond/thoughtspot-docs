...
It is part of ThoughtSpot's move to a new stack. The new experience is off by default, but you can manage your individual answer experience xref:user-profile.adoc#new-answer-experience[from your profile].
