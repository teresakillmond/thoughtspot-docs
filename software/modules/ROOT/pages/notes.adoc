...
In this release, the Oracle ADW connection is changed to Oracle. Existing ADW connections continue to work. There are now two options: *Cloud* for ADW connections, and *On Premise* for Exadata or on-prem database connections. For details, see xref:connections-adw.adoc[Oracle].

[#denodo]
Denodo connector +++<span class="badge badge-new">New</span>+++::
In the release, Denodo is a new connection type. For details, see xref:connections-denodo.adoc[Denodo].

[#dremio]
Dremio connector +++<span class="badge badge-new">New</span>+++::
In the release, Dremio is a new connection type. For details, see xref:connections-dremio.adoc[Denodo].
