...
Integration with AWS Secrets Manager for connection passwords::
Connections now supports AWS Secrets Manager for clusters deployed in AWS. This feature is disabled by default. To enable it, xref:support-contact.adoc[contact ThoughtSpot Support].
