...
.image:cal-outline-blue.svg[Inline,25] Release 8.4.0.sw [.label.label-dep]#Limited Availability#
****
8.4.0.sw is a Limited Availability release provided directly to select customers to test and provide feedback directly to ThoughtSpot to ensure the 8.4.1.sw maintenance release is customer-tested, stable, and reliable for general consumption.
...
[#new-8-4-0]
== 8.4.0.sw [.label.label-dep]#Limited Availability# New Features and Functionality
