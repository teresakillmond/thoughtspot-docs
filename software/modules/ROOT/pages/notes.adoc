...
RHEL installation improvements::
We made installing ThoughtSpot on RHEL easier and more secure, in the following ways:
* The admin user who installs ThoughtSpot on RHEL does *_not_* need to be a root/ sudo user.
* The linux package installation no longer requires use of the yum package manager.
