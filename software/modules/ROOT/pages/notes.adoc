...
ThoughtSpot now uses Python 3.9 for xref:rhel.adoc[RHEL, OEL], and xref:al2.adoc[Amazon Linux 2] deployments. Python 3.9 is a newer and more secure release. ThoughtSpot no longer requires Python 2 for RHEL, OEL, or Amazon Linux 2 deployments.
