...
The xref:answer-experience-new.adoc[new answer experience] is now GA and on by default. It contains multiple new features and feature enhancements.
It is part of ThoughtSpot's move to a new stack.
To learn how to manage your answers experience, refer to xref:answer-experience-new.adoc[].
+
