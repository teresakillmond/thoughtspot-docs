...
* <<business-user-8-4-1-sw,For the Business User>>
...
Python 3.9 upgrade::
For ThoughtSpot-managed CentOS clusters, Python 3.9 is now the default Python version. ThoughtSpot does not support downgrading to an earlier Python release. For customer-managed RHEL, OEL, or Amazon Linux 2 clusters, the default Python version is still either 3.6 or 3.7. You can xref:python-upgrade.adoc[upgrade the cluster's Python version to 3.9].
...
If you are running one of the following versions, you can upgrade to the 8.4.0.sw or 8.4.1.sw release directly:

* 7.1.x to 8.4.0.sw or 8.4.1.sw
* 7.2.x to 8.4.0.sw or 8.4.1.sw

This includes any hotfixes or customer patches on these branches.

If you are running a different version, you must do a multiple pass upgrade.

First, upgrade to version 7.1.x or 7.2.x, and then to the 8.4.0.sw or 8.4.1.sw release.
