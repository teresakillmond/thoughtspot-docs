...
This release redesigns the experience of creating and working with answers. The new answer experience contains multiple new features and feature enhancements. It is in [.label.label-beta]#Beta# and on by default. You can toggle it on or off individually from the *Experience manager* in your profile, or for the whole company by xref:support-contact.adoc[contacting ThoughtSpot Support].
+
