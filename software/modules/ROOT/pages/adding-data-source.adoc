...
+
Refer to the xref:data-connect-connection-credentials.html#[Data Connect connectors reference] for more information on each of the specific attributes you must enter into the dialog box.
