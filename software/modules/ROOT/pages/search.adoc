...
Use search to answer questions about your data without having to consult a data analyst.
...
The *Answers* tab is where you can view and then edit your saved search results.
