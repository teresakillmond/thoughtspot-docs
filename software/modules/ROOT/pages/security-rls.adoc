...
Using row-level security, you can restrict data that appears in search results and Liveboards by group and by user. Row-level security (RLS) allows you to restrict a group's access to table row data.

You do this by creating a _rule_ that associates a filter with a group or a user.
