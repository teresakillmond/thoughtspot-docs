...
Using row-level security, you can restrict data that appears in search results and Liveboards by group or by user. Row-level security (RLS) allows you to restrict a group or user's access to table row data.
