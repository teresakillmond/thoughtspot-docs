...
. In the upper-right corner of the visualization of which you would like to make a copy, click the *More* menu icon image:icon-more-10px.png[more options menu icon].
