...
. Save your Liveboard by clicking the *More* menu icon image:icon-more-10px.png[more options menu icon] and selecting *Save*.

== Change the size of a chart or table

You can change the size of a chart or table on a Liveboard.
To do this:

. Navigate to the chart or table in the Liveboard.
...
. In the upper-right corner of the visualization, click the *More* menu icon image:icon-more-10px.png[more options menu icon] and select *Copy and edit*.
+
...
Most of these actions are found under the *More* menu icon image:icon-more-10px.png[more options menu icon].
