...
Editing the layout of a Liveboard lets you snap visualizations into place, choose between set visualization sizes, and reset your layout. If you enable the xref:liveboard-experience-new.adoc[new Liveboard experience] in 8.4.1.sw, you must be in *Edit* mode to edit the Liveboard layout.
