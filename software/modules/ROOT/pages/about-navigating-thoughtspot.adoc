...
| Did you know? | image::home-spotiq.png[] a|  [#insights]
Contains auto analysis results from SpotIQ. Off by default. After you turn on insights, they are visible only to users that have the SpotIQ privilege.
|====================
