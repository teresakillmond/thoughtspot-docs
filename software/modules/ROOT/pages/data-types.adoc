...
:description: ThoughtSpot supports all the common data types (VARCHAR, DOUBLE, FLOAT, BOOL, INT, DATE, DATETIME).
...
[NOTE]
====
* Wherever using abbreviations or codes, ThoughtSpot conforms to the USPS (United States Postal Service) standards.
