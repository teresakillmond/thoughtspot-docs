...
:description: Learn about the fields used to create a Hive connection with ThoughtSpot DataFlow.
...
Distribution version:: Provide the version of the Distribution you chose. Optional field.
Example:;; 2.6.5
...
KDC host:: Specify KDC Host Name where as KDC (Kerberos Key Distribution Center) is a service that runs on a domain controller server role (Configured from Kerberos configuration-/etc/krb5.conf). Optional field.
