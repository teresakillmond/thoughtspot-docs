...
Contact xref:support-contact.adoc[ThoughtSpot Support] to add new email domains to your list of allowed domains.
+
...
+
See steps for xref:liveboards.adoc#create[creating a Liveboard].
...
Under menu:Preferences[New user onboarding], select *Revisit*.
