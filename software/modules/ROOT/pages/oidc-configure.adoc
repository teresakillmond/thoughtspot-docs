...
This article explains how to configure OIDC for a non-embedded ThoughtSpot instance.

//To learn how to configure OIDC for an embedded ThoughtSpot instance, refer to the https://developers.thoughtspot.com/docs/?pageid=oidc-auth#embedConfig[developer documentation^].
