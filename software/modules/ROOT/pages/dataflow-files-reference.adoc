= Flat file connection reference for DataFlow
:last_updated: 07/07/2020
:experimental:
:linkattrs:
:page-aliases: /data-integrate/dataflow/dataflow-files-reference.adoc
...
include::partial$dataflow/password-optional.adoc[]
...
Null value::
Specifies the string literal that indicates the null value for a column.
...
Example:;; -
Valid Values:;; Only the default value
Default:;; -
...
Example:;; true_false
Valid Values:;; true_false, TRUE_FALSE, t_f, T_F, y_n,Y_N, 1_0, T_NULL, t_null
Default:;; true_false
[#dataflow-files-sync-max-ignored-rows]
...
[#dataflow-files-sync-parallel-thread-limit]
Parallel thread limit:: Specifies the number of parallel threads to unload data. Optional field.
Example:;; 4
Valid Values:;; Any numeric value
Default:;; 1
////