...
****
The group aggregation filters enhancement feature is in Beta and off by default. To enable it, contact {support-url}. For more information about Beta features, see xref:release-lifecycle.adoc#beta[ThoughtSpot Cloud release life cycle].
****
