...
Beginning in the 9.0.0.sw release, you can specify a column in the third argument of a group_aggregate function in order to include all filters defined in the search that pertain to that column, and ignore unrelated filters. This feature is in beta and off by default. To enable group aggregation filters, contact ThoughtSpot Support.
