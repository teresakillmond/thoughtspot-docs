...
:linkattrs:
:experimental:
:redirect_from: /data-integrate/embrace/embrace-adw-add.html
...
> **Related information**
>
> * xref:connections-adw-modify.adoc[Modify an ADW connection]
> * xref:connections-adw-reference.adoc[ADW connection reference]
