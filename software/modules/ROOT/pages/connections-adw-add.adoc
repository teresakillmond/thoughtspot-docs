...
. Enter the connection details for your Oracle data source, and upload your Wallet file.
+
image:adw-connectiondetails.png[]
+
. (Optional) If the wallet file contains the username and password, check *Wallet contains the username and password*.
