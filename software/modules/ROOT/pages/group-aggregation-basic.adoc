...
:experimental:
:linkattrs:
:description: In this article, we walk through examples of basic aggregation.
...
3. Click the **more options** icon image:icon-more-10px.png[] and select *Add formula*.
...
2. Click the **more options** icon image:icon-more-10px.png[] and select *Add formula*.
