...
:experimental:
:description: The ThoughtSpot connection drivers support a limited set of SQL commands.
...
+
You must reload the data following a `TRUNCATE`, or all dependent objects (worksheets and Liveboards) in ThoughtSpot become invalid.
+
Example:;;
+
[source, sql]
