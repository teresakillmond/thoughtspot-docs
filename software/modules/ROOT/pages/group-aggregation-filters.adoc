...
:experimental:
:linkattrs:
:description: In this article, we walk through examples of group aggregation using filters.
...
.. Click the **more options** icon image:icon-more-10px.png[More options menu icon] and select *Add formula*.
