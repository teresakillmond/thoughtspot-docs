...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        ...
        <li><img src="_images/oracle_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://https://preview-thoughtspot.netlify.app/software/latest/connections-adw">Oracle <span class="badge badge-new">New!</span></a></li>
    </ul>
    </div>
      <div class="box">
