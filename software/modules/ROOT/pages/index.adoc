...
<div class="columns">
  <div class="box">
    ...
    <h2>
      <a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/business-user">Business User</a>
    </h2>
    <ul>
  ...
  <div class="box">
    ...
    <h2>
      <a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/analyst">Analyst</a>
    </h2>
    <ul>
      <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/relationship-create">Define table joins</a></li>
      <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/worksheets">Create worksheets</a></li>
      <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/search-assist">Search Assist</a></li>
      <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/chart-change">Changing charts</a></li>
      <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/spotiq">SpotIQ analysis</a></li>
      <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/scriptability">Object migration</a></li>
    </ul>
    </div>
  <div class="box">
    <img src="_images/persona-data-engineer.png">
    <h2>
      <a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/data-engineer">Data Engineer</a>
    </h2>
    <ul>
        <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/connections">Connections</a></li>
        <li><img src="_images/databricks_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/connections-databricks-oauth">Databricks OAuth <span class="badge badge-new">New!</span></a></li>
    </ul>
    </div>
      <div class="box">
        <img src="_images/persona-it-ops.png">
        <h2>
          <a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/it-ops">IT and Operations
        </h2>
        <ul>
         <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/admin-portal">Admin console</a></li>
          <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/users-groups">Managing users and groups</a></li>
       <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/internal-auth">Local authentication</a></li>
       <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/saml">SAML authentication</a></li>
          <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/backup-strategy">Backup and restore</a></li>
          <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/deployment-sw">Software deployment</a></li>
          <li><a href="https://preview-thoughtspot.netlify.app/software/8.4.0.sw/rhel">Oracle Enterprise Linux (OEL) support </a></li>
        </ul>
        </div>
 </div>
