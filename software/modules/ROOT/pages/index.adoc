...
ThoughtSpot Software is our original offering that you deploy and manage on a cloud provider, VMware, or hardware appliance. For deployment options, see xref:deployment-sw.adoc[ThoughtSpot Software Deployment]. 
