...
<div class="columns">
  ...
  <div class="box">
    ...
    <ul>
        ...
        <li><img src="_images/databricks_sm.png" width="20px" alt="more options menu icon" class="inline"><a href="https://preview-thoughtspot.netlify.app/software/latest/connections-databricks-oauth">Databricks OAuth <span class="badge badge-new">New!</span></a></li>
