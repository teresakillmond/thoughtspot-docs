...
[#dataflow-amazon-s3-conn-other-s3-compatible-object-store]
Other S3-compatible object store:: Enable this option to support for non-AWS S3 storage. Optional field.
...
+
Option appears when you select "Other S3-compatible object store."
Example:;; US-West
...
Specify the bucket. +
 ...
 Example:;; bucket
[#dataflow-amazon-s3-conn-folder]
Folder::
...
Valid Values:;; EC2 attached IAM role, Access key and secret key
[#dataflow-amazon-s3-conn-access-key]
 ...
 Example:;; access key
Other notes:;; Displayed only when "Authentication type" is "Access key and Secret key".
...
Valid Values:;; Any numeric value
Default:;; 0
[#dataflow-amazon-s3-sync-max-ignored-rows]
