...
If the issue isn't progressing to your satisfaction (based on normal case lifecycle process expectations), the Escalation Manager joins the team. Escalations can be initiated by either the customer, or the SRE. The Escalation Manager:
...
If RST isn't possible for any reason, ThoughtSpot Support will use internet-based facilities, such as Zoom, for remote access. Please make sure that you have web and SSH access to ThoughtSpot nodes.
...
* To file a new case, select *Submit Case*.
* To view your cases, select *View Cases*.
...
image::community-main-page.png[Community home page]
...
To create a new case, sign in to the https://community.thoughtspot.com/s/login/[ThoughtSpot Community^] website, and select *Submit Case*.

image::community-submit-case.png[Community submit case form]

Please provide all required information in the web form. You may notice that on the left side of the form, under *Need Answers Fast?*, we suggest Knowledge Base articles that match the keywords in the **Subject** and **Description** you provide. Select the suggested articles to see if they help you to resolve your situation quickly.
...
You can view your cases, or all cases within your organization by selecting menu:Support[View Cases].

image::community-view-case.png[View cases]
...
image::community-pin-case.png[Recently Viewed Cases dropdown]
...
You can escalate a case at any time by requesting that you would like an SRE Manager to be engaged. Escalations occur when case progress or issue resolution isn't in line with your expectations relative to the prescribed case resolution process. The SRE Manager serves as the Escalation Manager until we resolve the issue to your satisfaction.
