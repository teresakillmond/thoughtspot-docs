...
| *_[8.4.1.sw and later]_* Number formatting based on xref:data-modeling-patterns.adoc#_number_formats[custom format patterns] | Supported | Not supported
...
| *_[8.4.1.sw and later]_* Column width | Supported | Not supported
