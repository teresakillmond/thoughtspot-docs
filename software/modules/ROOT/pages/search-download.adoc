...
[#table-formatting]
== Table formatting
When you download tables, the format in the downloaded table may look different. The following table describes the behavior for formatting in downloaded tables.

|===
| Formatting | XLSX download | CSV or PDF download
...
| Column width | Not supported | Not supported
