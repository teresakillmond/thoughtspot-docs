...
+
image::download-a-table-new-experience.png[More menu for a table, with Download PDF, Download CSV, and Download XLSX emphasized]

* For a chart, select *Download*.
+
image::download-a-chart-new-experience.png[More menu for a table, with the Download option emphasized]
...
| Number formatting based on xref:data-modeling-patterns.adoc#number-formats[custom format patterns] | Supported | Not supported
