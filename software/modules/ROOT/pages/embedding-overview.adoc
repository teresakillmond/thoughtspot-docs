...
NOTE: ThoughtSpot Extended Enterprise Edition is for ThoughtSpot Software release 7.x only. As of this release, ThoughtSpot Everywhere (TSE) is only available for ThoughtSpot Cloud.
