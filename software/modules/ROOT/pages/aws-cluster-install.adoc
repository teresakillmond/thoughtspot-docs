...
+ If you are using an s3 bucket for object storage, include the flag `--enable_cloud_storage s3aa`.
+
[source,console]
----
$ tscli cluster create <release-number>.tar.gz --enable_cloud_storage s3aa
----
