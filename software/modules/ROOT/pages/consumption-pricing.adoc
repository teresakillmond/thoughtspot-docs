...
:experimental:
:description: ThoughtSpot’s consumption-based pricing model lets you purchase a ThoughtSpot license based on your organization's utilization of the ThoughtSpot product.
