...
:experimental:
:description: ThoughtSpot’s consumption-based licensing model lets you license ThoughtSpot based on your organization's utilization of the ThoughtSpot product.
...
You can monitor your credit consumption through the *Credit Usage Liveboard*, a new default admin-only Liveboard that shows data we collect to monitor credit usage consumption. You can access this Liveboard by searching for it on the **Liveboards** page.

image::consumption-usage-pinboard.png[Credit Usage Liveboard]

The Credit Usage Liveboard contains useful visualizations and headlines you can use to monitor your consumption. You can also search the data yourself, using the Credit Usage Worksheet, and create your own answers and Liveboards.
