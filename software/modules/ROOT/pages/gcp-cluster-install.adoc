...
| &#10063; | <<install-step-4, *[Optional - 7.2.1 and later]* Step 4: Upgrade Python>>
|===
...
[#install-step-4]
=== [Optional - 7.2.1 and later] Step 4: Upgrade Python
By default, your ThoughtSpot cluster comes with Python 3.6. In ThoughtSpot version 7.2.1 and later, you can upgrade it to Python 3.9, remain on the default version, or return to Python 3.6 if you are on Python 3.9.
...
> * xref:support-contact.adoc[ThoughtSpot Support].
