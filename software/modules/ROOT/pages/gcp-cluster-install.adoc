...
By default, your ThoughtSpot cluster comes with Python 3.6. In ThoughtSpot version 7.2.1 and later, you can upgrade it to Python 3.9 or remain on the default version.
