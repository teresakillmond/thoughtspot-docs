...
Before you apply a filter, make sure you xref:about-runtime-filters.html#limitations-of-runtime-filters[understand their limitations].
...
. Append the runtime filter to the URL, using the link:runtime-filter-operators.adoc[runtime filter operators] to get the data you want.
