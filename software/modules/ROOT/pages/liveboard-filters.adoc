...
Refer to xref:liveboard-filters-linked.adoc[Linked Pinboard filters].
...
To specify the visualizations that a Pinboard filter should apply to, follow these steps, or refer to xref:liveboard-filters-selective.adoc[Selective Pinboard filters]:
