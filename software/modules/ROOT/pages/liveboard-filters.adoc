...
. Click the *More* menu icon image:icon-more-10px.png[more options menu icon], and select *Add filters*. If you are using the xref:liveboard-experience-new.adoc[new Liveboard experience] in 8.4.1.sw, select the *Edit* button, and select *Add filters*.
+
