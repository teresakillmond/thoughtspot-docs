...
. Click the *More* menu icon image:icon-more-10px.png[more options menu icon], and select *Add filters*. If you are using the xref:liveboard-experience-new.adoc[new Liveboard experience], select the *Edit* button, and select *Add filters*.
+
...
+
image::column_filter.png[Select values to include. Use the search bar to search for values.]

. If you want to exclude values, click *Exclude* and choose values to exclude.
+
image::exclude_nulls.png[Select values to exclude. Use the search bar to search for values.]
...
image::filter_appears.png[The x appears at the top right of the filter.]
