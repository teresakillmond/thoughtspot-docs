...
You can configure Security Assertion Markup Language (SAML) using ThoughtSpot's <<saml-configure-tscli,command line interface, tscli>>, or through the <<admin-portal,Admin Console>>.
