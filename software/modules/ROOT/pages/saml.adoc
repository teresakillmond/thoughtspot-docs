...
:linkattrs:
:experimental:
:page-aliases: /app-integrate/SAML/configure-SAML-with-tscli.html", "/admin/ts-cloud/authentication-integration.html", "/admin/setup/configure-SAML-with-tscli.html
...
WARNING: Starting in ThoughtSpot version 6.3.1, the mail field is mandatory, and cannot be empty. If your organization cannot meet this requirement, contact ontact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^] for help.
