...
+
You can add the UID and password by selecting *Options*.
...
. Enter a name in the *Name* field and select *OK*.
+
...
. Select a new OLE DB connection manager by selecting *New*.
...
+
If you don't see your data connection, you will have to create a new one in the Connection Manager by selecting *New*.
...
. Select the *System DSN* tab and select *ThoughtSpot_32*.
. Select *Configure*.
+
...
SSIS doesn't allow you to create the table in ThoughtSpot.
...
. Start the import job by selecting the *Start* button.
+
