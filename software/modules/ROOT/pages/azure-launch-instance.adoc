...
When you are ready to obtain the password, contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^].
...
+
You can choose *use existing public key* or *generate new key pair*, or https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^] to obtain a public key.
+
