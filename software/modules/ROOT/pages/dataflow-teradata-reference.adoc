= Teradata connection reference for DataFlow
:last_updated: 02/16/2022
:experimental:
:linkattrs:
...
Authentication type:: Specify the type of security protocol to connect to the instance. Based on the type of security, select the authentication type and provide details.
+
Mandatory field.
+
Valid Values:;; LDAP, Simple
Default:;; LDAP
