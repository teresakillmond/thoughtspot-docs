...
:linkattrs:
:experimental:
:description: Secure socket layers (SSL) provide authentication and data security when sending data to and from ThoughtSpot.
...
. To test that the certificate is correctly installed, sign in to the xref:admin-sign-in.adoc#tsadmin[admin account].
+
