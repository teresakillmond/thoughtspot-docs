...
:experimental:
:linkattrs:
:page-aliases: /admin/setup/work-with-ts-support.adoc
:description: There are several configurations you can set up in your installation to ensure your company's support from ThoughtSpot works smoothly.
...
. Contact xref:support-contact.adoc[ThoughtSpot Support] and open a support ticket for making the appropriate reverse tunnel settings on our end.
...
. Long in to the Linux shell using SSH.
...
. xref:support-contact.adoc[Contact ThoughtSpot Support] and test your setup.
...
Before uploading files to the secure file server, obtain your user name and password for logging in to the secure file server.
...
. Sign in to the ThoughtSpot server as `admin` user.
...
+
image::help_center_support_contact.png[Image of the customizable help menu, with an option to Contact Support in the bottom middle.]
