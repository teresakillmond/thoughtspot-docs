...
. Navigate to the Liveboard that contains the answer with the formula, click the *More* menu icon image:icon-ellipses.png[more options menu icon] and select *Edit*.
