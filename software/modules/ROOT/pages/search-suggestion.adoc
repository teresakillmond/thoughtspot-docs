...
:linkattrs:
:page-partial:
:page-aliases: /end-user/search/recent-searches.adoc
:description: Search suggestions include complete recent searches that are similar to the search you are constructing.
...
image::search_history.png[List of sample search suggestions]
...
Using this information, frequently used terms and phrases are offered in search suggestions more often than those that aren't commonly used.
...
Search suggestions aren't limited in scope to the columns that you select as the data sources.
