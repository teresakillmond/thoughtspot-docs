...
* *xref:set-up-DR-config.adoc[Set up a disaster recovery configuration]*  Use this procedure to set up a disaster recovery configuration with a primary and a mirror instance.
