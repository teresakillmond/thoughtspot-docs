...
:linkattrs:
:redirect_from: /admin/admin-portal/smtp-configure.html
:experimental:
...
NOTE: Add the ThoughtSpot Support alert email, `prod-alerts@thoughtspot.com`, to allow https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^] to receive alerts. https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^] monitors these alerts to ensure your cluster's health.
