...
image::top_fruit.png[Top sales for each department example]
...
+
You can only use location keywords if you bring your data into ThoughtSpot's in-memory database. You can't use them if you xref:connections.adoc[connect to your data] in an external database.
