...
+
You can only use location keywords if you bring your data into ThoughtSpot's in-memory database. You cannot use them if you xref:embrace.adoc[connect to your data] in an external database.
