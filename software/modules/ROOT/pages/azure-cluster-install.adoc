...
Learn how to install ThoughtSpot clusters in Azure. If you are deploying ThoughtSpot using xref:customer-os.adoc[RHEL, OEL, or Amazon Linux 2], refer to xref:customer-os-install.adoc[] instead of this article.
