...
If your load balancer cannot support these ciphers, xref:contact.html[contact ThoughtSpot Support].
...
To test if the certificate is installed correctly, see xref:logins.html#sign-in-to-the-thoughtspot-application[Sign in to the ThoughtSpot application].
