...
image::user-profile.png[Click Profile]
...
You can change your profile picture by clicking the user profile in the top right of the interface, clicking *Upload Picture*, and selecting a new image from the file browser.
...
image::user-profile-email.png[Update email]
...
image::user-sign-out.png[Sign out]
