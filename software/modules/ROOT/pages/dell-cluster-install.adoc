...
:linkattrs:
:experimental:
:redirect_from: /appliance/hardware/install-cluster-dell.html
...
If you do not have a link to download the release bundle, open a support ticket at https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^] to access the release bundle.
