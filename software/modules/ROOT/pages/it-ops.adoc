...
Before people can sign in and use ThoughtSpot, you need to create a membership in one or more groups for them, with the correct privileges. Use the Admin Console to easily create and manage your user groups.
...
//* View user activity
xref:admin-portal-system-cluster-liveboard.adoc[View cluster information]::
View system information about your cluster.
xref:admin-portal-system-alerts-liveboard.adoc[View alert information]::
View system alerts.
...
xref:admin-portal-user-adoption-liveboard.adoc[View user adoption information]::
View the User Adoption Liveboard to learn how your users are interacting with ThoughtSpot.
