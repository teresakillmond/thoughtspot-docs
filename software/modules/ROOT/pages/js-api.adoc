...
:linkattrs:
:redirect_from: /app-integrate/JSAPI/about-JS-API.html
:experimental:
...
To enable CORS between your client applications and your ThoughtSpot instance, you must work with xref:support-contact.adoc[ThoughtSpot Support].
