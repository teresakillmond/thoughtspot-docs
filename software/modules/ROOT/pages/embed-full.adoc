...
:linkattrs:
:experimental:
:description: Full embedding allows users to create ThoughtSpot content in an embedded environment.
...
Before committing to fully embed the application, review xref:embedding.adoc[Understand embedding].
