...
[#dataflow-amazon-aurora-conn-fetch-password-from-vault]
include::partial$dataflow/fetch-password-from-vault.adoc[]

[#dataflow-amazon-aurora-conn-vault-provider]
include::partial$dataflow/vault-provider.adoc[]

[#dataflow-amazon-aurora-conn-secrets-manager-region]
include::partial$dataflow/secrets-manager-region.adoc[]

[#dataflow-amazon-aurora-conn-secret-name-or-arn]
include::partial$dataflow/secret-name-or-arn.adoc[]

[#dataflow-amazon-aurora-conn-remote-role-arn]
include::partial$dataflow/remote-role-arn.adoc[]

[#dataflow-amazon-aurora-conn-key-name-in-secret]
...
Default:;; 1000
[#dataflow-amazon-aurora-sync-max-ignored-rows]
