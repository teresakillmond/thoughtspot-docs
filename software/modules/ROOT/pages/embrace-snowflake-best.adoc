...
. In ThoughtSpot Embrace, add a connection to Snowflake, specifically to the view you created.
   ...
   See <<connect-snowflake,Connect to Snowflake through Embrace>>.
...
To add the foreign key in ThoughtSpot (an alternative to the process outlined in <<add-fk-snowflake,Example 1>>, you can issue the following TQL `ALTER TABLE` statement:
