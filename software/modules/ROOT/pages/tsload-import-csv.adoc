...
:linkattrs:
:experimental:
:description: Use ThoughtSpot Loader (tsload) to load data from a CSV text file into an existing table in ThoughtSpot.
...
. When `tsload` starts processing the data, you can see messages that indicate the progress.
