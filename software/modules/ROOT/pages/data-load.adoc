...
:description: The fastest and easiest way to load a new table is by importing it using the Web browser.

The fastest and easiest way to load a new table is by importing it using the Web browser.
This is best for one-time data loads of small tables which don't have complex relationships to other tables.
...
WARNING: Use secondary disks or your NAS bucket for dataloads. DON'T use the primary disk, at locations such as `/tmp`, `/home/admin` or `/export/home/admin`.
