...
. In the open Liveboard, click the *more options* menu image:icon-more-10px.png[more options menu icon] (ellipses icon), and select *image:icon-present.png[present icon] Present*.
+
