...
+
To navigate through the slides of the presentation, use the left and right arrow navigation keys on your keyboard, or the up and down arrow buttons in the top right corner of the presentation.
+
image::pinboard-present-fullscreen.png[Liveboard in present mode, with options for navigating or quitting the slideshow in the top right corner of the screen]
