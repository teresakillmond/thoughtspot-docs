...
. In the open Liveboard, click the *more options* menu image:icon-ellipses.png[more options menu icon] (ellipses icon), and select *image:icon-present.png[present icon] Present*.
+
