...
:description: The Attribution Dimension setting applies only to tables that are related through a chasm trap.
...
image::NOT_attribution_dim.png[Image of two fact tables, Wholesale Purchases and Retail Sales, that share a common dimension, Date.]
...
image::IS_attribution_dim.png[Image of two fact tables, Wholesale Purchases and Retail Sales, that share a common dimension, Products.]
