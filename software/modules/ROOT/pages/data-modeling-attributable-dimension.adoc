...
The *Attribution Dimension* setting only applies to tables that join over a xref:chasm-trap.adoc[Chasm Trap]. If your schema does not include these, you can ignore this setting.
