...
For the following date formulas, you can further specify either `fiscal`, Gregorian `calendar`, or any other xref:connections-cust-cal.adoc[custom calendar] on which to base date calculations.
