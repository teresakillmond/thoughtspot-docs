...
You can update the <<search,search settings>>, <<spotiq,SpotIQ settings>>, <<liveboard-experience,Liveboard experience>>, and <<visualization-footer,download footer>> from this page.
...
////
need conf from a working cluster to include the below liveboard experience section
[#experience]
////
...
NOTE: The new Liveboard experience is dependent on the new answer experience. To enable the new Liveboard experience, ensure that you first enable the xref:answer-experience-new.adoc[new answer experience].
