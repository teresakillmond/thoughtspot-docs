...
If you are on the xref:answer-experience-new.adoc[new answer experience], you can drill down by both measures and attributes. On the classic answer experience, you can only drill down by attributes.
