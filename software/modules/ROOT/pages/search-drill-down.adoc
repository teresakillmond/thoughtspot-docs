...
To return to the original answer, select the reset icon. In the new Liveboard experience, the reset icon is part of the back button, and appears when you select the back button dropdown. In the classic Liveboard experience, the reset icon is a blue icon at the lower-right corner of the answer.
