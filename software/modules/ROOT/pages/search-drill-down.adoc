...
To return to the original answer, click the reset icon. The reset icon is a blue icon at the bottom right corner of the Answer.

image:drilldown-pinboard.png[Reset your visualization]
