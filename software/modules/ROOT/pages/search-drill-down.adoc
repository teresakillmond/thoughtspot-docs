...
. A list of attributes appears. Click any of the options to gain deeper insight into your data.
+
...
If you want to go back one step at a time while drilling down, xref:liveboards.adoc#add-answer[add your answer to a Liveboard] so you can use Answer Explorer.
