...
* Before you can create a custom calendar, you must contact link:support-contact.adoc[ThoughtSpot Support] to enable the custom calendar feature on your cluster.
...
> **Related information**
>
> * xref:connections-custom-cal-create.adoc[Create a custom calendar]
