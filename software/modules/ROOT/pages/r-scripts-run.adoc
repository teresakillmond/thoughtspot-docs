...
Anyone with R privileges can run an R analysis [.label.label-dep]#Deprecated 8.4.0.sw [LA]# in ThoughtSpot using provided scripts, you don't need to be an expert.
