...
:linkattrs:
:page-partial:
:page-aliases: /complex-search/about-filters.adoc, about-filters.adoc
:experimental:
...
If you ever find that your search or Liveboard does not appear to contain all the data you want to see, check for any existing filters and remove them by clicking the *X* to see all the data.
...
When adding a filter from the *More* menu icon image:icon-more-10px.png[more options menu icon], in the column header or by selecting a chart axis, numeric columns and text columns provide you with the ability to include or exclude values, and a checkbox selector for the values.
