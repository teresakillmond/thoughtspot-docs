...
:experimental:
:description: Prepare to install your ThoughtSpot cluster in Azure by configuring nodes.
...
| &#10063; | xref:azure-launch-instance.adoc#prepare-for-startup[3. Prepare for starting up ThoughtSpot] to learn how to log in to your VM with the private key, and change the admin password. You must change the admin password on first login, or you will not be able to log back into your VMs.
