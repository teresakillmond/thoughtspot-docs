...
If you would like to visualize your search as a pivot table, click on the *change visualization* icon image:icon-chart-type-10px.png[Change visualization icon image] near the top right of your screen, and select *pivot table*.
You need at least one attribute and one measure in your search.

You can restructure your pivot table by dragging and dropping the measures and attributes under *edit chart configuration* image:icon-gear-10px.png[Edit chart configuration icon image], or by dragging and dropping column headings on the table itself.
...
To see your data as a percent, click the *edit chart configuration* image:icon-gear-10px.png[Edit chart configuration icon image] icon, and click *settings* at the bottom of the chart configuration panel.
...
To turn on the heatmap, click the *edit chart configuration* image:icon-gear-10px.png[Edit chart configuration icon image] icon, and click *settings* at the bottom of the chart configuration panel.
Select *heatmap mode*.
