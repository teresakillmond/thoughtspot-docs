...
* xref:create-schema-with-script.adoc[Create the SQL script ahead of time], and <<upload-schema,use the browser to run it>>.
...
. Click the *More* icon image:icon-more-10px.png[more options menu icon], and select *Upload schema*.
+
...
+
image::edit-schema.png[Edit your schema]

. When ready, run your script by clicking the *Execute* button.
+
image::execute-schema.png[Execute your schema]
