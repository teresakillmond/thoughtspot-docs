...
. xref:overview-snapshot.html[Create a manual snapshot].
. xref:prep-schema-for-load.html#connect-with-tql[Connect to the database with the ThoughtSpot SQL Command Line (TQL)].
