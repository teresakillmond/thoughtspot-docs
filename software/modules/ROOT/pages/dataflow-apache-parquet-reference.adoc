...
:experimental:
:linkattrs:
:page-aliases: /data-integrate/dataflow/dataflow-apache-parquet-reference.adoc
...
Default:;; UFT-8
[#dataflow-apache-parquet-sync-parallel-thread-limit]
Parallel thread limit:: Specify the number of parallel threads to unload data. Optional field.
Example:;; 4
Valid Values:;; Any numeric value
Default:;; 1
[#dataflow-apache-parquet-sync-max-ignored-rows]
