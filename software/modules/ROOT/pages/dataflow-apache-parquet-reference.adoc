...
:experimental:
:linkattrs:
:page-aliases: /data-integrate/dataflow/dataflow-apache-parquet-reference.adoc, /7.0.0.mar.sw/data-integrate/dataflow/dataflow-apache-parquet-reference.adoc
