...
. In the *Add filters* side panel, click the *Add filter* icon next to the column you would like to filter on.
...
One of the customer regions in _Retail Sales_ might be *North America*, but the name of that customer in the Linked Worksheet, _Formula Worksheet_, might be *NA*.
