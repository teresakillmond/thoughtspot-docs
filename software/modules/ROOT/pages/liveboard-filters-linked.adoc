...
. In the *Add filters* side panel, click the *Filter* icon image:icon-filter-10px.png[filter icon image] next to the column you would like to filter on. In this example, we will create a linked *Customer Region() filter.
+
