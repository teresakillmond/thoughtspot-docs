...
If you do not add primary filters, the *Configure filters* option does not appear in the *More* menu image:icon-more-10px.png[More options menu icon].
. To add a primary Liveboard filter, select the *More* menu iconimage:icon-more-10px.png[More options menu icon] at the top right, and select *Add filters*.
...
Select the *More* menu icon image:icon-more-10px.png[More options menu icon] at the top right, and select *Configure filters*.
+
