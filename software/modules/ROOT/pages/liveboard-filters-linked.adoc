...
. To add a primary Liveboard filter, select the *More* menu iconimage:icon-more-10px.png[] at the top right, and select *Add filters*.
...
Select the *More* menu icon image:icon-more-10px.png[] at the top right, and select *Configure filters*.
+
