...
You can schedule a Liveboard job for any Liveboard by using the *Add a schedule* prompt page.
...
. Click the *More* menu icon image:icon-ellipses.png[more options menu icon] and select *Manage schedules* to view all of the schedules set for the Liveboard.
. Click *+ Schedule* to add a new schedule.
+
On the *Add a Schedule* page, you create a new schedule for your Liveboard.
+
image::pinboard-schedule-create.png[Create a Liveboard schedule]
