...
* *Configure layout options* allows you to specify the Pinboard layout, after you choose either *CSV* or *PDF*. For more details about the layout options, refer to xref:liveboard-download-pdf.adoc[].
+
Refer to xref:schedule-liveboards.adoc#format[format of scheduled Pinboards] for more information about the differences between CSV and PDF attachments in a scheduled Pinboard email.
Gating condition::
