...
last_updated: tbd sidebar: mydoc_sidebar permalink: /:collection/:path.html -- ThoughtSpot mobile 2.0 is now available.
...
For details, see xref:use-mobile.html#[ThoughtSpot Mobile overview].
