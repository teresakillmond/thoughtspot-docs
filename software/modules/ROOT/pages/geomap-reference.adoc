...
ThoughtSpot supports mapping of the following countries without subdivisions, with the following formats: Administration Name, Name, NAME LONG, ISO A3, and ISO A2. To view the countries with associated subdivisions that ThoughtSpot supports, refer to <<countries-subdivisions,Supported countries and subdivisions>>.
