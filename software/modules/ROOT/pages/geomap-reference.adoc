...
:experimental:
:description: ThoughtSpot supports a broad list of geographic regions. This article lists supported countries and their subdivisions.
...
+
--
include::partial$geos/fr-post-code.adoc[]
--
====
