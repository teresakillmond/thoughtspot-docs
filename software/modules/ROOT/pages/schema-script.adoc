...
:experimental:
:linkattrs:
:description: Using a SQL script to create your schema is a recommended best practice.
...
. Type in the command to create the database, if it doesn't already exist:
+
[source]
----
