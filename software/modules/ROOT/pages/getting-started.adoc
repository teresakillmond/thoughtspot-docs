...
To hide the *Getting Started* sidebar, click the *Help* icon image:icon-help-10px.png[] and select *Hide getting started*.
...
To show the Getting Started sidebar, click the *Help* icon image:icon-help-10px.png[icon] and select *Show getting started*.
...
4. **Help**<br>
    Access **Help** from the help icon ![](icon-help-10px.png "The help icon"){: .inline} in the top right corner of the screen. You can also access your profile in this corner.<br>
