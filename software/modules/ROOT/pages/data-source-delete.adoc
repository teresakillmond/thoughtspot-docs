...
:linkattrs:
:description: When you want to delete a data source, you first need to handle any dependent objects that have been built on top of it.
...
+
image::dependents.png[List of dependents for the Sporting Goods Retail Worksheet]
