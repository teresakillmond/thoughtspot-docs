...
`remote_user_management`::
*_[Optional]_* If you specify this parameter, ThoughtSpot does not create a local account when installing. You must set up Active Directory or LDAP integration prior to installation.
`ssh_user`::
