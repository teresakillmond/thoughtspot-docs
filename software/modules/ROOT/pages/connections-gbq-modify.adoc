...
You can modify  BigQuery connection in the following ways:
...
See xref:connections-gbq-modify.adoc#deleting-a-table-with-dependent-objects[Deleting a table with dependent objects].
