...
:linkattrs:
:experimental:
:description: In this article, we consider examples of aggregation formulas other than group_aggregate().
...
|===
+
If you do not include `account` in the search bar, the formula aggregates up to the table level, averaging the four values.
