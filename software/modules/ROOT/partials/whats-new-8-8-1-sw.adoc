...
The new Liveboard experience contains new features and enhancements, including Liveboard tabs, custom visualization sizes, Edit mode, HTML in Liveboard titles and descriptions, and improved filtering. It is on by default. For more information,
ifndef::pendo-links[]
...
image::new-liveboard-experience-gif-86.gif[New Liveboard experience, which includes Liveboard tabs, Edit mode, HTML in Liveboard titles and descriptions, and improved filtering.]
...
[#8-8-0-sw-python]
[discrete]
=== Python 3.9 support for RHEL, Amazon Linux 2, and OEL

// Teresa. May or may not make it into 8.8.1

[#8-8-0-sw-no-sudo]
[discrete]
=== No Sudo cluster Life cycle management
