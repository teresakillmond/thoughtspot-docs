...
Refer to xref:about-users-groups.adoc[Understand groups and privileges] to learn about the privileges you can assign to a user or group.
...
Refer to xref:add-group.adoc[Create, edit, or delete a group] for more detail on how to create and manage groups.
