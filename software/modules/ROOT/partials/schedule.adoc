...
+
The valid range is from 1 (default) to 60 minutes.
+
Mandatory field.
...
Ordinal day;;
Click the *The* selector, and choose one of _First_(default), _Second_, _Third_, _Fourth_, or _Last_. Then choose one of the days of the week, _Sunday_ through _Saturday_.
