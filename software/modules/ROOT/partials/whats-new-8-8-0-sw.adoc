...
Starburst connections now support Okta and Azure AD OAuth.

- For details on Okta OAuth,
ifndef::pendo-links[]
see xref:connections-starburst-okta-oauth.adoc[Configure OAuth for a Starburst connection].
endif::[]
ifdef::pendo-links[]
see xref:connections-starburst-okta-oauth.adoc[Configure OAuth for a Starburst connection,window=_blank].
endif::[]

- For details on Azure AD OAuth,
ifndef::pendo-links[]
