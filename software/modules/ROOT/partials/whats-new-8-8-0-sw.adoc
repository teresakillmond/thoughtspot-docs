...
The formula editor assistant now contains a search bar for formula operators. Use it to search for specific operators or types of operators. For more information,
ifndef::pendo-links[]
