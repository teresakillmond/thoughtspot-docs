...
We have made the following improvements to the Show underlying data UI:
...
This release introduces support for custom R analysis in the new answer experience. For more information,
ifndef::pendo-links[]
