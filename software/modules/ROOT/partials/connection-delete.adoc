{connection} connections can be used in multiple data sources or visualizations. Because of this, you must delete all data sources, answers, and Liveboards that depend on the connection before you can delete it.
