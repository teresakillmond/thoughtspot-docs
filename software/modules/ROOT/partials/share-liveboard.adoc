...
NOTE: This feature is now deprecated. You may not use it starting with release 8.4.1.sw, if you have the new Liveboard experience turned on. For details, see xref:deprecation.adoc[Deprecation Announcements].
