...
// ask manan if this needs answer v2
...
// this is also dependent on the new answer experience
...
// combine with other table formatting and just use one image (the one with colors)
...
// move both oauth features to the top of the secondary features
