...
For more information,
ifndef::pendo-links[]
see xref:8.4.1.sw@software:python-upgrade.adoc[Upgrade your Python version].
endif::[]
ifdef::pendo-links[]
see xref:8.4.1.sw@software:python-upgrade.adoc[Upgrade your Python version,window=_blank].
endif::[]
