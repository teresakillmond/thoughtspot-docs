...
If you need to move data between clusters or restore to a cluster that was updated to a new release, contact xref:appliance:contact.adoc[ThoughtSpot Support].
