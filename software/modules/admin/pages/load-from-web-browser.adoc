...
include::includes:partial$web-load-intro.adoc[]
...
include::includes:partial$csv-format.adoc[]
...
include::includes:partial$csv-create.adoc[]
...
include::includes:partial$csv-load.adoc[]

== Append to an existing table

include::includes:partial$csv-append.adoc[]
