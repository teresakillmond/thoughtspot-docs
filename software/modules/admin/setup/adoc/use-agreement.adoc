...
image::{{ site.baseurl }}/images/use-agreement-user-warning.png[User notification]
...
image::{{ site.baseurl }}/images/use-agreement-admin-no-access.png[Administrator notification - no access]
...
image::{{ site.baseurl }}/images/use-agreement-user-no-access.png[User notification - no access]
...
+
image::{{ site.baseurl }}/images/use-agreement-accept-email.png[Enter your email]
