...
last_updated: 7/13/2020 summary: "Constraints allow you to build relationships and join tables." sidebar: mydoc_sidebar permalink: /:collection/:path.html -- Constraints include primary keys, foreign keys, and relationships.
...
{% include note.html content="Using many-to-many joins is not a best practice.
...
For example, a date or product dimension could join an inventory fact table to a sales fact table." %}
