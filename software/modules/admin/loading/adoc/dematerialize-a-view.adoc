...
+
image::{{ site.baseurl }}/images/view-materialize-11.png[Dematerialize view]
...
+
image::{{ site.baseurl }}/images/view-materialize-12.png[Confirm dematerialization of view]
