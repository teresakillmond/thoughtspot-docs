...
image::{{ site.baseurl }}/images/charts-bar.png[Bar chart]
...
image::{{ site.baseurl }}/images/charts-stacked-bar-labels.png[Stacked bar chart with labels]
...
image::{{ site.baseurl }}/images/charts-stacked-bar-100.png[Stacked bar chart -- Stack 100 percent toggled on]
