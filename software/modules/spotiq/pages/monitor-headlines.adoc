...
With Monitor [.label.label-beta]#Beta#, you can follow headline metrics of your favorite Pinboards, and get daily updates in your mailbox, on your ThoughtSpot home page, or in the SpotIQ Follow management interface.
...
image::{{ site.baseurl }}/images/headline-follow.gif[Monitor headlines with Follow]
...
image::{{ site.baseurl }}/images/headline-subscribe-others.gif[Subscribe others to follow monitored headlines]
...
image::{{ site.baseurl }}/images/headline-add-others.gif[Subscribe others to follow monitored headlines you don't follow]
...
image::{{ site.baseurl }}/images/headline-follow-add-others.gif[Follow and subscribe others to follow monitored headlines]
...
image::{{ site.baseurl }}/images/headline-unfollow.gif[Unfollow a monitored Headline]
...
image::{{ site.baseurl }}/images/headline-rename.gif[Rename a monitored Headline]
