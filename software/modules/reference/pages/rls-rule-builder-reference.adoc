...
For information on how to use the row level security functions and operators, see xref:admin:row-level-security.adoc[About Rule-Based Row Level Security].
...
include::includes:partial$func-variables.adoc[]
