...
include::includes:partial$ports-operations.adoc[]

include::includes:partial$ports-intracluster.adoc[]

include::includes:partial$ports-cluster-access.adoc[]

include::includes:partial$ports-ipmi.adoc[]
