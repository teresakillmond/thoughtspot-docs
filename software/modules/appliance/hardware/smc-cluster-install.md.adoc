...
If you have not received a link to download the release bundle, open a support ticket with link:{{ site.baseurl }}/appliance/contact.html[ThoughtSpot Support] to access the release bundle.
...
. In the link:{{ site.baseurl }}/appliance/hardware/smc-cluster-install.html#ts-login[ThoughtSpot sign-in window], enter admin credentials, and click *Sign in*.
