...
Choose the https://azuremarketplace.microsoft.com/en-us/marketplace/apps/thoughtspot-inc.thoughtspotvirtualmachine?tab=Overview[ThoughtSpot Search & AI-driven Analytics (BYOL)] image.
...
You can choose *use existing public key* or *generate new key pair*, or link:{{ site.baseurl }}/appliance/contact.html[contact ThoughtSpot support] to obtain a public key.
...
Refer to link:{{ site.baseurl }}/appliance/ports.html[Network ports] for more information.
