...
. Open a Pinboard.
. Copy the URL:
 ** *Pinboard embedding*: click the *More* menu at the level of the Pinboard, image:{{ site.baseurl }}/images/icon-ellipses.png[more options menu icon], and select *[-] Copy embed link*.
+
 ...
 ** *Vizualization embedding*: click the *More* menu on the visual you plan to embed, image:{{ site.baseurl }}/images/icon-ellipses.png[more options menu icon], and select *[-] Copy embed link*.
+
The format for the link is:
+
----
