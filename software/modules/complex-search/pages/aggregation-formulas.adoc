...
image::{{ site.baseurl }}/images/formula_asst_aggregate.png[]
...
image::{{ site.baseurl }}/images/formula_gross_margin_no_sum.png[]
...
image::{{ site.baseurl }}/images/formula_gross_margin_sum.png[]
