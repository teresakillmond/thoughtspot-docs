...
To bucket your data in a table view, click the ellipsis icon image:{{ site.baseurl }}/images/icon-more-10px.png[] that appears when you hover over a column name on a table.
