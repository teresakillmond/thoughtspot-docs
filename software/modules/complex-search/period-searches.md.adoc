...
image::{{ site.baseurl }}/images/time-series.png[Automatic time series suggestions]
...
image::{{ site.baseurl }}/images/time-example1.png[]
...
image::{{ site.baseurl }}/images/time-example2.png[]
...
image::{{ site.baseurl }}/images/time-example3.png[]
