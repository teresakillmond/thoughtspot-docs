...
. If you are sharing a table, select *Entire Table* or *Specific Columns*. To use Column Level Security (CLS), select *Specific Columns*, and only share the columns the users or groups should have access to.
+
image:sharing-datacolumns.png[Specify sharing type]

. If you select *Specific Columns*, select the column(s) you want to share, and add the users or groups you want to share the column(s) with. Use this option for Column Level Security (CLS). If you select *Entire Table*, skip to step 6.
+
