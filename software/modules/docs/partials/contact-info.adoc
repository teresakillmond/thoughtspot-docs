You can contact ThoughtSpot by xref:phone[phone], xref:mail[mail], xref:email[email], by xref:file-ticket[filing a support ticket], or by asking the xref:community[ThoughtSpot Community].
