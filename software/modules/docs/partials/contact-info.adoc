:linkattrs:
You can contact ThoughtSpot by <<phone,phone>>, <<mail,mail>>, <<email,email>>, by <<file-ticket,filing a support ticket>>, or by asking <<community,the ThoughtSpot community>>.
