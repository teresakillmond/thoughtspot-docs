...
Contrast it with the xref:about-starting-a-new-search.html[original ThoughtSpot search].
...
. xref:searchiq-optimize-columns.html[Enable columns for SearchIQ]
. xref:searchiq-optimize-experts.html[Add Experts for SearchIQ]
. xref:searchiq-optimize-train.html[Train SearchIQ]
...
See xref:searchiq-optimize-columns.html[Enable Columns for SearchIQ].

== Add Experts

See xref:searchiq-optimize-experts.html[Add Experts for SearchIQ].

== Train SearchIQ

See xref:searchiq-optimize-train.html[Train SearchIQ].
