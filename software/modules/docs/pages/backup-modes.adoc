...
With AWS, you can back up an S3-based cluster xref:aws-backup-restore.adoc[using an S3 bucket].
With GCP, you can back up a GCS-based cluster xref:gcp-backup-restore.adoc[using a GCS bucket].
