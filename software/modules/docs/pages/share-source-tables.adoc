...
If you want to prevent shares from also revealing the columns regardless of where it appears (Worksheets, Answers, and Pinboards), you can ask xref:contact.adoc[ThoughtSpot Support] to enable a stricter behavior.

You can share a table xref:share-datatab[from the *Data* tab], or xref:share-dataset[from within the table] that you want to share.
