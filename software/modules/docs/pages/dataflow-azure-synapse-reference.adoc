...
:linkattrs:
:experimental:
:redirect_from: /data-integrate/dataflow/dataflow-azure-synapse-reference.html", "/7.0.0.mar.sw/data-integrate/dataflow/dataflow-azure-synapse-reference.html"
