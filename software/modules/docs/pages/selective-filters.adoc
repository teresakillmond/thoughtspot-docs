...
To learn more about Pinboard filters, refer to xref:pinboard-filters.adoc[Pinboard filters] and xref:linked-filters.adoc[Linked Pinboard filters].
...
To create one filter that filters visualizations based on more than one Worksheet, refer to xref:linked-filters.adoc[Linked Pinboard filters].
