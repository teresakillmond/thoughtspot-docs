...
Consumption-based pricing::
  ThoughtSpot now offers consumption, or usage, based pricing. Refer to xref:consumption-pricing.adoc[Consumption-based pricing] and the xref:consumption-pricing-faq.adoc[Consumption pricing FAQ]. To compare consumption- and capacity-based pricing, refer to https://www.thoughtspot.com/pricing[ThoughtSpot pricing^].
...
For details, see xref:deploying-cloud.adoc#reducing-your-cloud-infrastructure-costs[Use small and medium instance types].
