...
:linkattrs:
:redirect_from: "/7.0/release/notes.html", "/7.0.0.CU1/release/notes.html", "/7.0.1/release/notes.html", "/release/notes.html", "/7.0.0.mar.sw/release/notes.html"
...
+
You may need to press *Enter* or *Go* to ensure that ThoughtSpot updates your search with  new iteanyms in the search bar.
+
