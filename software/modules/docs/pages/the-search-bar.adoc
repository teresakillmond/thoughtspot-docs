...
xref:attributes-and-measures.adoc#measures[Measures] are green, xref:attributes-and-measures.adoc#attributes[attributes] are blue, and xref:filters.adoc[filters] are gray.
