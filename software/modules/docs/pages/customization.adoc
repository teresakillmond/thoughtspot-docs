...
You access it using the lightbulb button image:icon-lightbulb.png[more options menu icon] or the *More* menu image:icon-more-10px.png[SpotIQ analyze icon].
...
. Click the *More* icon image:icon-more-10px.png[more options menu icon] for the insight you want to explain and select *Explain insight*.
