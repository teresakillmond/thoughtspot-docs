...
You can change the date format used to display a column's values xref:model-data-in-UI.adoc[for a single table] or, by editing the data model, for xref:edit-model-file.adoc[the entire ThoughtSpot instance].
