...
:experimental:
:linkattrs:
:redirect_from: /data-integrate/dataflow/dataflow-ibm-db2-sync.html
 ...
 ** xref:dataflow-ibm-db2-reference.adoc#dataflow-ibm-db2-sync-data-extraction-mode[Data extraction mode] +
  Specify the extraction type.
 ** xref:dataflow-ibm-db2-reference.adoc#dataflow-ibm-db2-sync-column-delimiter[Column delimiter] +
  Specify the column delimiter character.
 ** xref:dataflow-ibm-db2-reference.adoc#dataflow-ibm-db2-sync-null-value[Null value] +
 ...
 ** xref:dataflow-ibm-db2-reference.adoc#dataflow-ibm-db2-sync-enclosing character[Enclosing character] +
  Specify if the text columns in the source data needs to be enclosed in quotes.
 ** xref:dataflow-ibm-db2-reference.adoc#dataflow-ibm-db2-sync-escape-character[Escape character] +
  Specify the escape character if using a text qualifier in the source data.
 ** xref:dataflow-ibm-db2-reference.adoc#dataflow-ibm-db2-sync-fetch-size[Fetch size] +
 ...
 ** xref:dataflow-ibm-db2-reference.adoc#dataflow-ibm-db2-sync-ts-load-options[TS load options] +
