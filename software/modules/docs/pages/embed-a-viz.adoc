...
+
If the object is a pinboard, click the *More* icon image:icon-more-10px.png[more options menu icon] >  *Copy Link*.
+
image::embed-link-1.png[]
+
The format for the link is:  `<protocol>:<host>:<port>/#/embed/viz/<pinboardID>`
+
For a visualization in a pinboard, click the *More* icon image:icon-more-10px.png[more options menu icon] >  *Copy Link*.
+
