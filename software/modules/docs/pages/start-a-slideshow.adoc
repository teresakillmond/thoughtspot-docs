...
. In the open pinboard, click the *More* menu image:icon-more-10px.png[more options menu icon] (ellipses icon), and select *image:icon-present.png[present icon] Present*.
+
