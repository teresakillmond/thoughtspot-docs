...
:linkattrs:
:experimental:
:redirect_from: /data-integrate/dataflow/dataflow-azure-data-lake-sync.html
 ...
 ** xref:dataflow-azure-data-lake-reference.adoc#dataflow-azure-data-lake-sync-column-delimiter[Column delimiter] +
  Specify the column delimiter character.
 ** xref:dataflow-azure-data-lake-reference.adoc#dataflow-azure-data-lake-sync-enclosing-character[Enclosing character] +
  Specify if the text columns in the source data needs to be enclosed in quotes.
 ** xref:dataflow-azure-data-lake-reference.adoc#dataflow-azure-data-lake-sync-escape-character[Escape character] +
 ...
 ** xref:dataflow-azure-data-lake-reference.adoc#dataflow-azure-data-lake-sync-ts-load-options[TS load options] +
