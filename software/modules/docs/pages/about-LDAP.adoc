...
Starting with ThoughtSpot version 6.0.5, ThoughtSpot also integrates with OpenLDAP for user authentication. LDAP provides security and makes user management more centralized. To enable user authenticaton through OpenLDAP, xref:contact.adoc[contact ThoughtSpot Support].
