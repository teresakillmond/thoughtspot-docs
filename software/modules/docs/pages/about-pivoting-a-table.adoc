...
image::charts-pivot-table-sort.pngSort by a row heading

image::charts-pivot-table-column.pngSort by a column heading
...
image::charts-pivot-table-cell.pngPivot table cell menu
