...
+
Refer to the xref:embrace-gbq-reference.doc[BigQuery connection reference] for more information on each of the specific attributes you must enter for your connection.
