...
If you right-click a table cell, the system displays a contextual menu, allowing you to *exclude* or *include* values, xref:drill-down.adoc[drill down], *show underlying data*, or *SpotIQ analyze*.
