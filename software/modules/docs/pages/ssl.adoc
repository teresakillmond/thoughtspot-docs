...
[width=“100%” grid=“none”]
|===
a| We recommend this ThoughtSpot U course: https://training.thoughtspot.com/authentication-security/610523[Nginx SSL^]. | See other courses at image:ts-u.png[link="https://training.thoughtspot.com/" alt="ThoughtSpot U" window=_blank]
|===
====
...
. To test that the certificate is correctly installed, sign in to the xref:logins.adoc#ts-app[ThoughtSpot application].
+
...
If your load balancer cannot support these ciphers, contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support, window=_blank].
...
To test if the certificate is installed correctly, see xref:logins.adoc#ts-app[Sign in to the ThoughtSpot application].
