...
:redirect_from: /6.3.0/admin/setup/set-up-relay-host.html", "/6.3.0.CU1/admin/setup/set-up-relay-host.html", "/6.3.1.CU1/admin/setup/set-up-relay-host.html
...
----
+
If you are on 6.1 rather than 6.1.1, or an earlier version than 6.0.5, contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support, window=_blank] to use a custom port.
