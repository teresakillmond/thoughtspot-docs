...
:linkattrs:
:redirect_from: /reference/geomap-reference.html
:experimental:
...
You can download a CSV file that contains all supported values for geo map countries, codes, and subdivisions. Use this file to confirm that your own geographical values are in the correct format, and that ThoughtSpot supports them. Download the CSV file link:{attachmentsdir}/geomaps-supported-countries-codes-subdivisions-6.3.csv[geomaps-supported-countries-codes-subdivisions-6.3.csv].
