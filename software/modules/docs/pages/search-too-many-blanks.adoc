...
So if you encounter this problem, you can link:{{ site.baseurl }}/admin/worksheets/change-inclusion-rule.html#[edit the worksheet, and change the inclusion rule] to *Exclude Empty Rows (Inner Join)*.
