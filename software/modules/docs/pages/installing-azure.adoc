...
Log in using the new password you created for the _admin_ user in step two of xref:launch-instance.adoc#prepare-for-startup[Prepare for starting up ThoughtSpot].
