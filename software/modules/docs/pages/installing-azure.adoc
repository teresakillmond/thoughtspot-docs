...
. *Change the admin password* Refer to xref:launch-an-instance.adoc#prepare-for-startup[Prepare for starting up ThoughtSpot] to learn how to log into your VM with the private key, and change the admin password.
...
Log in using the new password you created for the _admin_ user in step two of xref:launch-an-instance.adoc#prepare-for-startup[Prepare for starting up ThoughtSpot].
