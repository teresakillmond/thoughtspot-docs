 ...
 ** xref:dataflow-teradata-reference.adoc#dataflow-teradata-sync-data-extraction-mode[Data extraction mode] +
  Specify the extraction type.
 ** xref:dataflow-teradata-reference.adoc#dataflow-teradata-sync-column-delimiter[Column delimiter] +
  Specify the column delimiter character.
 ** xref:dataflow-teradata-reference.adoc#dataflow-teradata-sync-null-value[Null value] +
 ...
 ** xref:dataflow-teradata-reference.adoc#dataflow-teradata-sync-enclosing-character[Enclosing character] +
  Specify if the text columns in the source data needs to be enclosed in quotes.
 ** xref:dataflow-teradata-reference.adoc#dataflow-teradata-sync-escape-character[Escape character] +
  Specify the escape character if using a text qualifier in the source data.
 ** xref:dataflow-teradata-reference.adoc#dataflow-teradata-sync-fetch-size[Fetch size] +
 ...
 ** xref:dataflow-teradata-reference.adoc#dataflow-teradata-sync-ts-load-options[TS load options] +
