...
. Navigate to the Style Customization by clicking *Admin > Style Customization* from the top navigation bar. If the Style Customization page is not available, xref:contact.adoc[contact ThoughtSpot Support] to enable style customization.
