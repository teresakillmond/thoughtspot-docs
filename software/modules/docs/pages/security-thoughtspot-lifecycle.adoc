...
The https://www.centos.org/[CentOS,window=_blank] distribution of Linux is owned by https://www.redhat.com/en[RedHat,window=_blank] and closely tracks versions of RedHat Enterprise Linux (RHEL).
