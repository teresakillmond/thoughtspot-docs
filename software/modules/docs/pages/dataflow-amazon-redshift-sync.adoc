...
:experimental:
:linkattrs:
:redirect_from: /data-integrate/dataflow/dataflow-amazon-redshift-sync.html
 ...
 ** xref:dataflow-amazon-redshift-reference.adoc#dataflow-amazon-redshift-sync-column-delimiter[Column delimiter] +
  Specify the column delimiter character.
 ** xref:dataflow-amazon-redshift-reference.adoc#dataflow-amazon-redshift-sync-enclosing-character[Enclosing character] +
  Specify if the text columns in the source data needs to be enclosed in quotes.
 ** xref:dataflow-amazon-redshift-reference.adoc#dataflow-amazon-redshift-sync-escape-character[Escape character] +
  Specify the escape character if using a text qualifier in the source data.
 ** xref:dataflow-amazon-redshift-reference.adoc#dataflow-amazon-redshift-sync-fetch-size[Fetch size] +
 ...
 ** xref:dataflow-amazon-redshift-reference.adoc#dataflow-amazon-redshift-sync-ts-load-options[TS load options] +
