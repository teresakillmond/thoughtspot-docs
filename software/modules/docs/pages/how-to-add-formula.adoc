...
If Answer V2 [.label.label-beta]#Beta# is on in your environment, open the *Data* panel from the upper right corner if it is not open, and click the *+* icon next to *Formulas*.
+
