...
<img src="{{ "/images/dataflow-sm.png" | prepend: site.baseurl }}" alt="ThoughtSpot DataFlow">
<div class="grid-child">
<b>Easily load data into ThoughtSpot's in-memory engine</b>
<br>
 &bull;&nbsp;&nbsp;Graphical, code-free, analyst-friendly experience
<br>
