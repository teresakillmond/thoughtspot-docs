...
Downloading a Pinboard works just as it would when downloading an Answer: simply click the *More* menu icon image:icon-ellipses.png[more options menu icon] and select *Download as PDF*.
