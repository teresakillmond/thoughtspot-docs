...
:redirect_from: /6.3.0/admin/backup-restore/overview-snapshot.html", "/6.3.0.CU1/admin/backup-restore/overview-snapshot.html", "/6.3.1/CU1/admin/backup-restore/overview-snapshot.html", "/admin/backup-restore/overview-snapshot.html
:experimental:
:linkattrs:
...
Do not change the default policy, unless it is recommended by https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^].
