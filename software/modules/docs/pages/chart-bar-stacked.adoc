...
:experimental:
:linkattrs:
:redirect_from: /end-user/search/about-bar-charts.html#stacked-bar-charts

The stacked bar chart is similar to the xref:docs:chart-bar.adoc[bar chart], but with one major difference.
