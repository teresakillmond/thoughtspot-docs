...
last_updated: 11/18/2020 summary: "Viewing the underlying data of your answer gives you an un-aggregated view of the underlying data." sidebar: mydoc_sidebar permalink: /:collection/:path.html -- You can see the most granular details of a given result set, i.e.
