...
If you want a column to be part of your search and show up in the table view, but you do not want to include it in your chart, you can drag it to the '`Not Visualized`' section. You can use this functionality to perform a hidden sort, by moving the column you want to sort by to the ‘`Not Visualized`’ section.
