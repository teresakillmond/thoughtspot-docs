...
:experimental:
:linkattrs:
:redirect_from: /data-integrate/dataflow/dataflow-mariadb-sync.html
 ...
 ** xref:dataflow-mariadb-reference.adoc#dataflow-mariadb-sync-column-delimiter[Column delimiter] +
  Specify the column delimiter character.
 ** xref:dataflow-mariadb-reference.adoc#dataflow-mariadb-sync-enclosing-character[Enclosing character] +
  Specify if the text columns in the source data needs to be enclosed in quotes.
 ** xref:dataflow-mariadb-reference.adoc#dataflow-mariadb-sync-escape-character[Escape character] +
  Specify the escape character if using a text qualifier in the source data.
 ** xref:dataflow-mariadb-reference.adoc#dataflow-mariadb-sync-fetch-size[Fetch size] +
 ...
 ** xref:dataflow-mariadb-reference.adoc#dataflow-mariadb-sync-ts-load-options[TS load options] +
