...
Contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^] to determine if your specific cluster size can benefit from the S3 storage option.
