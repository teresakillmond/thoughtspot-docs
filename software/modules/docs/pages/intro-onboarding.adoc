...
Contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support,window="_blank"] to add new email domains to your list of allowed domains.
+
