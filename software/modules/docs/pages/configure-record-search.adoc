...
last_updated: 12/9/2020 summary: "You can record a search replay to create training for your users on how to search your own data." sidebar: mydoc_sidebar permalink: /:collection/:path.html -- Recording a search replay requires administrator privileges and a Firefox browser.
