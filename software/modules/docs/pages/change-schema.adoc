...
After you've craeted a schema and loaded data, you may find yourself wishing you'd set things up a little differently. You can make changes, such as changing the primary key, relationships to other tables, and sharding.
