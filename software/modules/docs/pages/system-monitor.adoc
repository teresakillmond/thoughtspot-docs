...
* xref:worksheets-system.adoc[System Worksheets]
...
You can configure ThoughtSpot to send emails to addresses you specify with monitoring reports and a cluster heartbeat. Follow these steps to xref:set-up-monitoring.adoc[Set up monitoring].
