...
:experimental:
:linkattrs:
:redirect_from: /data-integrate/dataflow/dataflow-mysql-sync.html
 ...
 ** xref:dataflow-mysql-reference.adoc#dataflow-mysql-sync-column-delimiter[Column delimiter] +
  Specify the column delimiter character.
 ** xref:dataflow-mysql-reference.adoc#dataflow-mysql-sync-enclosing-character[Enclosing character] +
  Specify if the text columns in the source data needs to be enclosed in quotes.
 ** xref:dataflow-mysql-reference.adoc#dataflow-mysql-sync-escape-character[Escape character] +
  Specify the escape character if using a text qualifier in the source data.
 ** xref:dataflow-mysql-reference.adoc#dataflow-mysql-sync-fetch-size[Fetch size] +
 ...
 ** xref:dataflow-mysql-reference.adoc#dataflow-mysql-sync-ts-load-options[TS load options] +
