...
For information on configuring SAML authentication, see xref:saml-configure-tscli.adoc[Configure SAML].
...
Permissions to see and edit tables, worksheets, and pinboards are set when you share them with users and groups, as described in xref:sharing-security-overview.adoc[Data security].
