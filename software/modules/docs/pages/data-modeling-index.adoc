...
:linkattrs:
:experimental:
:redirect_from: /admin/data-modeling/change-index.html
...
NOTE: When an administrator adds a formula to a Worksheet, it appears as a selectable column in your search. To turn on indexing for a Worksheet formula, set the **SUGGEST VALUES IN SEARCH** option to 'yes'.
