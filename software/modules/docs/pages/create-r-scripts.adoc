...
* The More icon image:icon-ellipses.png[more options menu icon] provides a menu with options to save or load a previously saved R script, as well as share your R script with other users in the system.
...
To save a script, choose *Save as* from the More menu image:icon-ellipses.png[more options menu icon] of the script.
After you name and save it, your script will show in the *Load* scripts dialog.

image::r-save-script.png[]

To share a script, choose *Share* from the More menu image:icon-ellipses.png[more options menu icon].
