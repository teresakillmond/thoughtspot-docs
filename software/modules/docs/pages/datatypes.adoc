...
+++<col width="50%">++++++</col>++++++</colgroup>+++
  ...
  +++<tr>++++++<td>+++Integer+++</td>+++
    ...
    +++<td>++++++<code>+++INT+++</code>+++ holds 32 bits. +++<code>+++BIGINT+++</code>+++ holds 64 bits. +++<code>+++INT+++</code>+++ has a range of +++<code>+++--2,147,483,648+++</code>+++ to +++<code>+++2,147,483,647+++</code>+++. +++<code>+++BIGINT+++</code>+++ has a range of +++<code>+++--9,223,372,036,854,775,808+++</code>+++ to +++<code>+++9,223,372,036,854,775,807+++</code>+++.+++</td>++++++</tr>+++
