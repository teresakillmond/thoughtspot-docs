...
:experimental:
:linkattrs:
:redirect_from: /data-integrate/dataflow/dataflow-hive-sync.html
...
+
See xref:dataflow-hive.html#sync-properties[Sync properties] for details, defaults, and examples.
