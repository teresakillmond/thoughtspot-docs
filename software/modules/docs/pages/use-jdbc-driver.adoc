...
ThoughtSpot's ODBC connection relies on the https://www.simba.com/products/SEN/doc/Client-Server_user_guide/content/clientserver/configuringsimbaclientodbc/simbaclientodbcunix.htm[SimbaEngine X SDK,window="_blank"] to connect through ODBC or JDBC to ThoughtSpot's remote data stores.
...
This is not the machine or SSH user password.
|===
...
* https://www.simba.com/products/SEN/doc/Client-Server_user_guide/content/clientserver/configuringsimbaclientjdbc/simbaclient_jdbcconfigurationoptions.htm[SimbaClient for JDBC Configuration Properties reference,window="_blank"]
...
To use the package, download and install it using the following steps:
