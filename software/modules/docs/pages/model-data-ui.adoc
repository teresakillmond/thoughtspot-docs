...
In that case, link:data-modeling-edit.adoc[using the model file] is recommended.
...
+
Descriptions of the possible settings are listed in link:data-modeling-settings.adoc[Data modeling settings].
