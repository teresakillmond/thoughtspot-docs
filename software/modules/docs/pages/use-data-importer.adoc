...
Before importing data, you need to xref:create-schema.adoc[build the schema].
...
For details, refer to the storage setting detailed in the GCP xref:gcp-launch-instance.adoc#create-an-instance[Create an instance] section.
