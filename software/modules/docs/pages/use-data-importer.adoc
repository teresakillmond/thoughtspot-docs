...
You can see the list of the flags it accepts in the xref:reference:data-importer-ref.adoc[ThoughtSpot Loader flag reference], or by issuing `tsload -help` on the command line.
