...
For information on these settings, see xref:change-aggreg-additive.adoc[Set ADDITIVE or AGGREGATION].
...
For a complete list of supported geo maps in ThoughtSpot, refer to: xref:reference:geomap-reference.adoc[Geo Map Reference]
