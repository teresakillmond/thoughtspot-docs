= Understand charts +++<span class="label label-dep">Deprecated</span>+++
...
[#search-iq]
SearchIQ +++<a href="javascript://" class="badge badge-dep" data-toggle="tooltip" data-placement="top" title="Deprecated!">D</a>+++
