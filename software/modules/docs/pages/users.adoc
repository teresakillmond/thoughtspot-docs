...
Depending on the size and structure of your organization, you may have colleagues who interact with ThoughtSpot in very specific fashion acording to the following roles, or a hybrid of these roles:
