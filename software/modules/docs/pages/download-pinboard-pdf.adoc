...
. In the open Pinboard, click the *More Options* menu image:icon-more-10px.png[more options menu icon] (ellipses icon), and select *Download as PDF*.
+
image::pinboard-download-pdf.png[Download Pinboard as PDF]
