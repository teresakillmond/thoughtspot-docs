 ...
 ** xref:dataflow-postrgresql-reference.adoc#dataflow-postgresql-sync-data-extraction-mode[Data extraction mode] +
  Specify the extraction type.
 ** xref:dataflow-postrgresql-reference.adoc#dataflow-postgresql-sync-column-delimiter[Column delimiter] +
  Specify the column delimiter character.
 ** xref:dataflow-postrgresql-reference.adoc#dataflow-postgresql-sync-null-value[Null value] +
 ...
 ** xref:dataflow-postrgresql-reference.adoc#dataflow-postgresql-sync-enclosing-character[Enclosing character] +
  Specify if the text columns in the source data needs to be enclosed in quotes.
 ** xref:dataflow-postrgresql-reference.adoc#dataflow-postgresql-sync-escape-character[Escape character] +
  Specify the escape character if using a text qualifier in the source data.
 ** xref:dataflow-postrgresql-reference.adoc#dataflow-postgresql-sync-ts-load-options[TS load options] +
