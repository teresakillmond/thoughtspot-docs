...
image::{{ site.baseurl }}/images/follow-headline.gif[Monitor headlines with Follow]
...
image::{{ site.baseurl }}/images/unfollow-headline.gif[Unfollow a monitored Headline]
...
image::{{ site.baseurl }}/images/rename-headline.gif[Rename a monitored Headline]
