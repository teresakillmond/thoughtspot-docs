...
You can use network attached storage (NAS) to support backup/restore and data loading.
...
[width=“100%” grid=“none”]
|===
a| We recommend this ThoughtSpot U course: https://training.thoughtspot.com/nas-mount[NAS Mount^]. | See other courses at image:ts-u.png[link="https://training.thoughtspot.com/" alt="ThoughtSpot U" window=_blank]
