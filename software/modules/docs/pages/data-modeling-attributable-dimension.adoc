...
* https://community.thoughtspot.com/customers/s/article/What-is-Attribution-and-Chasm-Traps?[What are Chasm Traps, and What is Attribution?, window=_blank]

See other training resources at +
image::thoughtspot-community.png[link="https://community.thoughtspot.com/s/", window=_blank]
////
