...
:linkattrs:
:redirect_from: /admin/manage-jobs/about-scheduled-pinboards.html
...
xref:contact.adoc[Contact ThoughtSpot Support] if you'd like to increase this limit.
...
xref:contact.adoc[Contact ThoughtSpot Support] to configure these settings.
