...
+
Refer to the link:{{ site.baseurl }}/data-integrate/embrace/embrace-teradata-reference.html#[Teradata connection reference] for more information on each of the specific attributes you must enter for your connection.
...
* link:{{ site.baseurl }}/data-integrate/embrace/embrace-teradata-modify.html[Modify a Teradata connection]
* link:{{ site.baseurl }}/data-integrate/embrace/embrace-teradata-reference.html[Teradata connection reference]
