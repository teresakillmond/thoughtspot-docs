...
In production deployments, ThoughtSpot requires you to have three 2TB HDFS disks on HDD (3 x 2TB). Refer to xref:vmware-intro.adoc#supported-configurations[Supported configurations]. For this use case, follow these steps to create the additional, larger capacity disks.
...
+
image::vmware-adddisk-2-tb.png[]
. Save your changes.
. Repeat steps 1-5 to create additional hard disks. ThoughtSpot requires 3 hard disks for a production environment.
. Power on the VM.
