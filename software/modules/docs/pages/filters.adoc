...
You can find out more about how these values are represented and how to filter for them in link:filters-for-null.adoc[About filtering on null, blank, or empty values].
