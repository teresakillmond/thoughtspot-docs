...
Flexible group aggregate formulas allow for flexibility in both xref:pinned-measures.adoc[groupings] and xref:filtered-agg-forms.adoc[filters].
...
* To learn about aggregation formulas in general, see xref:aggregation-formulas.adoc[Overview of aggregate formulas] and xref:pinned-measures.adoc[Group aggregation functions]
