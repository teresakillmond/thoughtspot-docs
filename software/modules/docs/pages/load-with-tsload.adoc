...
. `<standard-thoughspot-cluster-url> Login`.
. `<standard-thoughspot-cluster-url> StartLoad`.
...
link:{{ site.baseurl }}/reference/tsload-service-api-ref.html[tsload connector API reference]
