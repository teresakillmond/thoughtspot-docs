 ...
 ** xref:dataflow-sap-sql-anywhere-reference.adoc#dataflow-sap-sql-anywhere-sync-column-delimiter[Column delimiter] +
  Specify the column delimiter character.
 ** xref:dataflow-sap-sql-anywhere-reference.adoc#dataflow-sap-sql-anywhere-sync-fetch-size[Fetch size] +
 ...
 ** xref:dataflow-sap-sql-anywhere-reference.adoc#dataflow-sap-sql-anywhere-sync-enclosing-character[Enclosing character] +
  Specify if the text columns in the source data needs to be enclosed in quotes.
 ** xref:dataflow-sap-sql-anywhere-reference.adoc#dataflow-sap-sql-anywhere-sync-escape-character[Escape character] +
  Specify the escape character if using a text qualifier in the source data.
 ** xref:dataflow-sap-sql-anywhere-reference.adoc#dataflow-sap-sql-anywhere-sync-ts-load-options[TS load options] +
