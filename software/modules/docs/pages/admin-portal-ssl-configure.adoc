...
>
> * For best resutls with authentication and security, we recommend the following ThoughtSpot U course: xref:https://training.thoughtspot.com/authentication-security/610523[Nginx SSL^].
