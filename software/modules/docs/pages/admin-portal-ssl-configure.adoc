...
* xref:https://training.thoughtspot.com/authentication-security/610523[Nginx SSL, window=_blank]

See other training resources at

image::ts-u.png[link="https://training.thoughtspot.com/" alt="ThoughtSpot U"]
