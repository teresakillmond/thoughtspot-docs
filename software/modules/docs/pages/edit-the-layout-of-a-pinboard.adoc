...
In addition, the size picker at the bottom of a visualization's *More* menu image:icon-ellipses.png[more options menu icon] lets you toggle between predetermined sizes for each visualization.
...
. In the upper-right corner of the visualization, click the *More* icon image:icon-ellipses.png[more options menu icon] and select *Copy and edit*.
+
...
Most of these actions are found under the *More* icon image:icon-ellipses.png[more options menu icon].
