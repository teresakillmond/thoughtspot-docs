...
* xref:4-5-1[4.5.1 Fixed issues]
* xref:4-5[4.5 Fixed issues]
* xref:4-4[4.4 Fixed issues]+++</details>+++
...
- When *Copy link* has been disabled, it still appears in the *More* menu image:icon-more-10px.png[] of Pinboards.
...
* Visualizations that relied on chasm trap Worksheets were not immediately updated when a formula was changed.
