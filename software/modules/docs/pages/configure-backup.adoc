...
You can backup to a local file system, xref:NAS-mount.adoc[mount a NAS (network attached storage) file system] to hold the backup, or xref:appliance:aws-backup-restore.adoc[back up to an S3 bucket].
