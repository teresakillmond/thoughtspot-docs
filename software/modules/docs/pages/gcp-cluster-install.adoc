...
. *Review configuration options* Refer to xref:configuration-options-gcp.adoc[GCP configuration options] for detailed instance specs.
. *Create the instance* Refer to xref:launch-an-instance-gcp.adoc[Set up ThoughtSpot in GCP] to create and launch your instance.
...
. *Configure nodes* Refer to xref:installing-gcp.adoc[Configure ThoughtSpot nodes in GCP] to configure your nodes.
