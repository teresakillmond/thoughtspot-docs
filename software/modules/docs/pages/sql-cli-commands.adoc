...
You can use TQL either xref:schema-upload.adoc[through the ThoughtSpot application's web interface] or the xref:sql-cli-commands.adoc[command line interface] in the Linux shell.
