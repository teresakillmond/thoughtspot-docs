...
The procedure for xref:tenable-JS-API.adoc[enabling the JavaScript API] includes information on how to enable this.
...
You can find more information on our public APIs in the xref:tpublic-api-reference.adoc[Reference guide].
