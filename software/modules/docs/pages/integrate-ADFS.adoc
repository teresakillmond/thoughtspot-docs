...
. xref:configure-SAML-with-tscli.adoc[Configure SAML in ThoughtSpot].
...
. *Restart Tomcat* Contact xref:contact.adoc[ThoughtSpot Support] for help restarting ThoughtSpot's Tomcat instance.
