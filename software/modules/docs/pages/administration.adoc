...
This section covers all topics of special interest to application administrators, or users with xref:logins.adoc[administrative access privileges].
...
* xref:query-on-query.adoc[Using views] for 'stacked' search; you can accomplish some aspects of search stacking by using the `IN` keyword; see xref:search-subquery.adoc[Subquery search].
