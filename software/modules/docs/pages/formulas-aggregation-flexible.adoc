...
* To learn about aggregation formulas in general, see xref:aggregation-formulas.adoc[Overview of aggregate formulas] and xref:formulas-aggregation-group.adoc[Group aggregation functions]
