...
:experimental:
:linkattrs:
:redirect_from: /admin/troubleshooting/upload-logs-egnyte.html
...
. xref:support-configure.adoc[Configure the connection to the file server].
...
If you do not know the customer name, contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support^].
