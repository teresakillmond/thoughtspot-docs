...
:experimental:
:linkattrs:
:redirect_from: /data-integrate/dataflow/dataflow-azure-synapse-sync.html
 ...
 ** xref:dataflow-azure-synapse-reference.adoc#dataflow-azure-synapse-sync-data-extraction-mode[Data extraction mode] +
 Specify the extraction type.
 ** xref:dataflow-azure-synapse-reference.adoc#dataflow-azure-synapse-sync-column-delimiter[Column delimiter] +
 Specify the column delimiter character.
 ** xref:dataflow-azure-synapse-reference.adoc#dataflow-azure-synapse-sync-null-value[Null value] +
 ...
 ** xref:dataflow-azure-synapse-reference.adoc#dataflow-azure-synapse-sync-enclosing-character[Enclosing character] +
 Specify if text columns in the source data are enclosed in quotes;
if yes, single quotes or double quotes.
 ** xref:dataflow-azure-synapse-reference.adoc#dataflow-azure-synapse-sync-escape-character[Escape character] +
 Specify the escape character if using a text qualifier in the source data.
 ** xref:dataflow-azure-synapse-reference.adoc#dataflow-azure-synapse-sync-fetch-size[Fetch size] +
 ...
 ** xref:dataflow-azure-synapse-reference.adoc#dataflow-azure-synapse-sync-ts-load-options[TS load options] +
