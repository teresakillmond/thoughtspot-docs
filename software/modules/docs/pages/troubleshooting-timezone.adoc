...
If you need to change the timezone, contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support,window="_blank"] to change the timezone for you.
