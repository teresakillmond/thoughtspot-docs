...
This command has the following parameters:
  --online;; Downloads `maptiles` tar from the Internet. The default setting is `True`.
  --offline;; Specifies that you are using `maptiles` tar from a local disk. Use during offline enablement of map-tiles. The default setting is `False`.
  --tar TAR;; Specified tar file for map-tiles. Use during offline enablement of map-tiles.
  --md5 MD5;;  Specified md5 file for map-tiles. Use during offline enablement of map-tiles.
