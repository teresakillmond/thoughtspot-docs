...
tscli sssd set-sudo-group sudo_group::
  Allows `sudo` permissions for the specified user __`sudo_group`. For more about setting up Active Directory access, see xref:active-directory.adoc[Enable Active Directory based access].
