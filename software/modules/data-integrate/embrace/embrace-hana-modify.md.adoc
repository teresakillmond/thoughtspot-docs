...
+
image::{{ site.baseurl }}/images/HANA-chooseconnection.png[Select a connection to edit]
...
For more information, see link:{{ site.baseurl }}/data-integrate/embrace/embrace-HANA-modify.html#deleting-a-table-from-a-SAP HANA-connection[Deleting a table].
...
See link:{{ site.baseurl }}/data-integrate/embrace/embrace-HANA-modify.html#deleting-a-table-with-dependent-objects[Deleting a table with dependent objects].
