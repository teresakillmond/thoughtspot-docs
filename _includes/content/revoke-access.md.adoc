...
+
image:{{ site.baseurl }}/images/sharing-unshare.png[The Share icon]
...
+
image:{{ site.baseurl }}/images/sharing-revokeaccess.png[Unshare]
...
+
image:{{ site.baseurl }}/images/sharing-unsharedone.png[Click Share to unshare]
