...
image::{{ site.baseurl }}/images/admin-portal-help-customization-add.png[Add a new link]

Specify the name of the link, the URL, and optionally add a custom icon.
Then click *Confirm*.

image::{{ site.baseurl }}/images/admin-portal-help-customization-add-link.png[Add a new link]
...
image::{{ site.baseurl }}/images/admin-portal-help-customization-edit.png[Edit or delete items]

Specify the new information, and click *Confirm*.

image::{{ site.baseurl }}/images/admin-portal-help-customization-edit-link.png[Edit a link]
